...
public class CharsetMapping {
  ...
  /**
   * Indexes of collations using ucs2, utf16, utf16le or utf32 character sets and that cannot be set
   * to character_set_client system variable.
   */
  ...
  static {
    ...
    MysqlCharset[] charset =
        new MysqlCharset[] {
          ...
          new MysqlCharset(
              ...
              0,
              new String[] {"UTF-8"},
              new String[] {MYSQL_CHARSET_NAME_utf8}),
          new MysqlCharset(
              MYSQL_CHARSET_NAME_utf8mb4,
              4,
              1,
              new String[] {"UTF-8"}), // "UTF-8 = *> 5.5.2 utf8mb4"
    ...
    // Collations may have different default names in different MySQL versions, while the remaining
    ...
    collation[33] =
        new Collation(
            33,
            new String[] {"utf8mb3_general_ci", "utf8_general_ci"},
            1,
            MYSQL_CHARSET_NAME_utf8mb3);
    ...
    collation[76] =
        new Collation(
            76,
            new String[] {"utf8mb3_tolower_ci", "utf8_tolower_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    ...
    collation[83] =
        new Collation(83, new String[] {"utf8mb3_bin", "utf8_bin"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
    ...
    collation[192] =
        new Collation(
            192,
            new String[] {"utf8mb3_unicode_ci", "utf8_unicode_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[193] =
        new Collation(
            193,
            new String[] {"utf8mb3_icelandic_ci", "utf8_icelandic_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[194] =
        new Collation(
            194,
            new String[] {"utf8mb3_latvian_ci", "utf8_latvian_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[195] =
        new Collation(
            195,
            new String[] {"utf8mb3_romanian_ci", "utf8_romanian_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[196] =
        new Collation(
            196,
            new String[] {"utf8mb3_slovenian_ci", "utf8_slovenian_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[197] =
        new Collation(
            197,
            new String[] {"utf8mb3_polish_ci", "utf8_polish_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[198] =
        new Collation(
            198,
            new String[] {"utf8mb3_estonian_ci", "utf8_estonian_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[199] =
        new Collation(
            199,
            new String[] {"utf8mb3_spanish_ci", "utf8_spanish_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[200] =
        new Collation(
            200,
            new String[] {"utf8mb3_swedish_ci", "utf8_swedish_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[201] =
        new Collation(
            201,
            new String[] {"utf8mb3_turkish_ci", "utf8_turkish_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[202] =
        new Collation(
            202, new String[] {"utf8mb3_czech_ci", "utf8_czech_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
    collation[203] =
        new Collation(
            203,
            new String[] {"utf8mb3_danish_ci", "utf8_danish_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[204] =
        new Collation(
            204,
            new String[] {"utf8mb3_lithuanian_ci", "utf8_lithuanian_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[205] =
        new Collation(
            205,
            new String[] {"utf8mb3_slovak_ci", "utf8_slovak_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[206] =
        new Collation(
            206,
            new String[] {"utf8mb3_spanish2_ci", "utf8_spanish2_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[207] =
        new Collation(
            207, new String[] {"utf8mb3_roman_ci", "utf8_roman_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
    collation[208] =
        new Collation(
            208,
            new String[] {"utf8mb3_persian_ci", "utf8_persian_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[209] =
        new Collation(
            209,
            new String[] {"utf8mb3_esperanto_ci", "utf8_esperanto_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[210] =
        new Collation(
            210,
            new String[] {"utf8mb3_hungarian_ci", "utf8_hungarian_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[211] =
        new Collation(
            211,
            new String[] {"utf8mb3_sinhala_ci", "utf8_sinhala_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[212] =
        new Collation(
            212,
            new String[] {"utf8mb3_german2_ci", "utf8_german2_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[213] =
        new Collation(
            213,
            new String[] {"utf8mb3_croatian_ci", "utf8_croatian_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[214] =
        new Collation(
            214,
            new String[] {"utf8mb3_unicode_520_ci", "utf8_unicode_520_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    collation[215] =
        new Collation(
            215,
            new String[] {"utf8mb3_vietnamese_ci", "utf8_vietnamese_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    // 216..222
    collation[223] =
        new Collation(
            223,
            new String[] {"utf8mb3_general_mysql500_ci", "utf8_general_mysql500_ci"},
            0,
            MYSQL_CHARSET_NAME_utf8mb3);
    ...
    collation[270] =
        new Collation(270, "utf8mb4_es_trad_0900_ai_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
    ...
    collation[293] =
        new Collation(293, "utf8mb4_es_trad_0900_as_cs", 0, MYSQL_CHARSET_NAME_utf8mb4);
    ...
    collation[314] =
        new Collation(314, "utf8mb4_sr_latn_0900_ai_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
    collation[315] =
        new Collation(315, "utf8mb4_sr_latn_0900_as_cs", 0, MYSQL_CHARSET_NAME_utf8mb4);
    ...
    collation[322] =
        new Collation(322, "utf8mb4_mn_cyrl_0900_ai_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
    collation[323] =
        new Collation(323, "utf8mb4_mn_cyrl_0900_as_cs", 0, MYSQL_CHARSET_NAME_utf8mb4);
    ...
    for (MysqlCharset cs : charset) {
      if (!cs.aliases.isEmpty()
          && (idx = charsetNameToCollationIndexMap.get(cs.charsetName)) != null) {
  ...
  protected static String getStaticMysqlCharsetForJavaEncoding(
      String javaEncoding, ServerVersion version) {
    List<MysqlCharset> mysqlCharsets =
        CharsetMapping.JAVA_ENCODING_UC_TO_MYSQL_CHARSET.get(
            javaEncoding.toUpperCase(Locale.ENGLISH));
  ...
  protected static int getStaticCollationIndexForJavaEncoding(
      String javaEncoding, ServerVersion version) {
   ...
   *       or aliases available for this mapping then javaEncoding value as is; this is required
   *       when result should match to connection encoding, for example if connection encoding is
   ...
   *       or aliases available for this mapping then return default Java encoding (the first in
   *       mapping list)
   * </ul>
   *
   ...
   */
  protected static String getStaticJavaEncodingForMysqlCharset(
      String mysqlCharsetName, String fallbackJavaEncoding) {
  ...
  protected static String getStaticJavaEncodingForCollationIndex(
    ...
    return charset != null
        ? charset.getMatchingJavaEncoding(fallbackJavaEncoding)
...
class MysqlCharset {
   ...
   * @param javaEncodings List of Java encodings corresponding to this MySQL charset; the first name
   *     in list is the default for mysql --&gt; java data conversion
   */
