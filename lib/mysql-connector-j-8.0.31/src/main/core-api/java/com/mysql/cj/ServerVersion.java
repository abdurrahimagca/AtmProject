...
public class ServerVersion implements Comparable<ServerVersion> {
   ...
   * "complete" string which may contain more than just the version number, this string is returned
   * verbatim. Otherwise, a string representation of the version numbers is given.
   *
  ...
  public boolean equals(Object obj) {
    ...
    if (this.getMajor() != another.getMajor()
        || this.getMinor() != another.getMinor()
      ...
      try {
        ...
        if (point != -1) {
          ...
          return new ServerVersion(
              versionString, serverMajorVersion, serverMinorVersion, serverSubminorVersion);
        }
