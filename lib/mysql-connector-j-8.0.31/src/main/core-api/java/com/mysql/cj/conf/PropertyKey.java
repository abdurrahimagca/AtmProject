...
public enum PropertyKey {
  ...
  loadBalanceBlocklistTimeout(
      "loadBalanceBlocklistTimeout", "loadBalanceBlacklistTimeout", true), //
  ...
  readFromSourceWhenNoReplicas(
      "readFromSourceWhenNoReplicas", "readFromMasterWhenNoSlaves", true), //
  ...
  xdevapiAsyncResponseTimeout(
      "xdevapi.asyncResponseTimeout", "xdevapiAsyncResponseTimeout", true), //
  ...
  xdevapiConnectionAttributes(
      "xdevapi.connection-attributes", "xdevapiConnectionAttributes", true), //
  xdevapiCompression("xdevapi.compression", "xdevapiCompression", true), //
  xdevapiCompressionAlgorithms(
      "xdevapi.compression-algorithms", "xdevapiCompressionAlgorithms", true), //
  xdevapiCompressionExtensions(
      "xdevapi.compression-extensions", "xdevapiCompressionExtensions", true), //
  xdevapiDnsSrv("xdevapi.dns-srv", "xdevapiDnsSrv", true), //
  xdevapiFallbackToSystemKeyStore(
      "xdevapi.fallback-to-system-keystore", "xdevapiFallbackToSystemKeyStore", true), //
  ...
  xdevapiSslKeyStorePassword(
      "xdevapi.ssl-keystore-password", "xdevapiSslKeystorePassword", true), //
  ...
  xdevapiSslTrustStorePassword(
      "xdevapi.ssl-truststore-password", "xdevapiSslTruststorePassword", true), //
...
;
   ...
   * @return the {@link PropertyKey} element that matches the given key name value or <code>null
   *     </code> if none is found.
   */
  public static PropertyKey fromValue(String value) {
    for (PropertyKey k : values()) {
      if (k.isCaseSensitive) {
        if (k.getKeyName().equals(value)
            || (k.getCcAlias() != null && k.getCcAlias().equals(value))) {
          return k;
        }
      } else {
        if (k.getKeyName().equalsIgnoreCase(value)
            || (k.getCcAlias() != null && k.getCcAlias().equalsIgnoreCase(value))) {
          return k;
        }
      }
    }
