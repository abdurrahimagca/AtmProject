...
public final class MysqlErrorNumbers {
  ...
  public static final int ER_NO =
      1002; // SQLSTATE: HY000 Message: NO; Used in the construction of other messages.
  ...
  public static final int ER_CANT_CREATE_TABLE =
      1005; // SQLSTATE: HY000 Message: Can't create table '%s' (errno: %d)
  public static final int ER_CANT_CREATE_DB =
      1006; // SQLSTATE: HY000 Message: Can't create database '%s' (errno: %d)
  ...
  public static final int ER_CANT_LOCK =
      1015; // SQLSTATE: HY000 Message: Can't lock file (errno: %d - %s)
  public static final int ER_CANT_OPEN_FILE =
      1016; // SQLSTATE: HY000 Message: Can't open file: '%s' (errno: %d - %s)
  public static final int ER_FILE_NOT_FOUND =
      1017; // SQLSTATE: HY000 Message: Can't find file: '%s' (errno: %d - %s)
  public static final int ER_CANT_READ_DIR =
      1018; // SQLSTATE: HY000 Message: Can't read dir of '%s' (errno: %d - %s)
  public static final int ER_CANT_SET_WD =
      1019; // SQLSTATE: HY000 Message: Can't change dir to '%s' (errno: %d - %s)
  ...
  public static final int ER_DISK_FULL =
      1021; // SQLSTATE: HY000 Message: Disk full (%s); waiting for someone to free some space...
            // (errno: %d - %s)
  public static final int ER_DUP_KEY =
      1022; // SQLSTATE: 23000 Message: Can't write; duplicate key in table '%s'
  ...
  public static final int ER_FILE_USED =
      1027; // SQLSTATE: HY000 Message: '%s' is locked against change
  ...
  public static final int ER_FORM_NOT_FOUND =
      1029; // SQLSTATE: HY000 Message: View '%s' doesn't exist for '%s'
  public static final int ER_GET_ERRNO =
      1030; // SQLSTATE: HY000 Message: Got error %d from storage engine...
  ...
  public static final int ER_KEY_NOT_FOUND =
      1032; // SQLSTATE: HY000 Message: Can't find record in '%s'
  public static final int ER_NOT_FORM_FILE =
      1033; // SQLSTATE: HY000 Message: Incorrect information in file: '%s'
  ...
  public static final int ER_OLD_KEYFILE =
      1035; // SQLSTATE: HY000 Message: Old key file for table '%s'; repair it!
  public static final int ER_OPEN_AS_READONLY =
      1036; // SQLSTATE: HY000 Message: Table '%s' is read only
  public static final int ER_OUTOFMEMORY =
      1037; // SQLSTATE: HY001 Message: Out of memory; restart server and try again (needed %d
            // bytes)
  public static final int ER_OUT_OF_SORTMEMORY =
      1038; // SQLSTATE: HY001 Message: Out of sort memory, consider increasing server sort buffer
            // size
  ...
  public static final int ER_CON_COUNT_ERROR =
      1040; // SQLSTATE: 08004 Message: Too many connections
  public static final int ER_OUT_OF_RESOURCES =
      1041; // SQLSTATE: HY000 Message: Out of memory; check if mysqld or some other process uses
            // all available memory; if not, you may have to use 'ulimit' to allow mysqld to use
            // more memory or you can add more swap space
  public static final int ER_BAD_HOST_ERROR =
      1042; // SQLSTATE: 08S01 Message: Can't get hostname for your address
  ...
  public static final int ER_BAD_NULL_ERROR =
      1048; // SQLSTATE: 23000 Message: Column '%s' cannot be null
  ...
  public static final int ER_NON_UNIQ_ERROR =
      1052; // SQLSTATE: 23000 Message: Column '%s' in %s is ambiguous
  public static final int ER_SERVER_SHUTDOWN =
      1053; // SQLSTATE: 08S01 Message: Server shutdown in progress
  public static final int ER_BAD_FIELD_ERROR =
      1054; // SQLSTATE: 42S22 Message: Unknown column '%s' in '%s'
  public static final int ER_WRONG_FIELD_WITH_GROUP =
      1055; // SQLSTATE: 42000 Message: '%s' isn't in GROUP BY
  public static final int ER_WRONG_GROUP_FIELD =
      1056; // SQLSTATE: 42000 Message: Can't group on '%s'
  ...
  public static final int ER_TOO_LONG_IDENT =
      1059; // SQLSTATE: 42000 Message: Identifier name '%s' is too long
  public static final int ER_DUP_FIELDNAME =
      1060; // SQLSTATE: 42S21 Message: Duplicate column name '%s'
  ...
  public static final int ER_DUP_ENTRY =
      1062; // SQLSTATE: 23000 Message: Duplicate entry '%s' for key %d
  ...
  public static final int ER_NONUNIQ_TABLE =
      1066; // SQLSTATE: 42000 Message: Not unique table/alias: '%s'
  public static final int ER_INVALID_DEFAULT =
      1067; // SQLSTATE: 42000 Message: Invalid default value for '%s'
  public static final int ER_MULTIPLE_PRI_KEY =
      1068; // SQLSTATE: 42000 Message: Multiple primary key defined
  ...
  public static final int ER_BLOB_USED_AS_KEY =
      1073; // SQLSTATE: 42000 Message: BLOB column '%s' can't be used in key specification with the
            // used table type
  public static final int ER_TOO_BIG_FIELDLENGTH =
      1074; // SQLSTATE: 42000 Message: Column length too big for column '%s' (max = %lu); use BLOB
            // or TEXT instead
  public static final int ER_WRONG_AUTO_KEY =
      1075; // SQLSTATE: 42000 Message: Incorrect table definition; there can be only one auto
            // column and it must be defined as a key
  public static final int ER_READY =
      1076; // SQLSTATE: HY000 Message: %s: ready for connections. Version: '%s' socket: '%s' port:
            // %d
  ...
  public static final int ER_GOT_SIGNAL =
      1078; // SQLSTATE: HY000 Message: %s: Got signal %d. Aborting!
  public static final int ER_SHUTDOWN_COMPLETE =
      1079; // SQLSTATE: HY000 Message: %s: Shutdown complete
  ...
  public static final int ER_NO_SUCH_INDEX =
      1082; // SQLSTATE: 42S12 Message: Table '%s' has no index like the one used in CREATE INDEX;
            // recreate the table
  public static final int ER_WRONG_FIELD_TERMINATORS =
      1083; // SQLSTATE: 42000 Message: Field separator argument is not what is expected; check the
            // manual
  public static final int ER_BLOBS_AND_NO_TERMINATED =
      1084; // SQLSTATE: 42000 Message: You can't use fixed rowlength with BLOBs; please use 'fields
            // terminated by'
  public static final int ER_TEXTFILE_NOT_READABLE =
      1085; // SQLSTATE: HY000 Message: The file '%s' must be in the database directory or be
            // readable by all
  public static final int ER_FILE_EXISTS_ERROR =
      1086; // SQLSTATE: HY000 Message: File '%s' already exists
  ...
  public static final int ER_ALTER_INFO =
      1088; // SQLSTATE: HY000 Message: Records: %ld Duplicates: %ld
  public static final int ER_WRONG_SUB_KEY =
      1089; // SQLSTATE: HY000 Message: Incorrect prefix key; the used key part isn't a string, the
            // used length is longer than the key part, or the storage engine doesn't support unique
            // prefix keys
  public static final int ER_CANT_REMOVE_ALL_FIELDS =
      1090; // SQLSTATE: 42000 Message: You can't delete all columns with ALTER TABLE; use DROP
            // TABLE instead
  ...
  public static final int ER_UPDATE_TABLE_USED =
      1093; // SQLSTATE: HY000 Message: You can't specify target table '%s' for update in FROM
            // clause
  public static final int ER_NO_SUCH_THREAD =
      1094; // SQLSTATE: HY000 Message: Unknown thread id: %lu
  public static final int ER_KILL_DENIED_ERROR =
      1095; // SQLSTATE: HY000 Message: You are not owner of thread %lu
  ...
  public static final int ER_TOO_BIG_SET =
      1097; // SQLSTATE: HY000 Message: Too many strings for column %s and SET
  ...
  public static final int ER_WRONG_DB_NAME =
      1102; // SQLSTATE: 42000 Message: Incorrect database name '%s'
  public static final int ER_WRONG_TABLE_NAME =
      1103; // SQLSTATE: 42000 Message: Incorrect table name '%s'
  public static final int ER_TOO_BIG_SELECT =
      1104; // SQLSTATE: 42000 Message: The SELECT would examine more than MAX_JOIN_SIZE rows; check
            // your WHERE and use SET SQL_BIG_SELECTS=1 or SET MAX_JOIN_SIZE=# if the SELECT is okay
  ...
  public static final int ER_UNKNOWN_PROCEDURE =
      1106; // SQLSTATE: 42000 Message: Unknown procedure '%s'
  ...
  public static final int ER_UNKNOWN_TABLE =
      1109; // SQLSTATE: 42S02 Message: Unknown table '%s' in %s
  public static final int ER_FIELD_SPECIFIED_TWICE =
      1110; // SQLSTATE: 42000 Message: Column '%s' specified twice
  public static final int ER_INVALID_GROUP_FUNC_USE =
      1111; // SQLSTATE: HY000 Message: Invalid use of group function
  public static final int ER_UNSUPPORTED_EXTENSION =
      1112; // SQLSTATE: 42000 Message: Table '%s' uses an extension that doesn't exist in this
            // MySQL version
  ...
  public static final int ER_RECORD_FILE_FULL =
      1114; // SQLSTATE: HY000 Message: The table '%s' is full
  public static final int ER_UNKNOWN_CHARACTER_SET =
      1115; // SQLSTATE: 42000 Message: Unknown character set: '%s'
  ...
  public static final int ER_TOO_BIG_ROWSIZE =
      1118; // SQLSTATE: 42000 Message: Row size too large. The maximum row size for the used table
            // type, not counting BLOBs, is %ld. This includes storage overhead, check the manual.
  ...
  public static final int ER_WRONG_OUTER_JOIN =
      1120; // SQLSTATE: 42000 Message: Cross dependency found in OUTER JOIN; examine your ON
            // conditions
  public static final int ER_NULL_COLUMN_IN_INDEX =
      1121; // SQLSTATE: 42000 Message: Table handler doesn't support NULL in given index. Please
            // change column '%s' to be NOT NULL or use another handler
  public static final int ER_CANT_FIND_UDF =
      1122; // SQLSTATE: HY000 Message: Can't load function '%s'
  ...
  public static final int ER_UDF_NO_PATHS =
      1124; // SQLSTATE: HY000 Message: No paths allowed for shared library
  public static final int ER_UDF_EXISTS =
      1125; // SQLSTATE: HY000 Message: Function '%s' already exists
  ...
  public static final int ER_CANT_FIND_DL_ENTRY =
      1127; // SQLSTATE: HY000 Message: Can't find symbol '%s' in library
  public static final int ER_FUNCTION_NOT_DEFINED =
      1128; // SQLSTATE: HY000 Message: Function '%s' is not defined
  public static final int ER_HOST_IS_BLOCKED =
      1129; // SQLSTATE: HY000 Message: Host '%s' is blocked because of many connection errors;
  ...
  public static final int ER_PASSWORD_ANONYMOUS_USER =
      1131; // SQLSTATE: 42000 Message: You are using MySQL as an anonymous user and anonymous users
            // are not allowed to change passwords
  public static final int ER_PASSWORD_NOT_ALLOWED =
      1132; // SQLSTATE: 42000 Message: You must have privileges to update tables in the mysql
  ...
  public static final int ER_CANT_CREATE_THREAD =
      1135; // SQLSTATE: HY000 Message: Can't create a new thread (errno %d); if you are not out of
  ...
  public static final int ER_CANT_REOPEN_TABLE =
      1137; // SQLSTATE: HY000 Message: Can't reopen table: '%s'
  public static final int ER_INVALID_USE_OF_NULL =
      1138; // SQLSTATE: 22004 Message: Invalid use of NULL value
  public static final int ER_REGEXP_ERROR =
      1139; // SQLSTATE: 42000 Message: Got error '%s' from regexp
  ...
  public static final int ER_COLUMNACCESS_DENIED_ERROR =
      1143; // SQLSTATE: 42000 Message: %s command denied to user '%s'@'%s' for column '%s' in table
            // '%s'
  public static final int ER_ILLEGAL_GRANT_FOR_TABLE =
      1144; // SQLSTATE: 42000 Message: Illegal GRANT/REVOKE command; please consult the manual to
  ...
  public static final int ER_NO_SUCH_TABLE =
      1146; // SQLSTATE: 42S02 Message: Table '%s.%s' doesn't exist
  public static final int ER_NONEXISTING_TABLE_GRANT =
      1147; // SQLSTATE: 42000 Message: There is no such grant defined for user '%s' on host '%s' on
            // table '%s'
  ...
  public static final int ER_SYNTAX_ERROR =
      1149; // SQLSTATE: 42000 Message: You have an error in your SQL syntax; check the manual that
            // corresponds to your MySQL server version for the right syntax to use
  public static final int ER_DELAYED_CANT_CHANGE_LOCK =
      1150; // SQLSTATE: HY000 Message: Delayed insert thread couldn't get requested lock for table
            // %s
  ...
  public static final int ER_NET_FCNTL_ERROR =
      1155; // SQLSTATE: 08S01 Message: Got an error from fcntl()
  public static final int ER_NET_PACKETS_OUT_OF_ORDER =
      1156; // SQLSTATE: 08S01 Message: Got packets out of order
  ...
  public static final int ER_DELAYED_INSERT_TABLE_LOCKED =
      1165; // SQLSTATE: HY000 Message: INSERT DELAYED can't be used with table '%s' because it is
            // locked with LOCK TABLES
  public static final int ER_WRONG_COLUMN_NAME =
      1166; // SQLSTATE: 42000 Message: Incorrect column name '%s'
  ...
  public static final int ER_WRONG_MRG_TABLE =
      1168; // SQLSTATE: HY000 Message: Unable to open underlying table which is differently defined
  ...
  public static final int ER_BLOB_KEY_WITHOUT_LENGTH =
      1170; // SQLSTATE: 42000 Message: BLOB/TEXT column '%s' used in key specification without a
            // key length
  public static final int ER_PRIMARY_CANT_HAVE_NULL =
      1171; // SQLSTATE: 42000 Message: All parts of a PRIMARY KEY must be NOT NULL; if you need
            // NULL in a key, use UNIQUE instead
  public static final int ER_TOO_MANY_ROWS =
      1172; // SQLSTATE: 42000 Message: Result consisted of more than one row
  ...
  public static final int ER_UPDATE_WITHOUT_KEY_IN_SAFE_MODE =
      1175; // SQLSTATE: HY000 Message: You are using safe update mode and you tried to update a
  ...
  public static final int ER_CHECK_NO_SUCH_TABLE =
      1177; // SQLSTATE: 42000 Message: Can't open table
  ...
  public static final int ER_ERROR_DURING_COMMIT =
      1180; // SQLSTATE: HY000 Message: Got error %d during COMMIT
  public static final int ER_ERROR_DURING_ROLLBACK =
      1181; // SQLSTATE: HY000 Message: Got error %d during ROLLBACK
  ...
  public static final int ER_NEW_ABORTING_CONNECTION =
      1184; // SQLSTATE: 08S01 Message: Aborted connection %ld to db: '%s' user: '%s' host: '%s'
            // (%s)
  public static final int ER_DUMP_NOT_IMPLEMENTED =
      1185; // SQLSTATE: HY000 Message: The storage engine for the table does not support binary
            // table dump
  @Deprecated public static final int ER_FLUSH_MASTER_BINLOG_CLOSED = 1186;
  public static final int ER_FLUSH_SOURCE_BINLOG_CLOSED =
      1186; // SQLSTATE: HY000 Message: Binlog closed, cannot RESET SOURCE
  public static final int ER_INDEX_REBUILD =
      1187; // SQLSTATE: HY000 Message: Failed rebuilding the index of dumped table '%s'
  @Deprecated public static final int ER_MASTER = 1188;
  public static final int ER_SOURCE = 1188; // SQLSTATE: HY000 Message: Error from source: '%s'
  @Deprecated public static final int ER_MASTER_NET_READ = 1189;
  public static final int ER_SOURCE_NET_READ =
      1189; // SQLSTATE: 08S01 Message: Net error reading from source
  @Deprecated public static final int ER_MASTER_NET_WRITE = 1190;
  public static final int ER_SOURCE_NET_WRITE =
      1190; // SQLSTATE: 08S01 Message: Net error writing to source
  ...
  public static final int ER_LOCK_OR_ACTIVE_TRANSACTION =
      1192; // SQLSTATE: HY000 Message: Can't execute the given command because you have active
            // locked tables or an active transaction
  public static final int ER_UNKNOWN_SYSTEM_VARIABLE =
      1193; // SQLSTATE: HY000 Message: Unknown system variable '%s'
  ...
  public static final int ER_CRASHED_ON_REPAIR =
      1195; // SQLSTATE: HY000 Message: Table '%s' is marked as crashed and last (automatic?) repair
            // failed
  public static final int ER_WARNING_NOT_COMPLETE_ROLLBACK =
      1196; // SQLSTATE: HY000 Message: Some non-transactional changed tables couldn't be rolled
            // back
  public static final int ER_TRANS_CACHE_FULL =
      1197; // SQLSTATE: HY000 Message: Multi-statement transaction required more than
            // 'max_binlog_cache_size' bytes of storage; increase this mysqld variable and try again
  @Deprecated public static final int ER_SLAVE_MUST_STOP = 1198;
  public static final int ER_REPLICA_MUST_STOP =
      1198; // SQLSTATE: HY000 Message: This operation cannot be performed with a running replica;
            // run STOP REPLICA first
  @Deprecated public static final int ER_SLAVE_NOT_RUNNING = 1199;
  public static final int ER_REPLICA_NOT_RUNNING =
      1199; // SQLSTATE: HY000 Message: This operation requires a running replica; configure replica
            // and do START REPLICA
  @Deprecated public static final int ER_BAD_SLAVE = 1200;
  public static final int ER_BAD_REPLICA =
      1200; // SQLSTATE: HY000 Message: The server is not configured as replica; fix in config file
            // or with CHANGE SOURCE TO
  @Deprecated public static final int ER_MASTER_INFO = 1201;
  public static final int ER_SOURCE_INFO =
      1201; // SQLSTATE: HY000 Message: Could not initialize source info structure; more error
            // messages can be found in the MySQL error log
  @Deprecated public static final int ER_SLAVE_THREAD = 1202;
  public static final int ER_REPLICA_THREAD =
  ...
  public static final int ER_TOO_MANY_USER_CONNECTIONS =
      1203; // SQLSTATE: 42000 Message: User %s already has more than 'max_user_connections' active
            // connections
  ...
  public static final int ER_READ_ONLY_TRANSACTION =
      1207; // SQLSTATE: 25000 Message: Update locks cannot be acquired during a READ UNCOMMITTED
            // transaction
  public static final int ER_DROP_DB_WITH_READ_LOCK =
      1208; // SQLSTATE: HY000 Message: DROP DATABASE not allowed while thread is holding global
            // read lock
  public static final int ER_CREATE_DB_WITH_READ_LOCK =
      1209; // SQLSTATE: HY000 Message: CREATE DATABASE not allowed while thread is holding global
            // read lock
  public static final int ER_WRONG_ARGUMENTS =
      1210; // SQLSTATE: HY000 Message: Incorrect arguments to %s
  ...
  public static final int ER_UNION_TABLES_IN_DIFFERENT_DIR =
      1212; // SQLSTATE: HY000 Message: Incorrect table definition; all MERGE tables must be in the
            // same database
  public static final int ER_LOCK_DEADLOCK =
      1213; // SQLSTATE: 40001 Message: Deadlock found when trying to get lock; try restarting
            // transaction
  ...
  public static final int ER_CANNOT_ADD_FOREIGN =
      1215; // SQLSTATE: HY000 Message: Cannot add foreign key constraint
  public static final int ER_NO_REFERENCED_ROW =
      1216; // SQLSTATE: 23000 Message: Cannot add or update a child row: a foreign key constraint
            // fails
  public static final int ER_ROW_IS_REFERENCED =
      1217; // SQLSTATE: 23000 Message: Cannot delete or update a parent row: a foreign key
            // constraint fails
  @Deprecated public static final int ER_CONNECT_TO_MASTER = 1218;
  public static final int ER_CONNECT_TO_SOURCE =
      1218; // SQLSTATE: 08S01 Message: Error connecting to source: %s
  @Deprecated public static final int ER_QUERY_ON_MASTER = 1219;
  public static final int ER_QUERY_ON_SOURCE =
      1219; // SQLSTATE: HY000 Message: Error running query on source: %s
  ...
  public static final int ER_WRONG_USAGE =
      1221; // SQLSTATE: HY000 Message: Incorrect usage of %s and %s
  public static final int ER_WRONG_NUMBER_OF_COLUMNS_IN_SELECT =
      1222; // SQLSTATE: 21000 Message: The used SELECT statements have a different number of
            // columns
  public static final int ER_CANT_UPDATE_WITH_READLOCK =
      1223; // SQLSTATE: HY000 Message: Can't execute the query because you have a conflicting read
            // lock
  public static final int ER_MIXING_NOT_ALLOWED =
      1224; // SQLSTATE: HY000 Message: Mixing of transactional and non-transactional tables is
            // disabled
  public static final int ER_DUP_ARGUMENT =
      1225; // SQLSTATE: HY000 Message: Option '%s' used twice in statement
  public static final int ER_USER_LIMIT_REACHED =
      1226; // SQLSTATE: 42000 Message: User '%s' has exceeded the '%s' resource (current value:
            // %ld)
  public static final int ER_SPECIFIC_ACCESS_DENIED_ERROR =
      1227; // SQLSTATE: 42000 Message: Access denied; you need (at least one of) the %s
            // privilege(s) for this operation
  public static final int ER_LOCAL_VARIABLE =
      1228; // SQLSTATE: HY000 Message: Variable '%s' is a SESSION variable and can't be used with
            // SET GLOBAL
  public static final int ER_GLOBAL_VARIABLE =
      1229; // SQLSTATE: HY000 Message: Variable '%s' is a GLOBAL variable and should be set with
            // SET GLOBAL
  public static final int ER_NO_DEFAULT =
      1230; // SQLSTATE: 42000 Message: Variable '%s' doesn't have a default value
  ...
  @Deprecated public static final int ER_MASTER_FATAL_ERROR_READING_BINLOG = 1236;
  public static final int ER_SOURCE_FATAL_ERROR_READING_BINLOG =
      1236; // SQLSTATE: HY000 Message: Got fatal error %d from source when reading data from binary
            // log: '%s'
  @Deprecated public static final int ER_SLAVE_IGNORED_TABLE = 1237;
  public static final int ER_REPLICA_IGNORED_TABLE =
      1237; // SQLSTATE: HY000 Message: Replica SQL thread ignored the query because of
  ...
  public static final int ER_OPERAND_COLUMNS =
      1241; // SQLSTATE: 21000 Message: Operand should contain %d column(s)
  public static final int ER_SUBQUERY_NO_1_ROW =
      1242; // SQLSTATE: 21000 Message: Subquery returns more than 1 row
  ...
  public static final int ER_CYCLIC_REFERENCE =
      1245; // SQLSTATE: HY000 Message: Cyclic reference on subqueries
  public static final int ER_AUTO_CONVERT =
      1246; // SQLSTATE: HY000 Message: Converting column '%s' from %s to %s
  public static final int ER_ILLEGAL_REFERENCE =
      1247; // SQLSTATE: 42S22 Message: Reference '%s' not supported (%s)
  ...
  public static final int ER_NOT_SUPPORTED_AUTH_MODE =
      1251; // SQLSTATE: 08004 Message: Client does not support authentication protocol requested by
  ...
  @Deprecated public static final int ER_SLAVE_WAS_RUNNING = 1254;
  public static final int ER_REPLICA_WAS_RUNNING =
      1254; // SQLSTATE: HY000 Message: Replica is already running
  @Deprecated public static final int ER_SLAVE_WAS_NOT_RUNNING = 1255;
  public static final int ER_REPLICA_WAS_NOT_RUNNING =
      1255; // SQLSTATE: HY000 Message: Replica already has been stopped
  public static final int ER_TOO_BIG_FOR_UNCOMPRESS =
      1256; // SQLSTATE: HY000 Message: Uncompressed data size too large; the maximum size is %d
            // (probably, length of uncompressed data was corrupted)
  public static final int ER_ZLIB_Z_MEM_ERROR =
      1257; // SQLSTATE: HY000 Message: ZLIB: Not enough memory
  public static final int ER_ZLIB_Z_BUF_ERROR =
      1258; // SQLSTATE: HY000 Message: ZLIB: Not enough room in the output buffer (probably, length
  ...
  public static final int ER_WARN_TOO_MANY_RECORDS =
      1262; // SQLSTATE: 01000 Message: Row %ld was truncated; it contained more data than there
            // were input columns
  public static final int ER_WARN_NULL_TO_NOTNULL =
      1263; // SQLSTATE: 22004 Message: Column set to default value; NULL supplied to NOT NULL
            // column '%s' at row %ld
  ...
  public static final int ER_CANT_AGGREGATE_2COLLATIONS =
      1267; // SQLSTATE: HY000 Message: Illegal mix of collations (%s,%s) and (%s,%s) for operation
            // '%s'
  ...
  public static final int ER_REVOKE_GRANTS =
      1269; // SQLSTATE: HY000 Message: Can't revoke all privileges for one or more of the requested
            // users
  public static final int ER_CANT_AGGREGATE_3COLLATIONS =
      1270; // SQLSTATE: HY000 Message: Illegal mix of collations (%s,%s), (%s,%s), (%s,%s) for
            // operation '%s'
  ...
  public static final int ER_UNKNOWN_COLLATION =
      1273; // SQLSTATE: HY000 Message: Unknown collation: '%s'
  @Deprecated public static final int ER_SLAVE_IGNORED_SSL_PARAMS = 1274;
  public static final int ER_REPLICA_IGNORED_SSL_PARAMS =
      1274; // SQLSTATE: HY000 Message: SSL parameters in CHANGE SOURCE are ignored because this
            // MySQL replica was compiled without SSL support; they can be used later if MySQL
            // replica with SSL is started
  public static final int ER_SERVER_IS_IN_SECURE_AUTH_MODE =
      1275; // SQLSTATE: HY000 Message: Server is running in --secure-auth mode, but '%s'@'%s' has a
            // password in the old format; please change the password to the new format
  public static final int ER_WARN_FIELD_RESOLVED =
      1276; // SQLSTATE: HY000 Message: Field or reference '%s%s%s%s%s' of SELECT #%d was resolved
            // in SELECT #%d
  @Deprecated public static final int ER_BAD_SLAVE_UNTIL_COND = 1277;
  public static final int ER_BAD_REPLICA_UNTIL_COND =
      1277; // SQLSTATE: HY000 Message: Incorrect parameter or combination of parameters for START
            // REPLICA UNTIL
  @Deprecated public static final int ER_MISSING_SKIP_SLAVE = 1278;
  public static final int ER_MISSING_SKIP_REPLICA =
      1278; // SQLSTATE: HY000 Message: It is recommended to use --skip-replica-start when doing
            // step-by-step replication with START REPLICA UNTIL; otherwise, you will get problems
            // if you get an unexpected replica's mysqld restart
  ...
  public static final int ER_WRONG_NAME_FOR_INDEX =
      1280; // SQLSTATE: 42000 Message: Incorrect index name '%s'
  public static final int ER_WRONG_NAME_FOR_CATALOG =
      1281; // SQLSTATE: 42000 Message: Incorrect catalog name '%s'
  public static final int ER_WARN_QC_RESIZE =
      1282; // SQLSTATE: HY000 Message: Query cache failed to set size %lu; new query cache size is
            // %lu
  ...
  public static final int ER_UNKNOWN_KEY_CACHE =
      1284; // SQLSTATE: HY000 Message: Unknown key cache '%s'
  public static final int ER_WARN_HOSTNAME_WONT_WORK =
      1285; // SQLSTATE: HY000 Message: MySQL is started in --skip-name-resolve mode; you must
            // restart it without this switch for this grant to work
  public static final int ER_UNKNOWN_STORAGE_ENGINE =
      1286; // SQLSTATE: 42000 Message: Unknown storage engine '%s'
  public static final int ER_WARN_DEPRECATED_SYNTAX =
      1287; // SQLSTATE: HY000 Message: '%s' is deprecated and will be removed in a future release.
  ...
  public static final int ER_FEATURE_DISABLED =
      1289; // SQLSTATE: HY000 Message: The '%s' feature is disabled; you need MySQL built with '%s'
            // to have it working
  public static final int ER_OPTION_PREVENTS_STATEMENT =
      1290; // SQLSTATE: HY000 Message: The MySQL server is running with the %s option so it cannot
  ...
  public static final int ER_TOO_MUCH_AUTO_TIMESTAMP_COLS =
      1293; // SQLSTATE: HY000 Message: Incorrect table definition; there can be only one TIMESTAMP
  ...
  public static final int ER_UNSUPPORTED_PS =
      1295; // SQLSTATE: HY000 Message: This command is not supported in the prepared statement
            // protocol yet
  public static final int ER_GET_ERRMSG =
      1296; // SQLSTATE: HY000 Message: Got error %d '%s' from %s
  ...
  public static final int ER_WARN_ALLOWED_PACKET_OVERFLOWED =
      1301; // SQLSTATE: HY000 Message: Result of %s() was larger than max_allowed_packet (%ld) -
            // truncated
  ...
  public static final int ER_SP_ALREADY_EXISTS =
      1304; // SQLSTATE: 42000 Message: %s %s already exists
  public static final int ER_SP_DOES_NOT_EXIST =
      1305; // SQLSTATE: 42000 Message: %s %s does not exist
  ...
  public static final int ER_SP_STORE_FAILED =
      1307; // SQLSTATE: HY000 Message: Failed to CREATE %s %s
  public static final int ER_SP_LILABEL_MISMATCH =
      1308; // SQLSTATE: 42000 Message: %s with no matching label: %s
  public static final int ER_SP_LABEL_REDEFINE =
      1309; // SQLSTATE: 42000 Message: Redefining label %s
  public static final int ER_SP_LABEL_MISMATCH =
      1310; // SQLSTATE: 42000 Message: End-label %s without match
  public static final int ER_SP_UNINIT_VAR =
      1311; // SQLSTATE: 01000 Message: Referring to uninitialized variable %s
  ...
  public static final int ER_SP_BADRETURN =
      1313; // SQLSTATE: 42000 Message: RETURN is only allowed in a FUNCTION
  ...
  public static final int ER_UPDATE_LOG_DEPRECATED_IGNORED =
      1315; // SQLSTATE: 42000 Message: The update log is deprecated and replaced by the binary log;
            // SET SQL_LOG_UPDATE has been ignored. This option will be removed in MySQL 5.6.
  public static final int ER_UPDATE_LOG_DEPRECATED_TRANSLATED =
      1316; // SQLSTATE: 42000 Message: The update log is deprecated and replaced by the binary log;
            // SET SQL_LOG_UPDATE has been translated to SET SQL_LOG_BIN. This option will be
            // removed in MySQL 5.6.
  public static final int ER_QUERY_INTERRUPTED =
      1317; // SQLSTATE: 70100 Message: Query execution was interrupted
  ...
  public static final int ER_SP_COND_MISMATCH =
      1319; // SQLSTATE: 42000 Message: Undefined CONDITION: %s
  public static final int ER_SP_NORETURN =
      1320; // SQLSTATE: 42000 Message: No RETURN found in FUNCTION %s
  public static final int ER_SP_NORETURNEND =
      1321; // SQLSTATE: 2F005 Message: FUNCTION %s ended without RETURN
  public static final int ER_SP_BAD_CURSOR_QUERY =
      1322; // SQLSTATE: 42000 Message: Cursor statement must be a SELECT
  public static final int ER_SP_BAD_CURSOR_SELECT =
      1323; // SQLSTATE: 42000 Message: Cursor SELECT must not have INTO
  public static final int ER_SP_CURSOR_MISMATCH =
      1324; // SQLSTATE: 42000 Message: Undefined CURSOR: %s
  public static final int ER_SP_CURSOR_ALREADY_OPEN =
      1325; // SQLSTATE: 24000 Message: Cursor is already open
  public static final int ER_SP_CURSOR_NOT_OPEN =
      1326; // SQLSTATE: 24000 Message: Cursor is not open
  public static final int ER_SP_UNDECLARED_VAR =
      1327; // SQLSTATE: 42000 Message: Undeclared variable: %s
  ...
  public static final int ER_SP_DUP_PARAM =
      1330; // SQLSTATE: 42000 Message: Duplicate parameter: %s
  ...
  public static final int ER_SP_SUBSELECT_NYI =
      1335; // SQLSTATE: 0A000 Message: Subquery value not supported
  ...
  public static final int ER_SP_VARCOND_AFTER_CURSHNDLR =
      1337; // SQLSTATE: 42000 Message: Variable or condition declaration after cursor or handler
            // declaration
  ...
  public static final int ER_SP_CASE_NOT_FOUND =
      1339; // SQLSTATE: 20000 Message: Case not found for CASE statement
  ...
  public static final int ER_VIEW_NO_EXPLAIN =
      1345; // SQLSTATE: HY000 Message: EXPLAIN/SHOW can not be issued; lacking privileges for
            // underlying table
  ...
  public static final int ER_NONUPDATEABLE_COLUMN =
      1348; // SQLSTATE: HY000 Message: Column '%s' is not updatable
  ...
  public static final int ER_VIEW_WRONG_LIST =
      1353; // SQLSTATE: HY000 Message: View's SELECT and view's field list have different column
            // counts
  public static final int ER_WARN_VIEW_MERGE =
      1354; // SQLSTATE: HY000 Message: View merge algorithm can't be used here for now (assumed
            // undefined algorithm)
  public static final int ER_WARN_VIEW_WITHOUT_KEY =
      1355; // SQLSTATE: HY000 Message: View being updated does not have complete key of underlying
            // table in it
  public static final int ER_VIEW_INVALID =
      1356; // SQLSTATE: HY000 Message: View '%s.%s' references invalid table(s) or column(s) or
  ...
  public static final int ER_TRG_ALREADY_EXISTS =
      1359; // SQLSTATE: HY000 Message: Trigger already exists
  public static final int ER_TRG_DOES_NOT_EXIST =
      1360; // SQLSTATE: HY000 Message: Trigger does not exist
  ...
  public static final int ER_VIEW_CHECK_FAILED =
      1369; // SQLSTATE: HY000 Message: CHECK OPTION failed '%s.%s'
  ...
  public static final int ER_RELAY_LOG_FAIL =
      1371; // SQLSTATE: HY000 Message: Failed purging old relay logs: %s
  ...
  public static final int ER_BINLOG_PURGE_FATAL_ERR =
      1377; // SQLSTATE: HY000 Message: Fatal error during log purge
  public static final int ER_LOG_IN_USE =
      1378; // SQLSTATE: HY000 Message: A purgeable log is in use, will not purge
  public static final int ER_LOG_PURGE_UNKNOWN_ERR =
      1379; // SQLSTATE: HY000 Message: Unknown error during log purge
  ...
  public static final int ER_NO_BINARY_LOGGING =
      1381; // SQLSTATE: HY000 Message: You are not using binary logging
  public static final int ER_RESERVED_SYNTAX =
      1382; // SQLSTATE: HY000 Message: The '%s' syntax is reserved for purposes internal to the
            // MySQL server
  ...
  public static final int ER_LOGGING_PROHIBIT_CHANGING_OF =
      1387; // SQLSTATE: HY000 Message: Binary logging and replication forbid changing the global
            // server %s
  public static final int ER_NO_FILE_MAPPING =
      1388; // SQLSTATE: HY000 Message: Can't map file: %s, errno: %d
  ...
  public static final int ER_KEY_PART_0 =
      1391; // SQLSTATE: HY000 Message: Key part '%s' length cannot be 0
  public static final int ER_VIEW_CHECKSUM =
      1392; // SQLSTATE: HY000 Message: View text checksum failed
  public static final int ER_VIEW_MULTIUPDATE =
      1393; // SQLSTATE: HY000 Message: Can not modify more than one base table through a join view
            // '%s.%s'
  ...
  public static final int ER_CANNOT_USER =
      1396; // SQLSTATE: HY000 Message: Operation %s failed for %s
  ...
  public static final int ER_XAER_RMFAIL =
      1399; // SQLSTATE: XAE07 Message: XAER_RMFAIL: The command cannot be executed when global
  ...
  public static final int ER_NONEXISTING_PROC_GRANT =
      1403; // SQLSTATE: 42000 Message: There is no such grant defined for user '%s' on host '%s' on
            // routine '%s'
  ...
  public static final int ER_SP_BAD_SQLSTATE =
      1407; // SQLSTATE: 42000 Message: Bad; //SQLSTATE: '%s'
  public static final int ER_STARTUP =
      1408; // SQLSTATE: HY000 Message: %s: ready for connections. Version: '%s' socket: '%s' port:
            // %d %s
  ...
  public static final int ER_SP_NOT_VAR_ARG =
      1414; // SQLSTATE: 42000 Message: OUT or INOUT argument %d for routine %s is not a variable or
  ...
  public static final int ER_CANT_CREATE_GEOMETRY_OBJECT =
      1416; // SQLSTATE: 22003 Message: Cannot get geometry object from data you send to the
            // GEOMETRY field
  public static final int ER_FAILED_ROUTINE_BREAK_BINLOG =
      1417; // SQLSTATE: HY000 Message: A routine failed and has neither NO SQL nor READS SQL DATA
            // in its declaration and binary logging is enabled; if non-transactional tables were
            // updated, the binary log will miss their changes
  public static final int ER_BINLOG_UNSAFE_ROUTINE =
      1418; // SQLSTATE: HY000 Message: This function has none of DETERMINISTIC, NO SQL, or READS
  ...
  public static final int ER_BINLOG_CREATE_ROUTINE_NEED_SUPER =
      1419; // SQLSTATE: HY000 Message: You do not have the SUPER privilege and binary logging is
  ...
  public static final int ER_EXEC_STMT_WITH_OPEN_CURSOR =
      1420; // SQLSTATE: HY000 Message: You can't execute a prepared statement which has an open
  ...
  public static final int ER_COMMIT_NOT_ALLOWED_IN_SF_OR_TRG =
      1422; // SQLSTATE: HY000 Message: Explicit or implicit commit is not allowed in stored
            // function or trigger.
  public static final int ER_NO_DEFAULT_FOR_VIEW_FIELD =
      1423; // SQLSTATE: HY000 Message: Field of view '%s.%s' underlying table doesn't have a
            // default value
  ...
  public static final int ER_TOO_BIG_PRECISION =
      1426; // SQLSTATE: 42000 Message: Too big precision %d specified for column '%s'. Maximum is
            // %lu.
  public static final int ER_M_BIGGER_THAN_D =
      1427; // SQLSTATE: 42000 Message: For float(M,D), double(M,D) or decimal(M,D), M must be >= D
            // (column '%s').
  public static final int ER_WRONG_LOCK_OF_SYSTEM_TABLE =
      1428; // SQLSTATE: HY000 Message: You can't combine write-locking of system tables with other
            // tables or lock types
  ...
  public static final int ER_QUERY_ON_FOREIGN_DATA_SOURCE =
      1430; // SQLSTATE: HY000 Message: There was a problem processing the query on the foreign data
            // source. Data source error: %s
  public static final int ER_FOREIGN_DATA_SOURCE_DOESNT_EXIST =
      1431; // SQLSTATE: HY000 Message: The foreign data source you are trying to reference does not
            // exist. Data source error: %s
  public static final int ER_FOREIGN_DATA_STRING_INVALID_CANT_CREATE =
      1432; // SQLSTATE: HY000 Message: Can't create federated table. The data source connection
            // string '%s' is not in the correct format
  public static final int ER_FOREIGN_DATA_STRING_INVALID =
      1433; // SQLSTATE: HY000 Message: The data source connection string '%s' is not in the correct
            // format
  ...
  public static final int ER_TRG_IN_WRONG_SCHEMA =
      1435; // SQLSTATE: HY000 Message: Trigger in wrong schema
  public static final int ER_STACK_OVERRUN_NEED_MORE =
      1436; // SQLSTATE: HY000 Message: Thread stack overrun: %ld bytes used of a %ld byte stack,
            // and %ld bytes needed. Use 'mysqld --thread_stack=#' to specify a bigger stack.
  public static final int ER_TOO_LONG_BODY =
      1437; // SQLSTATE: 42000 Message: Routine body for '%s' is too long
  ...
  public static final int ER_XAER_DUPID =
      1440; // SQLSTATE: XAE08 Message: XAER_DUPID: The XID already exists
  ...
  public static final int ER_CANT_UPDATE_USED_TABLE_IN_SF_OR_TRG =
      1442; // SQLSTATE: HY000 Message: Can't update table '%s' in stored function/trigger because
            // it is already used by statement which invoked this stored function/trigger.
  public static final int ER_VIEW_PREVENT_UPDATE =
      1443; // SQLSTATE: HY000 Message: The definition of table '%s' prevents operation %s on table
            // '%s'.
  public static final int ER_PS_NO_RECURSION =
      1444; // SQLSTATE: HY000 Message: The prepared statement contains a stored routine call that
            // refers to that same statement. It's not allowed to execute a prepared statement in
            // such a recursive manner
  public static final int ER_SP_CANT_SET_AUTOCOMMIT =
      1445; // SQLSTATE: HY000 Message: Not allowed to set autocommit from a stored function or
            // trigger
  public static final int ER_MALFORMED_DEFINER =
      1446; // SQLSTATE: HY000 Message: Definer is not fully qualified
  public static final int ER_VIEW_FRM_NO_USER =
      1447; // SQLSTATE: HY000 Message: View '%s'.'%s' has no definer information (old table
            // format). Current user is used as definer. Please recreate the view!
  public static final int ER_VIEW_OTHER_USER =
      1448; // SQLSTATE: HY000 Message: You need the SUPER privilege for creation view with
            // '%s'@'%s' definer
  ...
  public static final int ER_ROW_IS_REFERENCED_2 =
      1451; // SQLSTATE: 23000 Message: Cannot delete or update a parent row: a foreign key
            // constraint fails (%s)
  public static final int ER_NO_REFERENCED_ROW_2 =
      1452; // SQLSTATE: 23000 Message: Cannot add or update a child row: a foreign key constraint
            // fails (%s)
  ...
  public static final int ER_TRG_NO_DEFINER =
      1454; // SQLSTATE: HY000 Message: No definer attribute for trigger '%s'.'%s'. The trigger will
            // be activated under the authorization of the invoker, which may have insufficient
            // privileges. Please recreate the trigger.
  public static final int ER_OLD_FILE_FORMAT =
      1455; // SQLSTATE: HY000 Message: '%s' has an old format, you should re-create the '%s'
            // object(s)
  public static final int ER_SP_RECURSION_LIMIT =
      1456; // SQLSTATE: HY000 Message: Recursive limit %d (as set by the max_sp_recursion_depth
            // variable) was exceeded for routine %s
  public static final int ER_SP_PROC_TABLE_CORRUPT =
      1457; // SQLSTATE: HY000 Message: Failed to load routine %s. The table mysql.proc is missing,
            // corrupt, or contains bad data (internal code %d)
  public static final int ER_SP_WRONG_NAME =
      1458; // SQLSTATE: 42000 Message: Incorrect routine name '%s'
  public static final int ER_TABLE_NEEDS_UPGRADE =
      1459; // SQLSTATE: HY000 Message: Table upgrade required. Please do "REPAIR TABLE `%s`" or
  ...
  public static final int ER_MAX_PREPARED_STMT_COUNT_REACHED =
      1461; // SQLSTATE: 42000 Message: Can't create more than max_prepared_stmt_count statements
            // (current value: %lu)
  public static final int ER_VIEW_RECURSIVE =
      1462; // SQLSTATE: HY000 Message: `%s`.`%s` contains view recursion
  ...
  public static final int ER_ADMIN_WRONG_MRG_TABLE =
      1472; // SQLSTATE: HY000 Message: Table '%s' is differently defined or of non-MyISAM type or
            // doesn't exist
  ...
  public static final int ER_NAME_BECOMES_EMPTY =
      1474; // SQLSTATE: HY000 Message: Name '%s' has become ''
  public static final int ER_AMBIGUOUS_FIELD_TERM =
      1475; // SQLSTATE: HY000 Message: First character of the FIELDS TERMINATED string is
            // ambiguous; please use non-optional and non-empty FIELDS ENCLOSED BY
  public static final int ER_FOREIGN_SERVER_EXISTS =
      1476; // SQLSTATE: HY000 Message: The foreign server, %s, you are trying to create already
            // exists.
  public static final int ER_FOREIGN_SERVER_DOESNT_EXIST =
      1477; // SQLSTATE: HY000 Message: The foreign server name you are trying to reference does not
            // exist. Data source error: %s
  public static final int ER_ILLEGAL_HA_CREATE_OPTION =
      1478; // SQLSTATE: HY000 Message: Table storage engine '%s' does not support the create option
            // '%s'
  public static final int ER_PARTITION_REQUIRES_VALUES_ERROR =
      1479; // SQLSTATE: HY000 Message: Syntax error: %s PARTITIONING requires definition of VALUES
            // %s for each partition
  public static final int ER_PARTITION_WRONG_VALUES_ERROR =
      1480; // SQLSTATE: HY000 Message: Only %s PARTITIONING can use VALUES %s in partition
            // definition
  ...
  public static final int ER_PARTITION_SUBPART_MIX_ERROR =
      1483; // SQLSTATE: HY000 Message: Must define subpartitions on all partitions if on one
            // partition
  public static final int ER_PARTITION_WRONG_NO_PART_ERROR =
      1484; // SQLSTATE: HY000 Message: Wrong number of partitions defined, mismatch with previous
            // setting
  public static final int ER_PARTITION_WRONG_NO_SUBPART_ERROR =
      1485; // SQLSTATE: HY000 Message: Wrong number of subpartitions defined, mismatch with
            // previous setting
  public static final int ER_WRONG_EXPR_IN_PARTITION_FUNC_ERROR =
      1486; // SQLSTATE: HY000 Message: Constant, random or timezone-dependent expressions in
  ...
  public static final int ER_FIELD_NOT_FOUND_PART_ERROR =
      1488; // SQLSTATE: HY000 Message: Field in list of fields for partition function not found in
            // table
  ...
  public static final int ER_INCONSISTENT_PARTITION_INFO_ERROR =
      1490; // SQLSTATE: HY000 Message: The partition info in the frm file is not consistent with
  ...
  public static final int ER_RANGE_NOT_INCREASING_ERROR =
      1493; // SQLSTATE: HY000 Message: VALUES LESS THAN value must be strictly increasing for each
            // partition
  ...
  public static final int ER_MIX_HANDLER_ERROR =
      1497; // SQLSTATE: HY000 Message: The mix of handlers in the partitions is not allowed in this
            // version of MySQL
  ...
  public static final int ER_SUBPARTITION_ERROR =
      1500; // SQLSTATE: HY000 Message: It is only possible to mix RANGE/LIST partitioning with
  ...
  public static final int ER_PARTITION_MGMT_ON_NONPARTITIONED =
      1505; // SQLSTATE: HY000 Message: Partition management on a not partitioned table is not
            // possible
  public static final int ER_FOREIGN_KEY_ON_PARTITIONED =
      1506; // SQLSTATE: HY000 Message: Foreign key clause is not yet supported in conjunction with
            // partitioning
  ...
  public static final int ER_REORG_HASH_ONLY_ON_SAME_NO =
      1510; // SQLSTATE: HY000 Message: REORGANIZE PARTITION can only be used to reorganize
  ...
  public static final int ER_ADD_PARTITION_SUBPART_ERROR =
      1513; // SQLSTATE: HY000 Message: Trying to Add partition(s) with wrong number of
            // subpartitions
  ...
  public static final int ER_SAME_NAME_PARTITION =
      1517; // SQLSTATE: HY000 Message: Duplicate partition name %s
  ...
  public static final int ER_CONSECUTIVE_REORG_PARTITIONS =
      1519; // SQLSTATE: HY000 Message: When reorganizing a set of partitions they must be in
            // consecutive order
  public static final int ER_REORG_OUTSIDE_RANGE =
      1520; // SQLSTATE: HY000 Message: Reorganize of range partitions cannot change total ranges
            // except for last partition where it can extend the range
  public static final int ER_PARTITION_FUNCTION_FAILURE =
      1521; // SQLSTATE: HY000 Message: Partition function not supported in this version for this
            // handler
  ...
  public static final int ER_PLUGIN_IS_NOT_LOADED =
      1524; // SQLSTATE: HY000 Message: Plugin '%s' is not loaded
  public static final int ER_WRONG_VALUE =
      1525; // SQLSTATE: HY000 Message: Incorrect %s value: '%s'
  ...
  public static final int ER_CREATE_FILEGROUP_FAILED =
      1528; // SQLSTATE: HY000 Message: Failed to create %s
  public static final int ER_DROP_FILEGROUP_FAILED =
      1529; // SQLSTATE: HY000 Message: Failed to drop %s
  ...
  public static final int ER_WRONG_SIZE_NUMBER =
      1531; // SQLSTATE: HY000 Message: A size parameter was incorrectly specified, either number or
            // on the form 10M
  public static final int ER_SIZE_OVERFLOW_ERROR =
      1532; // SQLSTATE: HY000 Message: The size number was correct but we don't allow the digit
            // part to be more than 2 billion
  public static final int ER_ALTER_FILEGROUP_FAILED =
      1533; // SQLSTATE: HY000 Message: Failed to alter: %s
  ...
  public static final int ER_BINLOG_ROW_RBR_TO_SBR =
      1536; // SQLSTATE: HY000 Message: Replica running with --log-replica-updates must use
            // row-based binary logging to be able to replicate row-based binary log events
  public static final int ER_EVENT_ALREADY_EXISTS =
      1537; // SQLSTATE: HY000 Message: Event '%s' already exists
  ...
  public static final int ER_EVENT_DOES_NOT_EXIST =
      1539; // SQLSTATE: HY000 Message: Unknown event '%s'
  public static final int ER_EVENT_CANT_ALTER =
      1540; // SQLSTATE: HY000 Message: Failed to alter event '%s'
  ...
  public static final int ER_EVENT_OPEN_TABLE_FAILED =
      1545; // SQLSTATE: HY000 Message: Failed to open mysql.event
  ...
  public static final int ER_COL_COUNT_DOESNT_MATCH_CORRUPTED =
      1547; // SQLSTATE: HY000 Message: Column count of mysql.%s is wrong. Expected %d, found %d.
  ...
  public static final int ER_EVENT_SAME_NAME =
      1551; // SQLSTATE: HY000 Message: Same old and new event name
  public static final int ER_EVENT_DATA_TOO_LONG =
      1552; // SQLSTATE: HY000 Message: Data for column '%s' too long
  ...
  public static final int ER_WARN_DEPRECATED_SYNTAX_WITH_VER =
      1554; // SQLSTATE: HY000 Message: The syntax '%s' is deprecated and will be removed in MySQL
            // %s. Please use %s instead
  public static final int ER_CANT_WRITE_LOCK_LOG_TABLE =
      1555; // SQLSTATE: HY000 Message: You can't write-lock a log table. Only read access is
            // possible
  ...
  public static final int ER_FOREIGN_DUPLICATE_KEY =
      1557; // SQLSTATE: 23000 Message: Upholding foreign key constraints for table '%s', entry
            // '%s', key %d would lead to a duplicate entry
  public static final int ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE =
      1558; // SQLSTATE: HY000 Message: Column count of mysql.%s is wrong. Expected %d, found %d.
            // Created with MySQL %d, now running %d. Please use mysql_upgrade to fix this error.
  public static final int ER_TEMP_TABLE_PREVENTS_SWITCH_OUT_OF_RBR =
      1559; // SQLSTATE: HY000 Message: Cannot switch out of the row-based binary log format when
            // the session has open temporary tables
  public static final int ER_STORED_FUNCTION_PREVENTS_SWITCH_BINLOG_FORMAT =
      1560; // SQLSTATE: HY000 Message: Cannot change the binary logging format inside a stored
            // function or trigger
  public static final int ER_NDB_CANT_SWITCH_BINLOG_FORMAT =
      1561; // SQLSTATE: HY000 Message: The NDB cluster engine does not support changing the binlog
  ...
  public static final int ER_WRONG_PARTITION_NAME =
      1567; // SQLSTATE: HY000 Message: Incorrect partition name
  public static final int ER_CANT_CHANGE_TX_ISOLATION =
      1568; // SQLSTATE: 25001 Message: Transaction isolation level can't be changed while a
            // transaction is in progress
  public static final int ER_DUP_ENTRY_AUTOINCREMENT_CASE =
      1569; // SQLSTATE: HY000 Message: ALTER TABLE causes auto_increment resequencing, resulting in
  ...
  public static final int ER_EVENT_SET_VAR_ERROR =
      1571; // SQLSTATE: HY000 Message: Error during starting/stopping of the scheduler. Error code
            // %u
  ...
  public static final int ER_CANT_ACTIVATE_LOG =
      1573; // SQLSTATE: HY000 Message: Cannot activate '%s' log
  ...
  public static final int ER_BASE64_DECODE_ERROR =
      1575; // SQLSTATE: HY000 Message: Decoding of base64 string failed
  public static final int ER_EVENT_RECURSION_FORBIDDEN =
      1576; // SQLSTATE: HY000 Message: Recursion of EVENT DDL statements is forbidden when body is
            // present
  public static final int ER_EVENTS_DB_ERROR =
      1577; // SQLSTATE: HY000 Message: Cannot proceed because system tables used by Event Scheduler
  ...
  public static final int ER_CANT_RENAME_LOG_TABLE =
      1581; // SQLSTATE: HY000 Message: Cannot rename '%s'. When logging enabled, rename to/from log
            // table must rename two tables: the log table to an archive table and another table
            // back to '%s'
  public static final int ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT =
      1582; // SQLSTATE: 42000 Message: Incorrect parameter count in the call to native function
            // '%s'
  ...
  public static final int ER_EVENT_CANNOT_CREATE_IN_THE_PAST =
      1588; // SQLSTATE: HY000 Message: Event execution time is in the past and ON COMPLETION NOT
  ...
  public static final int ER_EVENT_CANNOT_ALTER_IN_THE_PAST =
      1589; // SQLSTATE: HY000 Message: Event execution time is in the past and ON COMPLETION NOT
            // PRESERVE is set. The event was dropped immediately after creation.
  @Deprecated public static final int ER_SLAVE_INCIDENT = 1590;
  public static final int ER_REPLICA_INCIDENT =
      1590; // SQLSTATE: HY000 Message: The incident %s occured on the source. Message: %s
  ...
  public static final int ER_BINLOG_UNSAFE_STATEMENT =
      1592; // SQLSTATE: HY000 Message: Unsafe statement written to the binary log using statement
            // format since BINLOG_FORMAT = STATEMENT. %s
  @Deprecated public static final int ER_SLAVE_FATAL_ERROR = 1593;
  public static final int ER_REPLICA_FATAL_ERROR = 1593; // SQLSTATE: HY000 Message: Fatal error: %s
  @Deprecated public static final int ER_SLAVE_RELAY_LOG_READ_FAILURE = 1594;
  public static final int ER_REPLICA_RELAY_LOG_READ_FAILURE =
      1594; // SQLSTATE: HY000 Message: Relay log read failure: %s
  @Deprecated public static final int ER_SLAVE_RELAY_LOG_WRITE_FAILURE = 1595;
  public static final int ER_REPLICA_RELAY_LOG_WRITE_FAILURE =
      1595; // SQLSTATE: HY000 Message: Relay log write failure: %s
  @Deprecated public static final int ER_SLAVE_CREATE_EVENT_FAILURE = 1596;
  public static final int ER_REPLICA_CREATE_EVENT_FAILURE =
      1596; // SQLSTATE: HY000 Message: Failed to create %s
  @Deprecated public static final int ER_SLAVE_MASTER_COM_FAILURE = 1597;
  public static final int ER_REPLICA_SOURCE_COM_FAILURE =
      1597; // SQLSTATE: HY000 Message: Source command %s failed: %s
  ...
  public static final int ER_NEVER_USED =
      1608; // SQLSTATE: HY000 Message: Ambiguous replica modes combination. %s
  public static final int ER_NO_FORMAT_DESCRIPTION_EVENT_BEFORE_BINLOG_STATEMENT =
      1609; // SQLSTATE: HY000 Message: The BINLOG statement of type `%s` was not preceded by a
            // format description BINLOG statement.
  @Deprecated public static final int ER_SLAVE_CORRUPT_EVENT = 1610;
  public static final int ER_REPLICA_CORRUPT_EVENT =
  ...
  public static final int ER_LOG_PURGE_NO_FILE =
      1612; // SQLSTATE: HY000 Message: Being purged log %s was not found
  public static final int ER_XA_RBTIMEOUT =
      1613; // SQLSTATE: XA106 Message: XA_RBTIMEOUT: Transaction branch was rolled back: took too
            // long
  public static final int ER_XA_RBDEADLOCK =
      1614; // SQLSTATE: XA102 Message: XA_RBDEADLOCK: Transaction branch was rolled back: deadlock
            // was detected
  ...
  @Deprecated public static final int WARN_NO_MASTER_INFO = 1617;
  public static final int WARN_NO_SOURCE_INFO =
      1617; // SQLSTATE: HY000 Message: The source info structure does not exist
  public static final int WARN_OPTION_IGNORED =
      1618; // SQLSTATE: HY000 Message: <%s> option ignored
  ...
  public static final int ER_VARIABLE_IS_READONLY =
      1621; // SQLSTATE: HY000 Message: %s variable '%s' is read-only. Use SET %s to assign the
            // value
  public static final int ER_WARN_ENGINE_TRANSACTION_ROLLBACK =
      1622; // SQLSTATE: HY000 Message: Storage engine %s does not support rollback for this
            // statement. Transaction rolled back and must be restarted
  @Deprecated public static final int ER_SLAVE_HEARTBEAT_FAILURE = 1623;
  public static final int ER_REPLICA_HEARTBEAT_FAILURE =
      1623; // SQLSTATE: HY000 Message: Unexpected source's heartbeat data: %s
  @Deprecated public static final int ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE = 1624;
  public static final int ER_REPLICA_HEARTBEAT_VALUE_OUT_OF_RANGE =
      1624; // SQLSTATE: HY000 Message: The requested value for the heartbeat period is either
  ...
  public static final int ER_FUNC_INEXISTENT_NAME_COLLISION =
      1630; // SQLSTATE: 42000 Message: FUNCTION %s does not exist. Check the 'Function Name Parsing
  ...
  public static final int ER_DEBUG_SYNC_TIMEOUT =
      1639; // SQLSTATE: HY000 Message: debug sync point wait timed out
  ...
  public static final int ER_SIGNAL_WARN =
      1642; // SQLSTATE: 01000 Message: Unhandled user-defined warning condition
  ...
  public static final int ER_SIGNAL_BAD_CONDITION_TYPE =
      1646; // SQLSTATE: HY000 Message: SIGNAL/RESIGNAL can only use a CONDITION defined with;
            // //SQLSTATE
  ...
  @Deprecated public static final int ER_SLAVE_IGNORE_SERVER_IDS = 1650;
  public static final int ER_REPLICA_IGNORE_SERVER_IDS =
      1650; // SQLSTATE: HY000 Message: The requested server id %d clashes with the replica startup
            // option --replicate-same-server-id
  public static final int ER_QUERY_CACHE_DISABLED =
      1651; // SQLSTATE: HY000 Message: Query cache is disabled; restart the server with
  ...
  public static final int ER_TOO_MANY_VALUES_ERROR =
      1657; // SQLSTATE: HY000 Message: Cannot have more than one value for this type of %s
            // partitioning
  public static final int ER_ROW_SINGLE_PARTITION_FIELD_ERROR =
      1658; // SQLSTATE: HY000 Message: Row expressions in VALUES IN only allowed for multi-field
            // column partitioning
  public static final int ER_FIELD_TYPE_NOT_ALLOWED_AS_PARTITION_FIELD =
      1659; // SQLSTATE: HY000 Message: Field '%s' is of a not allowed type for this type of
            // partitioning
  ...
  public static final int ER_BINLOG_ROW_ENGINE_AND_STMT_ENGINE =
      1661; // SQLSTATE: HY000 Message: Cannot execute statement: impossible to write to binary log
            // since both row-incapable engines and statement-incapable engines are involved.
  public static final int ER_BINLOG_ROW_MODE_AND_STMT_ENGINE =
      1662; // SQLSTATE: HY000 Message: Cannot execute statement: impossible to write to binary log
            // since BINLOG_FORMAT = ROW and at least one table uses a storage engine limited to
            // statement-based logging.
  public static final int ER_BINLOG_UNSAFE_AND_STMT_ENGINE =
      1663; // SQLSTATE: HY000 Message: Cannot execute statement: impossible to write to binary log
            // since statement is unsafe, storage engine is limited to statement-based logging, and
            // BINLOG_FORMAT = MIXED. %s
  public static final int ER_BINLOG_ROW_INJECTION_AND_STMT_ENGINE =
      1664; // SQLSTATE: HY000 Message: Cannot execute statement: impossible to write to binary log
            // since statement is in row format and at least one table uses a storage engine limited
            // to statement-based logging.
  public static final int ER_BINLOG_STMT_MODE_AND_ROW_ENGINE =
      1665; // SQLSTATE: HY000 Message: Cannot execute statement: impossible to write to binary log
            // since BINLOG_FORMAT = STATEMENT and at least one table uses a storage engine limited
            // to row-based logging.%s
  public static final int ER_BINLOG_ROW_INJECTION_AND_STMT_MODE =
      1666; // SQLSTATE: HY000 Message: Cannot execute statement: impossible to write to binary log
  ...
  public static final int ER_BINLOG_MULTIPLE_ENGINES_AND_SELF_LOGGING_ENGINE =
      1667; // SQLSTATE: HY000 Message: Cannot execute statement: impossible to write to binary log
            // since more than one engine is involved and at least one engine is self-logging.
  public static final int ER_BINLOG_UNSAFE_LIMIT =
      1668; // SQLSTATE: HY000 Message: The statement is unsafe because it uses a LIMIT clause. This
            // is unsafe because the set of rows included cannot be predicted.
  public static final int ER_BINLOG_UNSAFE_INSERT_DELAYED =
      1669; // SQLSTATE: HY000 Message: The statement is unsafe because it uses INSERT DELAYED. This
            // is unsafe because the times when rows are inserted cannot be predicted.
  public static final int ER_BINLOG_UNSAFE_SYSTEM_TABLE =
      1670; // SQLSTATE: HY000 Message: The statement is unsafe because it uses the general log,
            // slow query log, or performance_schema table(s). This is unsafe because system tables
            // may differ on replicas.
  public static final int ER_BINLOG_UNSAFE_AUTOINC_COLUMNS =
      1671; // SQLSTATE: HY000 Message: Statement is unsafe because it invokes a trigger or a stored
            // function that inserts into an AUTO_INCREMENT column. Inserted values cannot be logged
            // correctly.
  public static final int ER_BINLOG_UNSAFE_UDF =
      1672; // SQLSTATE: HY000 Message: Statement is unsafe because it uses a UDF which may not
            // return the same value on the replica.
  public static final int ER_BINLOG_UNSAFE_SYSTEM_VARIABLE =
      1673; // SQLSTATE: HY000 Message: Statement is unsafe because it uses a system variable that
            // may have a different value on the replica.
  public static final int ER_BINLOG_UNSAFE_SYSTEM_FUNCTION =
      1674; // SQLSTATE: HY000 Message: Statement is unsafe because it uses a system function that
            // may return a different value on the replica.
  public static final int ER_BINLOG_UNSAFE_NONTRANS_AFTER_TRANS =
      1675; // SQLSTATE: HY000 Message: Statement is unsafe because it accesses a non-transactional
            // table after accessing a transactional table within the same transaction.
  public static final int ER_MESSAGE_AND_STATEMENT =
      1676; // SQLSTATE: HY000 Message: %s Statement: %s
  @Deprecated public static final int ER_SLAVE_CONVERSION_FAILED = 1677;
  public static final int ER_REPLICA_CONVERSION_FAILED =
      1677; // SQLSTATE: HY000 Message: Column %d of table '%s.%s' cannot be converted from type
            // '%s' to type '%s'
  @Deprecated public static final int ER_SLAVE_CANT_CREATE_CONVERSION = 1678;
  public static final int ER_REPLICA_CANT_CREATE_CONVERSION =
  ...
  public static final int ER_PATH_LENGTH =
      1680; // SQLSTATE: HY000 Message: The path specified for %s is too long.
  public static final int ER_WARN_DEPRECATED_SYNTAX_NO_REPLACEMENT =
      1681; // SQLSTATE: HY000 Message: The syntax '%s' is deprecated and will be removed in MySQL
            // %s.
  ...
  public static final int ER_WARN_I_S_SKIPPED_TABLE =
      1684; // SQLSTATE: HY000 Message: Table '%s'.'%s' was skipped since its definition is being
            // modified by concurrent DDL statement
  public static final int ER_INSIDE_TRANSACTION_PREVENTS_SWITCH_BINLOG_DIRECT =
      1685; // SQLSTATE: HY000 Message: Cannot modify
  ...
  public static final int ER_STORED_FUNCTION_PREVENTS_SWITCH_BINLOG_DIRECT =
      1686; // SQLSTATE: HY000 Message: Cannot change the binlog direct flag inside a stored
            // function or trigger
  ...
  public static final int ER_DATA_OUT_OF_RANGE =
      1690; // SQLSTATE: 22003 Message: %s value is out of range in '%s'
  ...
  public static final int ER_BINLOG_UNSAFE_MULTIPLE_ENGINES_AND_SELF_LOGGING_ENGINE =
      1692; // SQLSTATE: HY000 Message: Mixing self-logging and non-self-logging engines in a
            // statement is unsafe.
  public static final int ER_BINLOG_UNSAFE_MIXED_STATEMENT =
      1693; // SQLSTATE: HY000 Message: Statement accesses nontransactional table as well as
  ...
  public static final int ER_STORED_FUNCTION_PREVENTS_SWITCH_SQL_LOG_BIN =
      1695; // SQLSTATE: HY000 Message: Cannot change the sql_log_bin inside a stored function or
            // trigger
  ...
  public static final int ER_SET_PASSWORD_AUTH_PLUGIN =
      1699; // SQLSTATE: HY000 Message: SET PASSWORD has no significance for users authenticating
            // via plugins
  public static final int ER_GRANT_PLUGIN_USER_EXISTS =
      1700; // SQLSTATE: HY000 Message: GRANT with IDENTIFIED WITH is illegal because the user %-.*s
            // already exists
  public static final int ER_TRUNCATE_ILLEGAL_FK =
      1701; // SQLSTATE: 42000 Message: Cannot truncate a table referenced in a foreign key
            // constraint (%s)
  ...
  @Deprecated public static final int ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MIN = 1703;
  public static final int ER_REPLICA_HEARTBEAT_VALUE_OUT_OF_RANGE_MIN =
      1703; // SQLSTATE: HY000 Message: The requested value for the heartbeat period is less than 1
            // millisecond. The value is reset to 0, meaning that heartbeating will effectively be
            // disabled.
  @Deprecated public static final int ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MAX = 1704;
  public static final int ER_REPLICA_HEARTBEAT_VALUE_OUT_OF_RANGE_MAX =
      1704; // SQLSTATE: HY000 Message: The requested value for the heartbeat period exceeds the
            // value of `replica_net_timeout' seconds. A sensible value for the period should be
            // less than the timeout.
  public static final int ER_STMT_CACHE_FULL =
      1705; // SQLSTATE: HY000 Message: Multi-row statements required more than
  ...
  public static final int ER_MULTI_UPDATE_KEY_CONFLICT =
      1706; // SQLSTATE: HY000 Message: Primary key/partition key update is not allowed since the
            // table is updated both as '%s' and '%s'.
  public static final int ER_TABLE_NEEDS_REBUILD =
      1707; // SQLSTATE: HY000 Message: Table rebuild required. Please do "ALTER TABLE `%s` FORCE"
  ...
  public static final int ER_INDEX_COLUMN_TOO_LONG =
      1709; // SQLSTATE: HY000 Message: Index column size too large. The maximum column size is %lu
            // bytes.
  ...
  public static final int ER_UNDO_RECORD_TOO_BIG =
      1713; // SQLSTATE: HY000 Message: Undo log record is too big.
  public static final int ER_BINLOG_UNSAFE_INSERT_IGNORE_SELECT =
      1714; // SQLSTATE: HY000 Message: INSERT IGNORE... SELECT is unsafe because the order in which
            // rows are retrieved by the SELECT determines which (if any) rows are ignored. This
  ...
  public static final int ER_BINLOG_UNSAFE_INSERT_SELECT_UPDATE =
      1715; // SQLSTATE: HY000 Message: INSERT... SELECT... ON DUPLICATE KEY UPDATE is unsafe
            // because the order in which rows are retrieved by the SELECT determines which (if any)
            // rows are updated. This order cannot be predicted and may differ on source and the
            // replica.
  public static final int ER_BINLOG_UNSAFE_REPLACE_SELECT =
      1716; // SQLSTATE: HY000 Message: REPLACE... SELECT is unsafe because the order in which rows
            // are retrieved by the SELECT determines which (if any) rows are replaced. This order
  ...
  public static final int ER_BINLOG_UNSAFE_CREATE_IGNORE_SELECT =
      1717; // SQLSTATE: HY000 Message: CREATE... IGNORE SELECT is unsafe because the order in which
            // rows are retrieved by the SELECT determines which (if any) rows are ignored. This
            // order cannot be predicted and may differ on source and the replica.
  public static final int ER_BINLOG_UNSAFE_CREATE_REPLACE_SELECT =
      1718; // SQLSTATE: HY000 Message: CREATE... REPLACE SELECT is unsafe because the order in
            // which rows are retrieved by the SELECT determines which (if any) rows are replaced.
  ...
  public static final int ER_BINLOG_UNSAFE_UPDATE_IGNORE =
      1719; // SQLSTATE: HY000 Message: UPDATE IGNORE is unsafe because the order in which rows are
            // updated determines which (if any) rows are ignored. This order cannot be predicted
            // and may differ on source and the replica.
  public static final int ER_PLUGIN_NO_UNINSTALL =
      1720; // SQLSTATE: HY000 Message: Plugin '%s' is marked as not dynamically uninstallable. You
            // have to stop the server to uninstall it.
  public static final int ER_PLUGIN_NO_INSTALL =
      1721; // SQLSTATE: HY000 Message: Plugin '%s' is marked as not dynamically installable. You
            // have to stop the server to install it.
  public static final int ER_BINLOG_UNSAFE_WRITE_AUTOINC_SELECT =
      1722; // SQLSTATE: HY000 Message: Statements writing to a table with an auto-increment column
            // after selecting from another table are unsafe because the order in which rows are
            // retrieved determines what (if any) rows will be written. This order cannot be
            // predicted and may differ on source and the replica.
  public static final int ER_BINLOG_UNSAFE_CREATE_SELECT_AUTOINC =
      1723; // SQLSTATE: HY000 Message: CREATE TABLE... SELECT... on a table with an auto-increment
            // column is unsafe because the order in which rows are retrieved by the SELECT
            // determines which (if any) rows are inserted. This order cannot be predicted and may
            // differ on source and the replica.
  public static final int ER_BINLOG_UNSAFE_INSERT_TWO_KEYS =
      1724; // SQLSTATE: HY000 Message: INSERT... ON DUPLICATE KEY UPDATE on a table with more than
  ...
  public static final int ER_BINLOG_UNSAFE_AUTOINC_NOT_FIRST =
      1727; // SQLSTATE: HY000 Message: INSERT into autoincrement field which is not the first part
            // in the composed primary key is unsafe.
  ...
  @Deprecated public static final int ER_MASTER_DELAY_VALUE_OUT_OF_RANGE = 1729;
  public static final int ER_SOURCE_DELAY_VALUE_OUT_OF_RANGE =
      1729; // SQLSTATE: HY000 Message: The requested value %u for the source delay exceeds the
            // maximum %u
  public static final int ER_ONLY_FD_AND_RBR_EVENTS_ALLOWED_IN_BINLOG_STATEMENT =
      1730; // SQLSTATE: HY000 Message: Only Format_description_log_event and row events are allowed
            // in BINLOG statements (but %s was provided)
  ...
  public static final int ER_BINLOG_CACHE_SIZE_GREATER_THAN_MAX =
      1738; // SQLSTATE: HY000 Message: Option binlog_cache_size (%lu) is greater than
            // max_binlog_cache_size (%lu); setting binlog_cache_size equal to
            // max_binlog_cache_size.
  public static final int ER_WARN_INDEX_NOT_APPLICABLE =
      1739; // SQLSTATE: HY000 Message: Cannot use %s access on index '%s' due to type or collation
            // conversion on field '%s'
  public static final int ER_PARTITION_EXCHANGE_FOREIGN_KEY =
      1740; // SQLSTATE: HY000 Message: Table to exchange with partition has foreign key references:
            // '%s'
  ...
  public static final int ER_RPL_INFO_DATA_TOO_LONG =
      1742; // SQLSTATE: HY000 Message: Data for column '%s' too long
  public static final int ER_NETWORK_READ_EVENT_CHECKSUM_FAILURE =
      1743; // SQLSTATE: HY000 Message: Replication event checksum verification failed while reading
            // from network.
  public static final int ER_BINLOG_READ_EVENT_CHECKSUM_FAILURE =
      1744; // SQLSTATE: HY000 Message: Replication event checksum verification failed while reading
            // from a log file.
  ...
  public static final int ER_CHANGE_RPL_INFO_REPOSITORY_FAILURE =
      1750; // SQLSTATE: HY000 Message: Failure while changing the type of replication repository:
            // %s.
  public static final int ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_CREATED_TEMP_TABLE =
      1751; // SQLSTATE: HY000 Message: The creation of some temporary tables could not be rolled
            // back.
  public static final int ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_DROPPED_TEMP_TABLE =
      1752; // SQLSTATE: HY000 Message: Some temporary tables were dropped, but these operations
  ...
  public static final int ER_MTS_UPDATED_DBS_GREATER_MAX =
      1754; // SQLSTATE: HY000 Message: The number of modified databases exceeds the maximum %d; the
            // database names will not be included in the replication event metadata.
  public static final int ER_MTS_CANT_PARALLEL =
      1755; // SQLSTATE: HY000 Message: Cannot execute the current event group in the parallel mode.
            // Encountered event %s, relay-log name %s, position %s which prevents execution of this
            // event group in parallel mode. Reason: %s.
  ...
  public static final int ER_DA_INVALID_CONDITION_NUMBER =
      1758; // SQLSTATE: 35000 Message: Invalid condition number
  public static final int ER_INSECURE_PLAIN_TEXT =
      1759; // SQLSTATE: HY000 Message: Sending passwords in plain text without SSL/TLS is extremely
            // insecure.
  @Deprecated public static final int ER_INSECURE_CHANGE_MASTER = 1760;
  public static final int ER_INSECURE_CHANGE_SOURCE =
      1760; // SQLSTATE: HY000 Message: Storing MySQL user name or password information in the
            // source.info repository is not secure and is therefore not recommended. Please see the
  ...
  public static final int ER_FOREIGN_DUPLICATE_KEY_WITH_CHILD_INFO =
      1761; // SQLSTATE: 23000 Message: Foreign key constraint for table '%s', record '%s' would
            // lead to a duplicate entry in table '%s', key '%s'
  public static final int ER_FOREIGN_DUPLICATE_KEY_WITHOUT_CHILD_INFO =
      1762; // SQLSTATE: 23000 Message: Foreign key constraint for table '%s', record '%s' would
            // lead to a duplicate entry in a child table
  @Deprecated public static final int ER_SQLTHREAD_WITH_SECURE_SLAVE = 1763;
  public static final int ER_SQLTHREAD_WITH_SECURE_REPLICA =
      1763; // SQLSTATE: HY000 Message: Setting authentication options is not possible when only the
            // Replica SQL Thread is being started.
  ...
  public static final int ER_VARIABLE_NOT_SETTABLE_IN_SF_OR_TRIGGER =
      1765; // SQLSTATE: HY000 Message: The system variable %s cannot be set in stored functions or
            // triggers.
  public static final int ER_VARIABLE_NOT_SETTABLE_IN_TRANSACTION =
      1766; // SQLSTATE: HY000 Message: The system variable %s cannot be set when there is an
            // ongoing transaction.
  public static final int ER_GTID_NEXT_IS_NOT_IN_GTID_NEXT_LIST =
      1767; // SQLSTATE: HY000 Message: The system variable @@SESSION.GTID_NEXT has the value %s,
  ...
  public static final int ER_GTID_NEXT_CANT_BE_AUTOMATIC_IF_GTID_NEXT_LIST_IS_NON_NULL =
      1770; // SQLSTATE: HY000 Message: The system variable @@SESSION.GTID_NEXT cannot be
            // 'AUTOMATIC' when @@SESSION.GTID_NEXT_LIST is non-NULL.
  public static final int ER_SKIPPING_LOGGED_TRANSACTION =
      1771; // SQLSTATE: HY000 Message: Skipping transaction %s because it has already been executed
            // and logged.
  ...
  public static final int ER_GNO_EXHAUSTED =
      1775; // SQLSTATE: HY000 Message: Impossible to generate Global Transaction Identifier: the
            // integer component reached the maximal value. Restart the server with a new
            // server_uuid.
  @Deprecated public static final int ER_BAD_SLAVE_AUTO_POSITION = 1776;
  public static final int ER_BAD_REPLICA_AUTO_POSITION =
      1776; // SQLSTATE: HY000 Message: Parameters SOURCE_LOG_FILE, SOURCE_LOG_POS, RELAY_LOG_FILE
  ...
  public static final int ER_AUTO_POSITION_REQUIRES_GTID_MODE_ON =
      1777; // SQLSTATE: HY000 Message: CHANGE SOURCE TO SOURCE_AUTO_POSITION = 1 can only be
            // executed when GTID_MODE = ON.
  public static final int ER_CANT_DO_IMPLICIT_COMMIT_IN_TRX_WHEN_GTID_NEXT_IS_SET =
      1778; // SQLSTATE: HY000 Message: Cannot execute statements with implicit commit inside a
            // transaction when GTID_NEXT != AUTOMATIC or GTID_NEXT_LIST != NULL.
  ...
  public static final int ER_GTID_MODE_REQUIRES_BINLOG =
      1780; // SQLSTATE: HY000 Message: GTID_MODE = ON or UPGRADE_STEP_1 or UPGRADE_STEP_2 requires
            // --log-bin and --log-replica-updates.
  ...
  public static final int ER_CANT_SET_GTID_NEXT_LIST_TO_NON_NULL_WHEN_GTID_MODE_IS_OFF =
      1783; // SQLSTATE: HY000 Message: GTID_NEXT_LIST cannot be set to a non-NULL value when
            // GTID_MODE = OFF.
  public static final int ER_FOUND_GTID_EVENT_WHEN_GTID_MODE_IS_OFF =
      1784; // SQLSTATE: HY000 Message: Found a Gtid_log_event or Previous_gtids_log_event when
            // GTID_MODE = OFF.
  public static final int ER_GTID_UNSAFE_NON_TRANSACTIONAL_TABLE =
      1785; // SQLSTATE: HY000 Message: When ENFORCE_GTID_CONSISTENCY = 1, updates to
            // non-transactional tables can only be done in either autocommitted statements or
  ...
  public static final int ER_GTID_UNSAFE_CREATE_SELECT =
      1786; // SQLSTATE: HY000 Message: CREATE TABLE ... SELECT is forbidden when
            // ENFORCE_GTID_CONSISTENCY = 1.
  public static final int ER_GTID_UNSAFE_CREATE_DROP_TEMPORARY_TABLE_IN_TRANSACTION =
      1787; // SQLSTATE: HY000 Message: When ENFORCE_GTID_CONSISTENCY = 1, the statements CREATE
  ...
  public static final int ER_GTID_MODE_CAN_ONLY_CHANGE_ONE_STEP_AT_A_TIME =
      1788; // SQLSTATE: HY000 Message: The value of GTID_MODE can only change one step at a time:
            // OFF <-> UPGRADE_STEP_1 <-> UPGRADE_STEP_2 <-> ON. Also note that this value must be
            // stepped up or down simultaneously on all servers; see the Manual for instructions.
  @Deprecated public static final int ER_MASTER_HAS_PURGED_REQUIRED_GTIDS = 1789;
  public static final int ER_SOURCE_HAS_PURGED_REQUIRED_GTIDS =
      1789; // SQLSTATE: HY000 Message: The replica is connecting using CHANGE SOURCE TO
            // SOURCE_AUTO_POSITION = 1, but the source has purged binary logs containing GTIDs that
            // the replica requires.
  public static final int ER_CANT_SET_GTID_NEXT_WHEN_OWNING_GTID =
      1790; // SQLSTATE: HY000 Message: GTID_NEXT cannot be changed by a client that owns a GTID.
  ...
  @Deprecated public static final int ER_SLAVE_CONFIGURATION = 1794;
  public static final int ER_REPLICA_CONFIGURATION =
      1794; // SQLSTATE: HY000 Message: Replica is not configured or failed to initialize properly.
            // You must at least set --server-id to enable either a source or a replica. Additional
            // error messages can be found in the MySQL error log.
  public static final int ER_INNODB_FT_LIMIT =
      1795; // SQLSTATE: HY000 Message: InnoDB presently supports one FULLTEXT index creation at a
            // time
  ...
  public static final int ER_INNODB_ONLINE_LOG_TOO_BIG =
      1799; // SQLSTATE: HY000 Message: Creating index '%s' required more than
  ...
  public static final int ER_UNKNOWN_ALTER_ALGORITHM =
      1800; // SQLSTATE: HY000 Message: Unknown ALGORITHM '%s'
  public static final int ER_UNKNOWN_ALTER_LOCK =
      1801; // SQLSTATE: HY000 Message: Unknown LOCK type '%s'
  @Deprecated public static final int ER_MTS_CHANGE_MASTER_CANT_RUN_WITH_GAPS = 1802;
  public static final int ER_MTS_CHANGE_SOURCE_CANT_RUN_WITH_GAPS =
      1802; // SQLSTATE: HY000 Message: CHANGE SOURCE cannot be executed when the replica was
            // stopped with an error or killed in MTS mode. Consider using RESET REPLICA or START
            // REPLICA UNTIL.
  public static final int ER_MTS_RECOVERY_FAILURE =
      1803; // SQLSTATE: HY000 Message: Cannot recover after REPLICA errored out in parallel
            // execution mode. Additional error messages can be found in the MySQL error log.
  public static final int ER_MTS_RESET_WORKERS =
      1804; // SQLSTATE: HY000 Message: Cannot clean up worker info tables. Additional error
            // messages can be found in the MySQL error log.
  public static final int ER_COL_COUNT_DOESNT_MATCH_CORRUPTED_V2 =
      1805; // SQLSTATE: HY000 Message: Column count of %s.%s is wrong. Expected %d, found %d. The
            // table is probably corrupted
  @Deprecated public static final int ER_SLAVE_SILENT_RETRY_TRANSACTION = 1806;
  public static final int ER_REPLICA_SILENT_RETRY_TRANSACTION =
  ...
  public static final int ER_DISCARD_FK_CHECKS_RUNNING =
      1807; // SQLSTATE: HY000 Message: There is a foreign key check running on table '%s'. Cannot
            // discard the table.
  public static final int ER_TABLE_SCHEMA_MISMATCH =
      1808; // SQLSTATE: HY000 Message: Schema mismatch (%s)
  ...
  public static final int ER_IO_READ_ERROR =
      1810; // SQLSTATE: HY000 Message: IO Read error: (%lu, %s) %s
  public static final int ER_IO_WRITE_ERROR =
      1811; // SQLSTATE: HY000 Message: IO Write error: (%lu, %s) %s
  ...
  public static final int ER_TABLESPACE_EXISTS =
      1813; // SQLSTATE: HY000 Message: Tablespace for table '%s' exists. Please DISCARD the
  ...
  public static final int ER_INNODB_IMPORT_ERROR =
      1816; // SQLSTATE: HY000 Message: ALTER TABLE '%s' IMPORT TABLESPACE failed with error %lu :
            // '%s'
  public static final int ER_INNODB_INDEX_CORRUPT =
      1817; // SQLSTATE: HY000 Message: Index corrupt: %s
  public static final int ER_INVALID_YEAR_COLUMN_LENGTH =
      1818; // SQLSTATE: HY000 Message: YEAR(%lu) column type is deprecated. Creating YEAR(4) column
            // instead.
  public static final int ER_NOT_VALID_PASSWORD =
      1819; // SQLSTATE: HY000 Message: Your password does not satisfy the current policy
            // requirements
  ...
  public static final int ER_FK_NO_INDEX_CHILD =
      1821; // SQLSTATE: HY000 Message: Failed to add the foreign key constaint. Missing index for
            // constraint '%s' in the foreign table '%s'
  public static final int ER_FK_NO_INDEX_PARENT =
      1822; // SQLSTATE: HY000 Message: Failed to add the foreign key constaint. Missing index for
            // constraint '%s' in the referenced table '%s'
  public static final int ER_FK_FAIL_ADD_SYSTEM =
      1823; // SQLSTATE: HY000 Message: Failed to add the foreign key constraint '%s' to system
            // tables
  ...
  public static final int ER_FK_INCORRECT_OPTION =
      1825; // SQLSTATE: HY000 Message: Failed to add the foreign key constraint on table '%s'.
  ...
  public static final int ER_PASSWORD_FORMAT =
      1827; // SQLSTATE: HY000 Message: The password hash doesn't have the expected format. Check if
            // the correct password algorithm is being used with the PASSWORD() function.
  public static final int ER_FK_COLUMN_CANNOT_DROP =
      1828; // SQLSTATE: HY000 Message: Cannot drop column '%s': needed in a foreign key constraint
            // '%s'
  public static final int ER_FK_COLUMN_CANNOT_DROP_CHILD =
      1829; // SQLSTATE: HY000 Message: Cannot drop column '%s': needed in a foreign key constraint
            // '%s' of table '%s'
  public static final int ER_FK_COLUMN_NOT_NULL =
      1830; // SQLSTATE: HY000 Message: Column '%s' cannot be NOT NULL: needed in a foreign key
            // constraint '%s' SET NULL
  public static final int ER_DUP_INDEX =
      1831; // SQLSTATE: HY000 Message: Duplicate index '%s' defined on the table '%s.%s'. This is
            // deprecated and will be disallowed in a future release.
  public static final int ER_FK_COLUMN_CANNOT_CHANGE =
      1832; // SQLSTATE: HY000 Message: Cannot change column '%s': used in a foreign key constraint
            // '%s'
  public static final int ER_FK_COLUMN_CANNOT_CHANGE_CHILD =
      1833; // SQLSTATE: HY000 Message: Cannot change column '%s': used in a foreign key constraint
            // '%s' of table '%s'
  public static final int ER_FK_CANNOT_DELETE_PARENT =
      1834; // SQLSTATE: HY000 Message: Cannot delete rows from table which is parent in a foreign
            // key constraint '%s' of table '%s'
  public static final int ER_MALFORMED_PACKET =
      1835; // SQLSTATE: HY000 Message: Malformed communication packet.
  public static final int ER_READ_ONLY_MODE =
      1836; // SQLSTATE: HY000 Message: Running in read-only mode
  public static final int ER_GTID_NEXT_TYPE_UNDEFINED_GROUP =
      1837; // SQLSTATE: HY000 Message: When GTID_NEXT is set to a GTID, you must explicitly set it
            // again after a COMMIT or ROLLBACK. If you see this error message in the replica SQL
            // thread, it means that a table in the current transaction is transactional on the
            // source and non-transactional on the replica. In a client connection, it means that
            // you executed SET GTID_NEXT before a transaction and forgot to set GTID_NEXT to a
            // different identifier or to 'AUTOMATIC' after COMMIT or ROLLBACK. Current GTID_NEXT is
            // '%s'.
  ...
  public static final int ER_CANT_SET_GTID_PURGED_WHEN_OWNED_GTIDS_IS_NOT_EMPTY =
      1841; // SQLSTATE: HY000 Message: GTID_PURGED can only be set when there are no ongoing
  ...
  public static final int ER_BINLOG_STMT_MODE_AND_NO_REPL_TABLES =
      1844; // SQLSTATE: HY000 Message: Cannot execute statement: impossible to write to binary log
            // since BINLOG_FORMAT = STATEMENT, and both replicated and non replicated tables are
            // written to.
  ...
  public static final int ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_PARTITION =
      1848; // SQLSTATE: HY000 Message: Partition specific operations do not yet support
            // LOCK/ALGORITHM
  ...
  public static final int ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_IGNORE =
      1852; // SQLSTATE: HY000 Message: Creating unique indexes with IGNORE requires COPY algorithm
            // to remove duplicate rows
  public static final int ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_NOPK =
      1853; // SQLSTATE: HY000 Message: Dropping a primary key is not allowed without also adding a
            // new primary key
  ...
  @Deprecated public static final int ER_SQL_SLAVE_SKIP_COUNTER_NOT_SETTABLE_IN_GTID_MODE = 1858;
  public static final int ER_SQL_REPLICA_SKIP_COUNTER_NOT_SETTABLE_IN_GTID_MODE =
      1858; // SQLSTATE: HY000 Message: sql_replica_skip_counter can not be set when the server is
            // running with GTID_MODE = ON. Instead, for each transaction that you want to skip,
            // generate an empty transaction with the same GTID as the transaction
  public static final int ER_DUP_UNKNOWN_IN_INDEX =
      1859; // SQLSTATE: 23000 Message: Duplicate entry for key '%s'
  public static final int ER_IDENT_CAUSES_TOO_LONG_PATH =
      1860; // SQLSTATE: HY000 Message: Long database name and identifier for object resulted in
            // path length exceeding %d characters. Path: '%s'.
  public static final int ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_NOT_NULL =
      1861; // SQLSTATE: HY000 Message: cannot silently convert NULL values, as required in this
            // SQL_MODE; was introduced in 5.7.1.
  public static final int ER_MUST_CHANGE_PASSWORD_LOGIN =
      1862; // SQLSTATE: HY000 Message: Your password has expired. To log in you must change it
            // using a client that supports expired passwords. was introduced in 5.7.1.
  ...
  public static final int ER_MTS_EVENT_BIGGER_PENDING_JOBS_SIZE_MAX =
      1864; // SQLSTATE: HY000 Message: Cannot schedule event %s, relay-log name %s, position %s to
            // Worker thread because its size %lu exceeds %lu of replica_pending_jobs_size_max.; was
            // introduced in 5.7.2.

  public static final int ER_INNODB_NO_FT_USES_PARSER =
      1865; // SQLSTATE: HY000 Message: Cannot CREATE FULLTEXT INDEX WITH PARSER on InnoDB table;
            // was introduced in 5.7.2.
  public static final int ER_BINLOG_LOGICAL_CORRUPTION =
      1866; // SQLSTATE: HY000 Message: The binary log file '%s' is logically corrupted: %s; was
            // introduced in 5.7.2.
  public static final int ER_WARN_PURGE_LOG_IN_USE =
      1867; // SQLSTATE: HY000 Message: file %s was not purged because it was being read by %d
            // thread(s), purged only %d out of %d files. was introduced in 5.7.2.
  public static final int ER_WARN_PURGE_LOG_IS_ACTIVE =
      1868; // SQLSTATE: HY000 Message: file %s was not purged because it is the active log file.;
            // was introduced in 5.7.2.
  public static final int ER_AUTO_INCREMENT_CONFLICT =
      1869; // SQLSTATE: HY000 Message: Auto-increment value in UPDATE conflicts with internally
            // generated values; was introduced in 5.7.2.
  public static final int WARN_ON_BLOCKHOLE_IN_RBR =
      1870; // SQLSTATE: HY000 Message: Row events are not logged for %s statements that modify
            // BLACKHOLE tables in row format. Table(s): '%s'; was introduced in 5.7.2.
  @Deprecated public static final int ER_SLAVE_MI_INIT_REPOSITORY = 1871;
  public static final int ER_REPLICA_MI_INIT_REPOSITORY =
      1871; // SQLSTATE: HY000 Message: Replica failed to initialize source info structure from the
            // repository; was introduced in 5.7.2.
  @Deprecated public static final int ER_SLAVE_RLI_INIT_REPOSITORY = 1872;
  public static final int ER_REPLICA_RLI_INIT_REPOSITORY =
      1872; // SQLSTATE: HY000 Message: Replica failed to initialize relay log info structure from
            // the repository; was introduced in 5.7.2.
  public static final int ER_ACCESS_DENIED_CHANGE_USER_ERROR =
      1873; // SQLSTATE: 28000 Message: Access denied trying to change to user '%s'@'%s' (using
            // password: %s). Disconnecting. was introduced in 5.7.2.
  ...
  @Deprecated public static final int ER_STOP_SLAVE_SQL_THREAD_TIMEOUT = 1875;
  public static final int ER_STOP_REPLICA_SQL_THREAD_TIMEOUT =
      1875; // SQLSTATE: HY000 Message: STOP REPLICA command execution is incomplete: Replica SQL
            // thread got the stop signal, thread is busy, SQL thread will stop once the current
            // task is complete.; was introduced in 5.7.2.
  @Deprecated public static final int ER_STOP_SLAVE_IO_THREAD_TIMEOUT = 1876;
  public static final int ER_STOP_REPLICA_IO_THREAD_TIMEOUT =
      1876; // SQLSTATE: HY000 Message: STOP REPLICA command execution is incomplete: Replica IO
            // thread got the stop signal, thread is busy, IO thread will stop once the current task
            // is complete.; was introduced in 5.7.2.
  public static final int ER_TABLE_CORRUPT =
      1877; // SQLSTATE: HY000 Message: Operation cannot be performed. The table '%s.%s' is missing,
            // corrupt or contains bad data.; was introduced in 5.7.2.
  ...
  public static final int ER_INNODB_FT_AUX_NOT_HEX_ID =
      1879; // SQLSTATE: HY000 Message: Upgrade index name failed, please use create index(alter
            // table) algorithm copy to rebuild index.; was introduced in 5.7.4.
  public static final int ER_OLD_TEMPORALS_UPGRADED =
      1880; // SQLSTATE: HY000 Message: TIME/TIMESTAMP/DATETIME columns of old format have been
            // upgraded to the new format.; was introduced in 5.7.4.
  public static final int ER_INNODB_FORCED_RECOVERY =
      1881; // SQLSTATE: HY000 Message: Operation not allowed when innodb_forced_recovery > 0.; was
            // introduced in 5.7.4.
  public static final int ER_AES_INVALID_IV =
      1882; // SQLSTATE: HY000 Message: The initialization vector supplied to %s is too short. Must
            // be at least %d bytes long; was introduced in 5.7.4.
  public static final int ER_FILE_CORRUPT = 1883; // SQLSTATE: HY000 Message: File %s is corrupted
  @Deprecated public static final int ER_ERROR_ON_MASTER = 1884;
  public static final int ER_ERROR_ON_SOURCE =
      1884; // SQLSTATE: HY000 Message: Query partially completed on the source (error on source:
            // %d) and was aborted. There is a chance that your source is inconsistent at this
            // point. If you are sure that your source is ok, run this query manually on the replica
            // and then restart the replica with SET GLOBAL SQL_REPLICA_SKIP_COUNTER=1; START
            // REPLICA;. Query:'%s'
  public static final int ER_INCONSISTENT_ERROR =
      1885; // SQLSTATE: HY000 Message: Query caused different errors on source and replica. Error
            // on source: message (format)='%s' error code=%d; Error on replica:actual message='%s',
            // error code=%d. Default database:'%s'. Query:'%s'
  ...
  public static final int ER_WARN_LEGACY_SYNTAX_CONVERTED =
      1888; // SQLSTATE: HY000 Message: %s is no longer supported. The statement was converted to
            // %s.
  public static final int ER_BINLOG_UNSAFE_FULLTEXT_PLUGIN =
      1889; // SQLSTATE: HY000 Message: Statement is unsafe because it uses a fulltext parser plugin
            // which may not return the same value on the replica.; was introduced in 5.7.1.
  public static final int ER_CANNOT_DISCARD_TEMPORARY_TABLE =
      1890; // SQLSTATE: HY000 Message: Cannot DISCARD/IMPORT tablespace associated with temporary
            // table; was introduced in 5.7.1.
  public static final int ER_FK_DEPTH_EXCEEDED =
      1891; // SQLSTATE: HY000 Message: Foreign key cascade delete/update exceeds max depth of %d.;
            // was introduced in 5.7.2.
  public static final int ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE_V2 =
      1892; // SQLSTATE: HY000 Message: Column count of %s.%s is wrong. Expected %d, found %d.
            // Created with MySQL %d, now running %d. Please use mysql_upgrade to fix this error.;
            // was introduced in 5.7.2.
  ...
  public static final int ER_REFERENCED_TRG_DOES_NOT_EXIST =
      1894; // SQLSTATE: HY000 Message: Referenced trigger '%s' for the given action time and event
            // type does not exist.; was introduced in 5.7.2.
  ...
  public static final int ER_MISSING_HA_CREATE_OPTION =
      1897; // SQLSTATE: HY000 Message: Table storage engine '%s' found required create option
            // missing; was introduced in 5.7.2.
  public static final int ER_ENGINE_OUT_OF_MEMORY =
      1898; // SQLSTATE: HY000 Message: Out of memory in storage engine '%s'.; was introduced in
            // 5.7.3.
  public static final int ER_PASSWORD_EXPIRE_ANONYMOUS_USER =
      1899; // SQLSTATE: HY000 Message: The password for anonymous user cannot be expired.; was
            // introduced in 5.7.3.
  @Deprecated public static final int ER_SLAVE_SQL_THREAD_MUST_STOP = 1900;
  public static final int ER_REPLICA_SQL_THREAD_MUST_STOP =
      1900; // SQLSTATE: HY000 Message: This operation cannot be performed with a running replica
            // sql thread; run STOP REPLICA SQL_THREAD first; was introduced in 5.7.3.
  public static final int ER_NO_FT_MATERIALIZED_SUBQUERY =
      1901; // SQLSTATE: HY000 Message: Cannot create FULLTEXT index on materialized subquery; was
            // introduced in 5.7.4.
  ...
  @Deprecated public static final int ER_SLAVE_IO_THREAD_MUST_STOP = 1904;
  public static final int ER_REPLICA_IO_THREAD_MUST_STOP =
      1904; // SQLSTATE: HY000 Message: This operation cannot be performed with a running replica io
            // thread; run STOP REPLICA IO_THREAD first.; was introduced in 5.7.4.
  public static final int ER_WARN_OPEN_TEMP_TABLES_MUST_BE_ZERO =
      1905; // SQLSTATE: HY000 Message: This operation may not be safe when the replica has
            // temporary tables. The tables will be kept open until the server restarts or until the
            // tables are deleted by any replicated DROP statement. Suggest to wait until
            // replica_open_temp_tables = 0.; was introduced in 5.7.4.
  @Deprecated public static final int ER_WARN_ONLY_MASTER_LOG_FILE_NO_POS = 1906;
  public static final int ER_WARN_ONLY_SOURCE_LOG_FILE_NO_POS =
      1906; // SQLSTATE: HY000 Message: CHANGE SOURCE TO with a SOURCE_LOG_FILE clause but no
            // SOURCE_LOG_POS clause may not be safe. The old position value may not be valid for
            // the new binary log file.; was introduced in 5.7.4.
  public static final int ER_QUERY_TIMEOUT =
      1907; // SQLSTATE: HY000 Message: Query execution was interrupted, max_statement_time
            // exceeded; was introduced in 5.7.4.
  public static final int ER_NON_RO_SELECT_DISABLE_TIMER =
      1908; // SQLSTATE: HY000 Message: Select is not a read only statement, disabling timer; was
            // introduced in 5.7.4.
  ...
  public static final int ER_CLIENT_INTERACTION_TIMEOUT =
      4031; // SQLSTATE: HY000 Message: The client was disconnected by the server because of
            // inactivity. See wait_timeout and interactive_timeout for configuring this behavior.
            // Was added in 8.0.24.
  ...
  public static final String SQL_STATE_STACKED_DIAGNOSTICS_ACCESSED_WITHOUT_ACTIVE_HANDLER =
      "0Z002";
  ...
  static {
    ...
    sqlStateMessages.put(
        SQL_STATE_MORE_THAN_ONE_ROW_UPDATED_OR_DELETED, Messages.getString("SQLError.41"));
    sqlStateMessages.put(SQL_STATE_WRONG_NO_OF_PARAMETERS, Messages.getString("SQLError.42"));
    sqlStateMessages.put(
        SQL_STATE_UNABLE_TO_CONNECT_TO_DATASOURCE, Messages.getString("SQLError.43"));
    ...
    sqlStateMessages.put(
        SQL_STATE_TRANSACTION_RESOLUTION_UNKNOWN, Messages.getString("SQLError.47"));
    sqlStateMessages.put(SQL_STATE_COMMUNICATION_LINK_FAILURE, Messages.getString("SQLError.48"));
    sqlStateMessages.put(
        SQL_STATE_INSERT_VALUE_LIST_NO_MATCH_COL_LIST, Messages.getString("SQLError.49"));
    ...
    sqlStateMessages.put(
        SQL_STATE_ROLLBACK_SERIALIZATION_FAILURE, Messages.getString("SQLError.53"));
    ...
    sqlStateMessages.put(
        SQL_STATE_BASE_TABLE_OR_VIEW_ALREADY_EXISTS, Messages.getString("SQLError.57"));
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_WARN_NULL_TO_NOTNULL, SQL_STATE_NULL_VALUE_NOT_ALLOWED);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_WARN_DATA_OUT_OF_RANGE, SQL_STATE_NUMERIC_VALUE_OUT_OF_RANGE);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NOT_SUPPORTED_AUTH_MODE, SQL_STATE_CONNECTION_REJECTED);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_BAD_HOST_ERROR, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_HANDSHAKE_ERROR, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_UNKNOWN_COM_ERROR, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_SERVER_SHUTDOWN, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_ABORTING_CONNECTION, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NET_PACKET_TOO_LARGE, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NET_READ_ERROR_FROM_PIPE, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NET_FCNTL_ERROR, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NET_PACKETS_OUT_OF_ORDER, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NET_UNCOMPRESS_ERROR, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NET_READ_ERROR, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NET_READ_INTERRUPTED, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NET_ERROR_ON_WRITE, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NET_WRITE_INTERRUPTED, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NEW_ABORTING_CONNECTION, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_SOURCE_NET_READ, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_SOURCE_NET_WRITE, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_CONNECT_TO_SOURCE, SQL_STATE_COMMUNICATION_LINK_FAILURE);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_STMT_NOT_ALLOWED_IN_SF_OR_TRG, SQL_STATE_FEATURE_NOT_SUPPORTED);
    mysqlToSql99State.put(MysqlErrorNumbers.ER_SP_NO_RETSET, SQL_STATE_FEATURE_NOT_SUPPORTED);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_ALTER_OPERATION_NOT_SUPPORTED, SQL_STATE_FEATURE_NOT_SUPPORTED);
    mysqlToSql99State.put(
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_WRONG_PARAMCOUNT_TO_PROCEDURE, SQL_STATE_SYNTAX_ERROR);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_MIX_OF_GROUP_FUNC_AND_FIELDS, SQL_STATE_SYNTAX_ERROR);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_TABLE_CANT_HANDLE_AUTO_INCREMENT, SQL_STATE_SYNTAX_ERROR);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NO_PERMISSION_TO_CREATE_USER, SQL_STATE_SYNTAX_ERROR);
    mysqlToSql99State.put(MysqlErrorNumbers.ER_USER_LIMIT_REACHED, SQL_STATE_SYNTAX_ERROR);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_SPECIFIC_ACCESS_DENIED_ERROR, SQL_STATE_SYNTAX_ERROR);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_UPDATE_LOG_DEPRECATED_IGNORED, SQL_STATE_SYNTAX_ERROR);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_UPDATE_LOG_DEPRECATED_TRANSLATED, SQL_STATE_SYNTAX_ERROR);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_MAX_PREPARED_STMT_COUNT_REACHED, SQL_STATE_SYNTAX_ERROR);
    mysqlToSql99State.put(MysqlErrorNumbers.ER_NON_GROUPING_FIELD_USED, SQL_STATE_SYNTAX_ERROR);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT, SQL_STATE_SYNTAX_ERROR);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_WRONG_PARAMETERS_TO_NATIVE_FCT, SQL_STATE_SYNTAX_ERROR);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_WRONG_PARAMETERS_TO_STORED_FCT, SQL_STATE_SYNTAX_ERROR);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_FUNC_INEXISTENT_NAME_COLLISION, SQL_STATE_SYNTAX_ERROR);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_WRONG_NUMBER_OF_COLUMNS_IN_SELECT, SQL_STATE_CARDINALITY_VIOLATION);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_BAD_NULL_ERROR, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NON_UNIQ_ERROR, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(MysqlErrorNumbers.ER_DUP_ENTRY, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_DUP_UNIQUE, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NO_REFERENCED_ROW, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_ROW_IS_REFERENCED, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_ROW_IS_REFERENCED_2, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NO_REFERENCED_ROW_2, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_FOREIGN_DUPLICATE_KEY, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_DUP_ENTRY_WITH_KEY_NAME, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_FOREIGN_DUPLICATE_KEY_WITH_CHILD_INFO,
        SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_FOREIGN_DUPLICATE_KEY_WITHOUT_CHILD_INFO,
        SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_DUP_UNKNOWN_IN_INDEX, SQL_STATE_INTEGRITY_CONSTRAINT_VIOLATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_DATA_TOO_LONG, SQL_STATE_STRING_DATA_RIGHT_TRUNCATION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_CANT_CREATE_GEOMETRY_OBJECT, SQL_STATE_NUMERIC_VALUE_OUT_OF_RANGE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_DATA_OUT_OF_RANGE, SQL_STATE_NUMERIC_VALUE_OUT_OF_RANGE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_TRUNCATED_WRONG_VALUE, SQL_STATE_INVALID_DATETIME_FORMAT);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_ILLEGAL_VALUE_FOR_TYPE, SQL_STATE_INVALID_DATETIME_FORMAT);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_DATETIME_FUNCTION_OVERFLOW, SQL_STATE_DATETIME_FIELD_OVERFLOW);
    mysqlToSql99State.put(MysqlErrorNumbers.ER_DIVISION_BY_ZERO, SQL_STATE_DIVISION_BY_ZERO);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_SP_CURSOR_ALREADY_OPEN, SQL_STATE_INVALID_CURSOR_STATE);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_READ_ONLY_TRANSACTION, SQL_STATE_INVALID_TRANSACTION_STATE);
    mysqlToSql99State.put(MysqlErrorNumbers.ER_ACCESS_DENIED_ERROR, SQL_STATE_INVALID_AUTH_SPEC);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_ACCESS_DENIED_NO_PASSWORD_ERROR, SQL_STATE_INVALID_AUTH_SPEC);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_ACCESS_DENIED_CHANGE_USER_ERROR, SQL_STATE_INVALID_AUTH_SPEC);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_DA_INVALID_CONDITION_NUMBER, SQL_STATE_INVALID_CONDITION_NUMBER);
    mysqlToSql99State.put(MysqlErrorNumbers.ER_NO_DB_ERROR, SQL_STATE_INVALID_CATALOG_NAME);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_RESIGNAL_WITHOUT_ACTIVE_HANDLER,
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_SP_CASE_NOT_FOUND, SQL_STATE_CASE_NOT_FOUND_FOR_CASE_STATEMENT);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_WRONG_VALUE_COUNT, SQL_STATE_INSERT_VALUE_LIST_NO_MATCH_COL_LIST);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_WRONG_VALUE_COUNT_ON_ROW,
        SQL_STATE_INSERT_VALUE_LIST_NO_MATCH_COL_LIST);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_INVALID_USE_OF_NULL, SQL_STATE_NULL_VALUE_NOT_ALLOWED);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_INVALID_ARGUMENT_FOR_LOGARITHM, SQL_STATE_INVALID_LOGARITHM_ARGUMENT);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_CANT_CHANGE_TX_ISOLATION, SQL_STATE_ACTIVE_SQL_TRANSACTION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_CANT_EXECUTE_IN_READ_ONLY_TRANSACTION,
        SQL_STATE_READ_ONLY_SQL_TRANSACTION);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_SP_NO_RECURSIVE_CREATE,
        SQL_STATE_SRE_PROHIBITED_SQL_STATEMENT_ATTEMPTED);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_SP_NORETURNEND, SQL_STATE_SRE_FUNCTION_EXECUTED_NO_RETURN_STATEMENT);
    mysqlToSql99State.put(MysqlErrorNumbers.ER_TABLE_EXISTS_ERROR, SQL_STATE_ER_TABLE_EXISTS_ERROR);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_BAD_TABLE_ERROR, SQL_STATE_BASE_TABLE_OR_VIEW_NOT_FOUND);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_UNKNOWN_TABLE, SQL_STATE_BASE_TABLE_OR_VIEW_NOT_FOUND);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_NO_SUCH_TABLE, SQL_STATE_BASE_TABLE_OR_VIEW_NOT_FOUND);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_OUT_OF_SORTMEMORY, SQL_STATE_MEMORY_ALLOCATION_ERROR);
    ...
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_LOCK_WAIT_TIMEOUT, SQL_STATE_ROLLBACK_SERIALIZATION_FAILURE);
    mysqlToSql99State.put(
        MysqlErrorNumbers.ER_LOCK_DEADLOCK, SQL_STATE_ROLLBACK_SERIALIZATION_FAILURE);
  }
