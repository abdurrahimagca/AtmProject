...
public interface Protocol<M extends Message> {
   ...
   *
   * <p>A constructor should be used unless the encapsulation of ProtocolFactory is necessary.
   *
  ...
  <T extends ProtocolEntity> T read(
      Class<T> requiredClass, ProtocolEntityFactory<T, M> protocolEntityFactory) throws IOException;
