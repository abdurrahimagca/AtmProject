...
public interface Resultset extends ProtocolEntity {
  ...
  public enum Concurrency {
    /**
     * The constant indicating the concurrency mode for a <code>Resultset</code> object that may NOT
     * be updated.
     */
    READ_ONLY(java.sql.ResultSet.CONCUR_READ_ONLY),

    /**
     * The constant indicating the concurrency mode for a <code>Resultset</code> object that may be
     * updated.
     */
  ...
  public enum Type {
    /**
     * The constant indicating the type for a <code>Resultset</code> object whose cursor may move
     * only forward.
     */
    FORWARD_ONLY(java.sql.ResultSet.TYPE_FORWARD_ONLY),

    /**
     * The constant indicating the type for a <code>Resultset</code> object that is scrollable but
     * generally not sensitive to changes to the data that underlies the <code>Resultset</code>.
     */
    SCROLL_INSENSITIVE(java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE),

    /**
     * The constant indicating the type for a <code>Resultset</code> object that is scrollable and
     * generally sensitive to changes to the data that underlies the <code>Resultset</code>.
     */
