...
public interface ServerSession {
  ...
  /**
   * Server will only open a cursor and set this flag if it can, otherwise it punts and goes back to
   * mysql_store_results() behavior.
   *
   * @return SERVER_STATUS_CURSOR_EXISTS <a
   *     href=http://dev.mysql.com/doc/internals/en/status-flags.html>status flag</a> value.
   */
  ...
  /**
   * The default time zone used to marshal date/time values to/from the server. This is used when
   * methods like getDate() are called without a calendar argument.
   *
