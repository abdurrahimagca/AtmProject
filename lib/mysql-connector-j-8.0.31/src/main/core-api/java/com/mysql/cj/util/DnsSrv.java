...
public class DnsSrv {
  public static class SrvRecord implements Comparable<SrvRecord> {
    ...
    public String toString() {
      return String.format(
          ...
          getPriority(), getWeight(), getPort(), getTarget());
    }
  ...
  public static List<SrvRecord> sortSrvRecords(List<SrvRecord> srvRecords) {
    ...
    List<SrvRecord> srvRecordsSortedNatural =
        srvRecords.stream().sorted().collect(Collectors.toList());
    ...
    List<Integer> priorities =
        srvRecordsSortedNatural.stream()
            .map(SrvRecord::getPriority)
            .distinct()
            .collect(Collectors.toList());
    for (Integer priority : priorities) {
      List<SrvRecord> srvRecordsSamePriority =
          srvRecordsSortedNatural.stream()
