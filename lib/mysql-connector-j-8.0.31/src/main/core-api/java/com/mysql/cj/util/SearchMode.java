...
public enum SearchMode {
   ...
   * comments, skip MySQL markers, skip hint blocks and skip white space. This is technically
   * equivalent to __BSE_MRK_COM_MYM_HNT_WS.
   */
  public static final Set<SearchMode> __FULL =
      Collections.unmodifiableSet(EnumSet.allOf(SearchMode.class));

  /**
   * Search mode: allow backslash escape, skip between markers, skip block comments, skip line
   * comments, skip MySQL markers, skip hint blocks and skip white space.
   */
  ...
  /**
   * Search mode: skip between markers, skip block comments, skip line comments, skip MySQL markers,
   * skip hint blocks and skip white space.
   */
  ...
  /**
   * Search mode: allow backslash escape, skip block comments, skip line comments, skip MySQL
   * markers, skip hint blocks and skip white space.
   */
  ...
  /**
   * Search mode: skip block comments, skip line comments, skip MySQL markers, skip hint blocks and
   * skip white space.
   */
  ...
  public static final Set<SearchMode> __BSE_MRK_WS =
      Collections.unmodifiableSet(
          EnumSet.of(ALLOW_BACKSLASH_ESCAPE, SKIP_BETWEEN_MARKERS, SKIP_WHITE_SPACE));
  ...
  /**
   * Empty search mode. There must be at least one element so that the Set may be later duplicated
   * if needed.
   */
