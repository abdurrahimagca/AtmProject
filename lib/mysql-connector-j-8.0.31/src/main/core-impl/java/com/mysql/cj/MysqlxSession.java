...
public class MysqlxSession extends CoreSession {
  ...
  /**
   * Check if enough statements were executed in the underlying MySQL server so that another prepare
  ...
  /**
   * Propagate to the underlying protocol instance that preparing a statement on the connected
   * server failed.
   *
  ...
  public <M extends Message, R, RES> RES query(
      M message,
