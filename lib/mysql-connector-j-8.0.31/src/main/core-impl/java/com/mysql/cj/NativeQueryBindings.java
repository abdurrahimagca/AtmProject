...
public class NativeQueryBindings implements QueryBindings {
  ...
  private AtomicBoolean sendTypesToServer =
      new AtomicBoolean(false); // specific to ServerPreparedQuery
  ...
  public NativeQueryBindings(
      int parameterCount, Session sess, Function<Session, BindValue> bindValueConstructor) {
    this.session = sess;
  ...
  public QueryBindings clone() {
    NativeQueryBindings newBindings =
        new NativeQueryBindings(this.bindValues.length, this.session, this.bindValueConstructor);
  ...
  public void checkParameterSet(int columnIndex) {
    if (!this.bindValues[columnIndex].isSet()) {
      throw ExceptionFactory.createException(
          Messages.getString("PreparedStatement.40") + (columnIndex + 1),
          MysqlErrorNumbers.SQL_STATE_WRONG_NO_OF_PARAMETERS,
          0,
          true,
          null,
  ...
  public BindValue getBinding(int parameterIndex, boolean forLongData) {
    if (this.bindValues[parameterIndex] != null
        && this.bindValues[parameterIndex].isStream()
        && !forLongData) {
  ...
  public void setFromBindValue(int parameterIndex, BindValue bv) {
    ...
    binding.setBinding(
        bv.getValue(), bv.getMysqlType(), this.numberOfExecutions, this.sendTypesToServer);
  ...
  static {
    ...
    DEFAULT_MYSQL_TYPES.put(
        LocalDateTime.class, MysqlType.DATETIME); // default JDBC mapping is TIMESTAMP, see B-4
    DEFAULT_MYSQL_TYPES.put(LocalTime.class, MysqlType.TIME);
    DEFAULT_MYSQL_TYPES.put(Long.class, MysqlType.BIGINT);
    DEFAULT_MYSQL_TYPES.put(
        OffsetDateTime.class,
        MysqlType.TIMESTAMP); // default JDBC mapping is TIMESTAMP_WITH_TIMEZONE, see B-4
    DEFAULT_MYSQL_TYPES.put(
        OffsetTime.class, MysqlType.TIME); // default JDBC mapping is TIME_WITH_TIMEZONE, see B-4
  ...
  public void setAsciiStream(int parameterIndex, InputStream x, int length) {
    ...
    binding.setBinding(
        ...
        this.sendTypesToServer); // TODO use length to find right TEXT type
  ...
  public void setBigDecimal(int parameterIndex, BigDecimal x) {
    ...
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.DECIMAL, this.numberOfExecutions, this.sendTypesToServer);
  }
  ...
  public void setBigInteger(int parameterIndex, BigInteger x) {
    ...
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.BIGINT_UNSIGNED, this.numberOfExecutions, this.sendTypesToServer);
  }
  ...
  public void setBinaryStream(int parameterIndex, InputStream x, int length) {
    ...
    binding.setBinding(
        ...
        MysqlType.BLOB,
        this.numberOfExecutions,
        this.sendTypesToServer); // TODO use length to find the right BLOB type
    binding.setScaleOrLength(length);
  }
  ...
  public void setBoolean(int parameterIndex, boolean x) {
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.BOOLEAN, this.numberOfExecutions, this.sendTypesToServer);
  }

  @Override
  public void setByte(int parameterIndex, byte x) {
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.TINYINT, this.numberOfExecutions, this.sendTypesToServer);
  }
  ...
  public void setBytes(int parameterIndex, byte[] x, boolean escapeIfNeeded) {
    ...
    BindValue binding = getBinding(parameterIndex, false);
    binding.setBinding(
        x, MysqlType.BINARY, this.numberOfExecutions, this.sendTypesToServer); // TODO VARBINARY ?
  ...
  public void setDouble(int parameterIndex, double x) {
    ...
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.DOUBLE, this.numberOfExecutions, this.sendTypesToServer);
  }

  @Override
  public void setFloat(int parameterIndex, float x) {
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.FLOAT, this.numberOfExecutions, this.sendTypesToServer);
  }

  @Override
  public void setInt(int parameterIndex, int x) {
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.INT, this.numberOfExecutions, this.sendTypesToServer);
  }

  @Override
  public void setLong(int parameterIndex, long x) {
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.BIGINT, this.numberOfExecutions, this.sendTypesToServer);
  }
  ...
  public void setNClob(int parameterIndex, NClob value) {
    ...
    try {
      ...
      throw ExceptionFactory.createException(
          t.getMessage(), t, this.session.getExceptionInterceptor());
    }
  }
  ...
  public void setShort(int parameterIndex, short x) {
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.SMALLINT, this.numberOfExecutions, this.sendTypesToServer);
  }
  ...
  public void setString(int parameterIndex, String x) {
    ...
    getBinding(parameterIndex, false)
        .setBinding(x, MysqlType.VARCHAR, this.numberOfExecutions, this.sendTypesToServer);
  }
  ...
  public void setObject(int parameterIndex, Object parameterObj) {
    ...
    if (defaultMysqlType == null) {
      Optional<MysqlType> mysqlType =
          DEFAULT_MYSQL_TYPES.entrySet().stream()
              .filter(m -> m.getKey().isAssignableFrom(parameterObj.getClass()))
              .map(m -> m.getValue())
              .findFirst();
   ...
   * values.
   *
   * <p>The given Java object will be converted to the targetMysqlType before being sent to the
   * database.
   *
  ...
  public void setObject(
    ...
    try {
      ...
      binding.setBinding(
          parameterObj, targetMysqlType, this.numberOfExecutions, this.sendTypesToServer);
  ...
  protected final void setSerializableObject(int parameterIndex, Object parameterObj) {
    try {
      ...
      throw ExceptionFactory.createException(
          WrongArgumentException.class,
          Messages.getString("PreparedStatement.54") + ex.getClass().getName(),
          ex,
          this.session.getExceptionInterceptor());
    }
  }
  ...
  public byte[] getBytesRepresentation(int parameterIndex) {
    ...
    return parameterVal == null
        ? null
        : this.bindValues[parameterIndex].isStream()
            ? parameterVal
            : StringUtils.unquoteBytes(parameterVal);
  }
}
