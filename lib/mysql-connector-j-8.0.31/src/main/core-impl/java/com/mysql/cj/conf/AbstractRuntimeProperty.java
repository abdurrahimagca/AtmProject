...
public abstract class AbstractRuntimeProperty<T> implements RuntimeProperty<T>, Serializable {
  ...
  /**
   * Set the value of a property from a string value. It involves the {@link
   * PropertyDefinition#parseObject(String, ExceptionInterceptor)} to validate and parse the string.
   *
   * @param value value
  ...
  public void setValueInternal(String value, ExceptionInterceptor exceptionInterceptor) {
    setValueInternal(
        getPropertyDefinition().parseObject(value, exceptionInterceptor),
        value,
  ...
  public void setValueInternal(
      T value, String valueAsString, ExceptionInterceptor exceptionInterceptor) {
  ...
  protected void checkRange(
      T val, String valueAsString, ExceptionInterceptor exceptionInterceptor) {
  ...
  public void setValue(T value, ExceptionInterceptor exceptionInterceptor) {
    if (getPropertyDefinition().isRuntimeModifiable()) {
      ...
      throw ExceptionFactory.createException(
          ...
          Messages.getString(
              "ConnectionProperties.dynamicChangeIsNotAllowed",
              new Object[] {"'" + getPropertyDefinition().getName() + "'"}));
    }
  }
}
