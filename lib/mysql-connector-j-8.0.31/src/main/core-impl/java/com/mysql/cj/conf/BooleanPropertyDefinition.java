...
public class BooleanPropertyDefinition extends AbstractPropertyDefinition<Boolean> {
  ...
  public static Boolean booleanFrom(
      String name, String value, ExceptionInterceptor exceptionInterceptor) {
    try {
      ...
      throw ExceptionFactory.createException(
          Messages.getString(
              ...
              new Object[] {
                name,
                StringUtils.stringArrayToString(
                    getBooleanAllowableValues(), "'", "', '", "' or '", "'"),
                value
              }),
          e,
  ...
  public static String[] getBooleanAllowableValues() {
    return Arrays.stream(AllowableValues.values())
        .map(AllowableValues::toString)
        .toArray(String[]::new);
  }
}
