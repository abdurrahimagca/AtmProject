...
/**
 * A {@link SaslClient} implementation for SCRAM-SHA-1, as specified in <a
 * href="https://tools.ietf.org/html/rfc5802">RFC 5802</a>.
 *
 * <p>The IANA-registered mechanism was renamed to "MYSQLCJ-SCRAM-SHA-1" in order to avoid future
 * conflicts with an officially supported implementation. When there is a Java-supported
 * implementation for SCRAM-SHA-1, it will have to be thoroughly tested with Connector/J and if that
 * works, this code can be obsoleted.
 */
public class ScramSha1SaslClient extends ScramShaSaslClient {
  ...
  public ScramSha1SaslClient(String authorizationId, String authenticationId, String password)
   ...
   * href="https://tools.ietf.org/html/rfc5802#section-2.2">RFC 5802, Section 2.2</a>. This
   ...
   * href="https://tools.ietf.org/html/rfc5802#section-2.2">RFC 5802, Section 2.2</a>. This
   * implementation corresponds to 'HmacSHA1'.
   *
   ...
   * href="https://tools.ietf.org/html/rfc5802#section-2.2">RFC 5802, Section 2.2</a>. This
   * implementation corresponds to 'PBKDF2WithHmacSHA1'.
   *
