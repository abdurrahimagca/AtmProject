...
/**
 * A {@link SaslClient} implementation for SCRAM-SHA-256, as specified in <a
 * href="https://tools.ietf.org/html/rfc5802">RFC 5802</a> and <a
 * href="https://tools.ietf.org/html/rfc7677">RFC 7677</a>.
 *
 * <p>The IANA-registered mechanism was renamed to "MYSQLCJ-SCRAM-SHA-256" in order to avoid future
 * conflicts with an officially supported implementation. When there is a Java-supported
 * implementation for SCRAM-SHA-256, it will have to be thoroughly tested with Connector/J and if
 * that works, this code can be obsoleted.
 */
public class ScramSha256SaslClient extends ScramShaSaslClient {
  ...
  public ScramSha256SaslClient(String authorizationId, String authenticationId, String password)
   ...
   * href="https://tools.ietf.org/html/rfc5802#section-2.2">RFC 5802, Section 2.2</a> and <a
   * href="https://tools.ietf.org/html/rfc7677#section-3">RFC 7677, Section 3</a>. This
   * implementation corresponds to SHA-256.
   *
   ...
   * href="https://tools.ietf.org/html/rfc5802#section-2.2">RFC 5802, Section 2.2</a> and <a
   * href="https://tools.ietf.org/html/rfc7677#section-3">RFC 7677, Section 3</a>. This
   * implementation corresponds to 'HmacSHA256'.
   *
   ...
   * href="https://tools.ietf.org/html/rfc5802#section-2.2">RFC 5802, Section 2.2</a> and <a
   * href="https://tools.ietf.org/html/rfc7677#section-3">RFC 7677, Section 3</a>. This
   * implementation corresponds to 'PBKDF2WithHmacSHA256'.
   *
