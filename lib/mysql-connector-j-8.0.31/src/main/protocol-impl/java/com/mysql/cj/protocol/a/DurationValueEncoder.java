  ...
  public void encodeAsBinary(Message msg, BindValue binding) {
    ...
    switch (binding.getMysqlType()) {
      case TIME:
        writeTime(
            msg,
            InternalTime.from(adjustDuration(Duration.ofNanos(x.toNanos()), binding.getField())));
        return;
      case CHAR:
      case VARCHAR:
      case TINYTEXT:
      ...
      case LONGTEXT:
        intoPacket.writeBytes(
            ...
            StringUtils.getBytes(TimeUtil.getDurationString(x), this.charEncoding.getValue()));
        return;
      default:
        throw ExceptionFactory.createException(
            WrongArgumentException.class,
