...
public class NativeConstants {
  ...
  public static final int COM_FIELD_LIST =
      4; // Not used; deprecated in MySQL 5.7.11 and MySQL 8.0.0.
  ...
  public static final int COM_PROCESS_INFO =
      10; // Not used; deprecated in MySQL 5.7.11 and MySQL 8.0.0.
  public static final int COM_CONNECT = 11;
  public static final int COM_PROCESS_KILL =
      12; // Not used; deprecated in MySQL 5.7.11 and MySQL 8.0.0.
  ...
  @Deprecated public static final int COM_REGISTER_SLAVE = 21;
  ...
  /**
   * Basic protocol data types as they are defined in
   * http://dev.mysql.com/doc/internals/en/string.html which require explicit length specification.
   */
  public static enum StringLengthDataType {
    ...
    /**
     * Protocol::VariableLengthString The length of the string is determined by another field or is
  ...
  public static enum StringSelfDataType {
    ...
    /**
     * Protocol::RestOfPacketString If a string is the last component of a packet, its length can be
     * calculated from the overall packet length minus the current position.
     */
    STRING_EOF;
  }
