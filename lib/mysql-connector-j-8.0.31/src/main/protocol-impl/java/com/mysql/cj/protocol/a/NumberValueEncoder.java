...
public class NumberValueEncoder extends AbstractValueEncoder {
  ...
  public String getString(BindValue binding) {
    Number x =
        binding.getValue() instanceof BigDecimal
            ? getScaled((BigDecimal) binding.getValue(), binding.getScaleOrLength())
      ...
      case LONGBLOB:
        intoPacket.writeBytes(
            ...
            StringUtils.getBytes(
                x instanceof BigDecimal ? ((BigDecimal) x).toPlainString() : x.toString(),
