  ...
  public String getString(BindValue binding) {
    ...
    switch (binding.getMysqlType()) {
      ...
      case DATE:
        ...
        sb.append(
            odt.atZoneSameInstant(this.serverSession.getDefaultTimeZone().toZoneId())
                .toLocalDate()
      ...
      case TIME:
        ...
        sb.append(
            adjustLocalTime(
                    ((OffsetDateTime) binding.getValue())
                        .atZoneSameInstant(this.serverSession.getDefaultTimeZone().toZoneId())
                        .toLocalTime(),
                    binding.getField())
      ...
      case YEAR:
        return String.valueOf(
            odt.atZoneSameInstant(this.serverSession.getDefaultTimeZone().toZoneId()).getYear());
      case CHAR:
      case VARCHAR:
      case TINYTEXT:
      case TEXT:
