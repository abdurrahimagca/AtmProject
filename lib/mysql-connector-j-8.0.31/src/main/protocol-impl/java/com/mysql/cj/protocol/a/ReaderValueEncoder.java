...
public class ReaderValueEncoder extends AbstractValueEncoder {
  ...
  protected byte[] readBytes(Reader reader, BindValue binding) {
    try {
      ...
      boolean useLength =
          this.propertySet.getBooleanProperty(PropertyKey.useStreamLengthsInPrepStmts).getValue();
      ...
      throw ExceptionFactory.createException(
          WrongArgumentException.class, uec.toString(), uec, this.exceptionInterceptor);
