    ...
    switch (binding.getMysqlType()) {
      ...
      case LONGTEXT:
        ...
        return binding.getCalendar() != null
            ...
            : TimeUtil.getSimpleDateFormat(
                    this.tdf, formatStr, this.serverSession.getDefaultTimeZone())
                .format(x);
        ...
        buf.append(
            binding.getCalendar() != null
                ? TimeUtil.getSimpleDateFormat("''yyyy-MM-dd HH:mm:ss", binding.getCalendar())
                    .format(x)
                : TimeUtil.getSimpleDateFormat(
                        null, "''yyyy-MM-dd HH:mm:ss", this.serverSession.getDefaultTimeZone())
                    .format(x));
    ...
    switch (binding.getMysqlType()) {
      ...
      case TIMESTAMP:
        java.sql.Timestamp ts =
            new java.sql.Timestamp(((java.sql.Time) binding.getValue()).getTime());
