...
public class UtilDateValueEncoder extends AbstractValueEncoder {
  ...
  public String getString(BindValue binding) {
    ...
    Timestamp x =
        adjustTimestamp(
            new Timestamp(((java.util.Date) binding.getValue()).getTime()),
            binding.getField(),
    ...
    switch (binding.getMysqlType()) {
      ...
      case LONGTEXT:
        ...
        intoPacket.writeBytes(
            ...
            StringUtils.getBytes(buf.toString(), this.charEncoding.getValue()));
        break;
  ...
  public void encodeAsQueryAttribute(Message msg, BindValue binding) {
    ...
    internalTimestamp.setOffset(
        (int) TimeUnit.MILLISECONDS.toMinutes(calendar.getTimeZone().getOffset(date.getTime())));
