...
/**
 * An {@link InputStream} wrapper that limits the number of bytes that can be read form the
...
public class ConfinedInputStream extends FilterInputStream {
  ...
  /**
   * Returns the number of bytes not yet consumed. Note that this method doen't care about the exact
   * number of bytes that may or may not be available in the underlying {@link InputStream}
   *
  ...
  /**
   * Closes this stream and throws away any bytes not consumed from the underlying {@link
   * InputStream}.
   *
  ...
  /**
   * Reads bytes from the underlying {@link InputStream} up to the number of bytes defined in this
   * {@link ConfinedInputStream} limit.
   *
  ...
  /**
   * Resets this {@link ConfinedInputStream} limit so that it can be reused over the same underlying
   * {@link InputStream}.
   *
