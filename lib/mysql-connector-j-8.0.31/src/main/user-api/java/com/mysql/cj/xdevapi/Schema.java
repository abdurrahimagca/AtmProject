...
public interface Schema extends DatabaseObject {
  ...
  /**
   * Retrieve a reference to the named collection hinting that an exception should be thrown if the
  ...
  /**
   * Defines options to be passed to {@link Schema#createCollection(String,
  ...
  /**
   * Defines options to be passed to {@link Schema#modifyCollection(String,
   * ModifyCollectionOptions)}. Options are defined by {@link Validation} object.
   *
   * <p>Example:
   *
   * <pre>
  ...
  /**
   * Validation options to be passed to {@link Schema#createCollection(String,
   * CreateCollectionOptions)} or {@link Schema#modifyCollection(String, ModifyCollectionOptions)}.
   *
   * <p>Allowed options are:
   *
   * <ul>
