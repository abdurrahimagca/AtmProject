...
public class Blob implements java.sql.Blob, OutputStreamWatcher {
  ...
  //
  // This is a real brain-dead implementation of BLOB. Once I add streamability to the I/O for MySQL
  // this will be more efficiently implemented
