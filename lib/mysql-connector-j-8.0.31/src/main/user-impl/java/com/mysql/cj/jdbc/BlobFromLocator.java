...
public class BlobFromLocator implements java.sql.Blob {
   ...
   */
  public BlobFromLocator(
      ResultSetImpl creatorResultSetToSet,
      int blobColumnIndex,
    ...
    this.blobColumnName =
        this.quotedId + this.creatorResultSet.getString(blobColumnIndex) + this.quotedId;
  }
  ...
  public java.io.InputStream getBinaryStream() throws SQLException {
    ...
    return new BufferedInputStream(
        new LocatorInputStream(),
        this.creatorResultSet
            .getSession()
            .getPropertySet()
  ...
  byte[] getBytesInternal(java.sql.PreparedStatement pStmt, long pos, int length)
      throws SQLException {
