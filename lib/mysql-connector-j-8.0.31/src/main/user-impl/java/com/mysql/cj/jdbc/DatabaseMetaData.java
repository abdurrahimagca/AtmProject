 ...
 *
 * <p>This class provides information about the database as a whole.
 *
 * <p>Many of the methods here return lists of information in ResultSets. You can use the normal
 ...
 *
 * <p>Some of these methods take arguments that are String patterns. These methods all have names
 * such as fooPattern. Within a pattern String "%" means match any substring of 0 or more characters
 * and "_" means match any one character.
 */
public class DatabaseMetaData implements java.sql.DatabaseMetaData {
    ...
    TypeDescriptor(String typeInfo, String nullabilityInfo) throws SQLException {
      if (typeInfo == null) {
        throw SQLError.createSQLException(
            Messages.getString("DatabaseMetaData.0"),
      ...
      switch (this.mysqlType) {
        ...
        case FLOAT_UNSIGNED:
          if (typeInfo.indexOf(",") != -1) {
            ...
            this.columnSize =
                Integer.valueOf(
                    typeInfo
                        .substring((typeInfo.indexOf("(") + 1), (typeInfo.indexOf(",")))
                        .trim());
            this.decimalDigits =
                Integer.valueOf(
                    typeInfo
            ...
            if (size > 23) {
              this.mysqlType =
                  this.mysqlType == MysqlType.FLOAT ? MysqlType.DOUBLE : MysqlType.DOUBLE_UNSIGNED;
        ...
        case BIT:
          ...
          if (typeInfo.indexOf("(") != -1) {
            ...
            if (DatabaseMetaData.this.tinyInt1isBit
                && this.columnSize.intValue() == 1
                && StringUtils.startsWithIgnoreCase(typeInfo, "tinyint")) {
      ...
      if (this.columnSize == null) {
        ...
        this.columnSize =
            this.mysqlType.getPrecision() > Integer.MAX_VALUE
                ? Integer.MAX_VALUE
                : this.mysqlType.getPrecision().intValue();
      }
   ...
   * @param <V> value type
   */
  protected class ComparableWrapper<K extends Object & Comparable<? super K>, V>
  ...
  /* package private */ static final List<String> SQL2003_KEYWORDS =
      Arrays.asList(
          "ABS",
          "ALL",
          "ALLOCATE",
  ...
  protected DatabaseMetaData(
      JdbcConnection connToSet, String databaseToSet, ResultSetFactory resultSetFactory) {
    this.conn = connToSet;
    ...
    this.databaseTerm =
        this.conn.getPropertySet().<DatabaseTerm>getEnumProperty(PropertyKey.databaseTerm);
    this.nullDatabaseMeansCurrent =
        this.conn.getPropertySet().getBooleanProperty(PropertyKey.nullDatabaseMeansCurrent);
    this.pedantic = this.conn.getPropertySet().getBooleanProperty(PropertyKey.pedantic).getValue();
    this.tinyInt1isBit =
        this.conn.getPropertySet().getBooleanProperty(PropertyKey.tinyInt1isBit).getValue();
    this.transformedBitIsBoolean =
        this.conn
            .getPropertySet()
            .getBooleanProperty(PropertyKey.transformedBitIsBoolean)
            .getValue();
    this.useHostsInPrivileges =
        this.conn.getPropertySet().getBooleanProperty(PropertyKey.useHostsInPrivileges).getValue();
    this.yearIsDateType =
        this.conn.getPropertySet().getBooleanProperty(PropertyKey.yearIsDateType).getValue();
  ...
  protected void convertToJdbcFunctionList(
      ResultSet proceduresRs, List<ComparableWrapper<String, Row>> procedureRows, Field[] fields)
      throws SQLException {
    while (proceduresRs.next()) {
      ...
      procedureRows.add(
          new ComparableWrapper<String, Row>(
              StringUtils.getFullyQualifiedName(procDb, functionName, this.quotedId, this.pedantic),
  ...
  protected void convertToJdbcProcedureList(
      ...
      List<ComparableWrapper<String, Row>> procedureRows)
      throws SQLException {
    while (proceduresRs.next()) {
      String procDb = proceduresRs.getString("db");
      ...
      boolean isFunction =
          fromSelect ? "FUNCTION".equalsIgnoreCase(proceduresRs.getString("type")) : false;
      rowData[7] =
          s2b(
              isFunction
                  ? Integer.toString(procedureReturnsResult)
                  : Integer.toString(procedureNoResult));
      ...
      procedureRows.add(
          new ComparableWrapper<String, Row>(
              StringUtils.getFullyQualifiedName(
                  procDb, procedureName, this.quotedId, this.pedantic),
              new ByteArrayRow(rowData, getExceptionInterceptor())));
    }
  }
  ...
  private Row convertTypeDescriptorToProcedureRow(
    ...
    row[4] =
        s2b(
            String.valueOf(
                getColumnType(
                    isOutParam, isInParam, isReturnParam, forGetFunctionColumns))); // COLUMN_TYPE
    row[5] =
        Short.toString(
                typeDesc.mysqlType == MysqlType.YEAR && !DatabaseMetaData.this.yearIsDateType
                    ? //
                    Types.SMALLINT
                    : (short) typeDesc.mysqlType.getJdbcType())
            .getBytes(); // DATA_TYPE (jdbc)
    row[6] = s2b(typeDesc.mysqlType.getName()); // TYPE_NAME
    row[7] =
        typeDesc.datetimePrecision == null
            ? s2b(typeDesc.columnSize.toString())
            : s2b(typeDesc.datetimePrecision.toString()); // PRECISION
    row[8] = typeDesc.columnSize == null ? null : s2b(typeDesc.columnSize.toString()); // LENGTH
    row[9] =
        typeDesc.decimalDigits == null ? null : s2b(typeDesc.decimalDigits.toString()); // SCALE
    ...
    switch (typeDesc.nullability) {
      ...
      default:
        throw SQLError.createSQLException(
            Messages.getString("DatabaseMetaData.1"),
    ...
    if (forGetFunctionColumns) {
      row[13] =
          typeDesc.charOctetLength == null
              ? null
              : s2b(typeDesc.charOctetLength.toString()); // CHAR_OCTET_LENGTH
  ...
  protected int getColumnType(
      boolean isOutParam, boolean isInParam, boolean isReturnParam, boolean forGetFunctionColumns) {
    return getProcedureOrFunctionColumnType(
        isOutParam, isInParam, isReturnParam, forGetFunctionColumns);
  }
   ...
   * @return The corresponding COLUMN_TYPE as in java.sql.getProcedureColumns API.
   */
  protected static int getProcedureOrFunctionColumnType(
      boolean isOutParam, boolean isInParam, boolean isReturnParam, boolean forGetFunctionColumns) {
   ...
   */
  public List<Row> extractForeignKeyForTable(
      ArrayList<Row> rows, java.sql.ResultSet rs, String dbName) throws SQLException {
    byte[][] row = new byte[3][];
    row[0] = rs.getBytes(1);
            ...
            if (referencedColumnBegin != -1) {
              ...
              if (referencedColumnEnd != -1) {
                referencedColumnName =
                    line.substring(referencedColumnBegin + 1, referencedColumnEnd);
              }
  ...
  public ResultSet extractForeignKeyFromCreateTable(String dbName, String tableName)
    ...
    if (tableName != null) {
      ...
      try {
        rs =
            this.databaseTerm.getValue() == DatabaseTerm.SCHEMA
                ? getTables(null, dbName, null, new String[] {"TABLE"})
    ...
    fields[0] =
        new Field(
            "",
            "Name",
            this.metadataCollationIndex,
            this.metadataEncoding,
            MysqlType.CHAR,
            Integer.MAX_VALUE);
    fields[1] =
        new Field(
            "", "Type", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 255);
    fields[2] =
        new Field(
            "",
            "Comment",
    ...
    try {
      for (int i = 0; i < numTables; i++) {
        ...
        String query =
            new StringBuilder("SHOW CREATE TABLE ")
                .append(
                    StringUtils.getFullyQualifiedName(
                        dbName, tableToExtract, this.quotedId, this.pedantic))
                .toString();
  ...
  public java.sql.ResultSet getAttributes(String arg0, String arg1, String arg2, String arg3)
    ...
    fields[0] =
        new Field(
            "", "TYPE_CAT", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 32);
    fields[1] =
        new Field(
            "",
            "TYPE_SCHEM",
    ...
    fields[6] =
        new Field(
            "", "ATTR_SIZE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 32);
    fields[7] =
        new Field(
            "",
            "DECIMAL_DIGITS",
    ...
    fields[9] =
        new Field(
            "", "NULLABLE ", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 32);
    fields[10] =
        new Field(
            "", "REMARKS", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 32);
    fields[11] =
        new Field(
            "", "ATTR_DEF", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 32);
    fields[12] =
        new Field(
            "",
            "SQL_DATA_TYPE",
    ...
    return this.resultSetFactory.createFromResultsetRows(
        ResultSet.CONCUR_READ_ONLY,
        ResultSet.TYPE_SCROLL_INSENSITIVE,
        new ResultsetRowsStatic(
            new ArrayList<ResultsetRow>(), new DefaultColumnDefinition(fields)));
  }

  @Override
  public java.sql.ResultSet getBestRowIdentifier(
      String catalog, String schema, final String table, int scope, boolean nullable)
      throws SQLException {
    if (table == null) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.2"),
          MysqlErrorNumbers.SQL_STATE_ILLEGAL_ARGUMENT,
          getExceptionInterceptor());
    }
    ...
    fields[0] =
        new Field(
            "", "SCOPE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.SMALLINT, 5);
    fields[1] =
        new Field(
            "",
            "COLUMN_NAME",
    ...
    fields[2] =
        new Field(
            "", "DATA_TYPE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 32);
    fields[3] =
        new Field(
            "",
            "TYPE_NAME",
      ...
      new IterateBlock<String>(getDatabaseIterator(db)) {
        ...
        void forEach(String dbStr) throws SQLException {
          ...
          try {
            ...
            queryBuf.append(
                StringUtils.quoteIdentifier(
                    table, DatabaseMetaData.this.quotedId, DatabaseMetaData.this.pedantic));
            queryBuf.append(" FROM ");
            queryBuf.append(
                StringUtils.quoteIdentifier(
                    dbStr, DatabaseMetaData.this.quotedId, DatabaseMetaData.this.pedantic));
              ...
              if (keyType != null) {
                if (StringUtils.startsWithIgnoreCase(keyType, "PRI")) {
                  ...
                  rowVal[2] =
                      s2b(
                          String.valueOf(
                              ft == MysqlType.YEAR && !DatabaseMetaData.this.yearIsDateType
                                  ? Types.SMALLINT
                                  : ft.getJdbcType()));
                  rowVal[3] = s2b(type);
                  rowVal[4] =
                      hasLength
                          ? Integer.toString(size + decimals).getBytes()
                          : Long.toString(ft.getPrecision()).getBytes();
            ...
            if (!MysqlErrorNumbers.SQL_STATE_BASE_TABLE_OR_VIEW_NOT_FOUND.equals(
                sqlEx.getSQLState())) {
              throw sqlEx;
            }
          } finally {
  ...
  private void getCallStmtParameterTypes(
    ...
    try {
      ...
      if (this.conn.lowerCaseTableNames()
          ...
          && oldDb != null
          && oldDb.length() != 0) {
        // Workaround for bug in server wrt. to  SHOW CREATE PROCEDURE not respecting lower-case
        // table names
      ...
      // there is no need to quote the identifier here since 'dbName' and 'procName' are guaranteed
      // to be already quoted.
      ...
      if (procType == PROCEDURE) {
        paramRetrievalRs =
            paramRetrievalStmt.executeQuery("SHOW CREATE PROCEDURE " + procNameBuf.toString());
        fieldName = "Create Procedure";
      } else {
        paramRetrievalRs =
            paramRetrievalStmt.executeQuery("SHOW CREATE FUNCTION " + procNameBuf.toString());
      ...
      if (paramRetrievalRs.next()) {
        ...
        if (!this.conn
                .getPropertySet()
                .getBooleanProperty(PropertyKey.noAccessToProcedureBodies)
                .getValue()
        ...
        if (procedureDef != null && procedureDef.length() != 0) {
          ...
          procedureDef =
              StringUtils.stripCommentsAndHints(
                  procedureDef,
                  identifierAndStringMarkers,
                  identifierAndStringMarkers,
                  !this.session.getServerSession().isNoBackslashEscapesSet());
          ...
          endOfParamDeclarationIndex =
              endPositionOfParameterDeclaration(openParenIndex, procedureDef, this.quotedId);
          ...
          if ((openParenIndex == -1) || (endOfParamDeclarationIndex == -1)) {
            // parse error?
            throw SQLError.createSQLException(
                Messages.getString("DatabaseMetaData.5"),
                MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
                getExceptionInterceptor());
          }
    ...
    if (parameterDef != null) {
      ...
      List<String> parseList =
          StringUtils.split(parameterDef, ",", storageDefnDelims, storageDefnClosures, true);
        ...
        if (declarationTok.hasMoreTokens()) {
          ...
          if (possibleParamName.equalsIgnoreCase("OUT")) {
            ...
            if (declarationTok.hasMoreTokens()) {
              ...
              throw SQLError.createSQLException(
                  Messages.getString("DatabaseMetaData.6"),
                  MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
                  getExceptionInterceptor());
            }
          ...
          if (declarationTok.hasMoreTokens()) {
            ...
            throw SQLError.createSQLException(
                Messages.getString("DatabaseMetaData.7"),
                MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
                getExceptionInterceptor());
          }

          if ((paramName.startsWith("`") && paramName.endsWith("`"))
              || (isProcedureInAnsiMode
          ...
          if (parameterNamePattern == null
              || StringUtils.wildCompareIgnoreCase(paramName, parameterNamePattern)) {
            Row row =
                convertTypeDescriptorToProcedureRow(
                    procNameAsBytes,
                    procCatAsBytes,
          ...
          throw SQLError.createSQLException(
              Messages.getString("DatabaseMetaData.8"),
              MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
              getExceptionInterceptor());
        }
      }
    } else {
      // Is this an error? JDBC spec doesn't make it clear if stored procedure doesn't exist, is it
      // an error....
    }
  }
   ...
   */
  private int endPositionOfParameterDeclaration(
      int beginIndex, String procedureDef, String quoteChar) throws SQLException {
   ...
   *
   * <p>Please note that in MySQL, NO ACTION is the equivalent to RESTRICT.
   *
  ...
  protected IteratorWithCleanup<String> getDatabaseIterator(String dbSpec) throws SQLException {
    if (dbSpec == null) {
      return this.nullDatabaseMeansCurrent.getValue()
          ? new SingleStringIterator(this.database)
          : new StringListIterator(getDatabases());
    }
    return new SingleStringIterator(
        this.pedantic ? dbSpec : StringUtils.unQuoteIdentifier(dbSpec, this.quotedId));
  }
  ...
  /**
   * Retrieves the database names available on this server. The results are ordered by database
   * name.
   *
  ...
  /**
   * Retrieves the database names matching the dbPattern available on this server. The results are
  ...
  public java.sql.ResultSet getCatalogs() throws SQLException {
    List<String> resultsAsList =
        this.databaseTerm.getValue() == DatabaseTerm.SCHEMA ? new ArrayList<>() : getDatabases();
  ...
  protected Field[] getColumnPrivilegesFields() {
    ...
    fields[4] =
        new Field(
            "", "GRANTOR", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 77);
    fields[5] =
        new Field(
            "", "GRANTEE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 77);
    fields[6] =
        new Field(
            "",
            "PRIVILEGE",
  ...
  public java.sql.ResultSet getColumnPrivileges(
    ...
    StringBuilder grantQueryBuf =
        new StringBuilder(
            "SELECT c.host, c.db, t.grantor, c.user, c.table_name, c.column_name, c.column_priv");
    ...
    return this.resultSetFactory.createFromResultsetRows(
        ...
        ResultSet.TYPE_SCROLL_INSENSITIVE,
        new ResultsetRowsStatic(
            grantRows, new DefaultColumnDefinition(getColumnPrivilegesFields())));
  }
  ...
  public java.sql.ResultSet getColumns(
    ...
    try {
      ...
      new IterateBlock<String>(
          dbMapsToSchema ? getSchemaPatternIterator(db) : getDatabaseIterator(db)) {
        @Override
        void forEach(String dbStr) throws SQLException {
          ...
          try {
            tables =
                dbMapsToSchema
                    ? getTables(null, dbStr, tableNamePattern, new String[0])
          ...
          for (String tableName : tableNameList) {
            ...
            try {
              ...
              queryBuf.append(
                  StringUtils.quoteIdentifier(
                      tableName, DatabaseMetaData.this.quotedId, DatabaseMetaData.this.pedantic));
              queryBuf.append(" FROM ");
              queryBuf.append(
                  StringUtils.quoteIdentifier(
                      dbStr, DatabaseMetaData.this.quotedId, DatabaseMetaData.this.pedantic));
              ...
              // Currently, MySQL doesn't show enough data to do this, so we do it the 'hard'
              // way...Once _SYSTEM tables are in, this should be
              // much easier
              ...
              while (results.next()) {
                TypeDescriptor typeDesc =
                    new TypeDescriptor(results.getString("Type"), results.getString("Null"));

                byte[][] rowVal = new byte[24][];
                rowVal[0] =
                    DatabaseMetaData.this.databaseTerm.getValue() == DatabaseTerm.SCHEMA
                        ? s2b("def")
                        : s2b(dbStr); // TABLE_CAT
                rowVal[1] =
                    DatabaseMetaData.this.databaseTerm.getValue() == DatabaseTerm.SCHEMA
                ...
                rowVal[4] =
                    Short.toString(
                            typeDesc.mysqlType == MysqlType.YEAR
                                    && !DatabaseMetaData.this.yearIsDateType
                                ? Types.SMALLINT
                                : (short) typeDesc.mysqlType.getJdbcType())
                        .getBytes(); // DATA_TYPE (jdbc)
                ...
                if (typeDesc.columnSize == null) { // COLUMN_SIZE
                  ...
                  int mbminlen = 1;
                  if (collation != null) {
                    // not null collation could only be returned by server for character types, so
                    // we don't need to check type name
                ...
                rowVal[8] =
                    typeDesc.decimalDigits == null ? null : s2b(typeDesc.decimalDigits.toString());
                ...
                if (StringUtils.indexOfIgnoreCase(typeDesc.mysqlType.getName(), "CHAR") != -1
                    ...
                    || StringUtils.indexOfIgnoreCase(typeDesc.mysqlType.getName(), "BINARY")
                        != -1) {
                ...
                if (!fixUpOrdinalsRequired) {
                  ...
                  if (realOrdinal != null) {
                    ...
                    throw SQLError.createSQLException(
                        Messages.getString("DatabaseMetaData.10"),
                        MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
                        getExceptionInterceptor());
                  }
                }
                  ...
                  rowVal[22] =
                      s2b(
                          StringUtils.indexOfIgnoreCase(extra, "auto_increment") != -1
                              ...
                              : "NO");
                  rowVal[23] =
                      s2b(StringUtils.indexOfIgnoreCase(extra, "generated") != -1 ? "YES" : "NO");
                }
  ...
  protected Field[] createColumnsFields() {
    ...
    fields[4] =
        new Field(
            "", "DATA_TYPE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 5);
    fields[5] =
        new Field(
            "",
            "TYPE_NAME",
            ...
            this.metadataEncoding,
            MysqlType.CHAR,
            16); // TODO why is it 16 bytes long? we have longer types specifications
    fields[6] =
        new Field(
            "",
            "COLUMN_SIZE",
    ...
    fields[10] =
        new Field(
            "", "NULLABLE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 10);
    fields[11] =
        new Field(
            "", "REMARKS", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 0);
    fields[12] =
        new Field(
            "",
            "COLUMN_DEF",
              ...
              if ((tableType != null)
                ...
                if (comment != null) {
                  ...
                  while (commentTokens.hasMoreTokens()) {
                    ...
                    Iterator<String> referencedColumns =
                        parsedInfo.referencedColumnsList.iterator();

                    while (referencingColumns.hasNext()) {
                      String referencingColumn =
                          StringUtils.unQuoteIdentifier(
                              referencingColumns.next(), DatabaseMetaData.this.quotedId);
                      ...
                      tuple[0] =
                          dbMapsToSchema
                              ? s2b("def")
                              : s2b(parsedInfo.referencedDatabase); // PKTABLE_CAT
                      tuple[1] =
                          dbMapsToSchema
                              ? s2b(parsedInfo.referencedDatabase)
                              : null; // PKTABLE_SCHEM
                      ...
                      tuple[3] =
                          s2b(
                              StringUtils.unQuoteIdentifier(
                                  ...
                                  DatabaseMetaData.this.quotedId)); // PKCOLUMN_NAME
  ...
  protected Field[] createFkMetadataFields() {
    ...
    fields[11] =
        new Field(
            "", "FK_NAME", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 0);
    fields[12] =
        new Field(
            "", "PK_NAME", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 0);
    fields[13] =
        new Field(
            "",
            "DEFERRABILITY",
  ...
  @Override
  public java.sql.ResultSet getExportedKeys(String catalog, String schema, final String table)
      throws SQLException {
    if (table == null) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.2"),
  ...
  protected int[] getForeignKeyActions(String commentString) {
    ...
    if (lastParenIndex != (commentString.length() - 1)) {
      String cascadeOptions =
          commentString.substring(lastParenIndex + 1).trim().toUpperCase(Locale.ENGLISH);
  ...
  @Override
  public java.sql.ResultSet getImportedKeys(String catalog, String schema, final String table)
      throws SQLException {
    if (table == null) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.2"),
  ...
  public java.sql.ResultSet getIndexInfo(
      String catalog, String schema, final String table, final boolean unique, boolean approximate)
      throws SQLException {
    /*
        ...
        void forEach(String dbStr) throws SQLException {
          ...
          try {
            ...
            while (results != null && results.next()) {
              ...
              IndexMetaDataKey indexInfoKey =
                  new IndexMetaDataKey(
                      !indexIsUnique,
                      indexType,
  ...
  protected Field[] createIndexInfoFields() {
    ...
    fields[6] =
        new Field(
            "", "TYPE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.SMALLINT, 32);
    fields[7] =
        new Field(
            "",
            "ORDINAL_POSITION",
    ...
    fields[11] =
        new Field(
            "", "PAGES", this.metadataCollationIndex, this.metadataEncoding, MysqlType.BIGINT, 20);
    fields[12] =
        new Field(
            "",
            "FILTER_CONDITION",
  ...
  protected Field[] getPrimaryKeysFields() {
    ...
    fields[5] =
        new Field(
            "", "PK_NAME", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 32);
    return fields;
  }

  @Override
  public java.sql.ResultSet getPrimaryKeys(String catalog, String schema, final String table)
      throws SQLException {
  ...
  protected Field[] createProcedureColumnsFields() {
    ...
    fields[7] =
        new Field(
            "", "PRECISION", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 12);
    fields[8] =
        new Field(
            "", "LENGTH", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 12);
    fields[9] =
        new Field(
            "",
            "SCALE",
    ...
    fields[10] =
        new Field(
            "", "RADIX", this.metadataCollationIndex, this.metadataEncoding, MysqlType.SMALLINT, 6);
    fields[11] =
        new Field(
            "",
            "NULLABLE",
    ...
    fields[12] =
        new Field(
            "", "REMARKS", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 512);
    fields[13] =
        new Field(
            "",
            "COLUMN_DEF",
  ...
  protected java.sql.ResultSet getProcedureOrFunctionColumns(
    ...
    try {
      // getProceduresAndOrFunctions does NOT expect procedureOrFunctionNamePattern  in form of
      // DB_NAME.SP_NAME thus we need to remove it
      String tmpProcedureOrFunctionNamePattern = null;
      // Check if NOT a pattern first, then "sanitize"
      if ((procedureOrFunctionNamePattern != null)
          && (!procedureOrFunctionNamePattern.equals("%"))) {
        tmpProcedureOrFunctionNamePattern =
            StringUtils.sanitizeProcOrFuncName(procedureOrFunctionNamePattern);
      }
      ...
      while (procsAndOrFuncsRs.next()) {
        procsOrFuncsToExtractList.add(
            new ComparableWrapper<>(
                StringUtils.getFullyQualifiedName(
                    dbMapsToSchema
                        ? procsAndOrFuncsRs.getString(2)
                        : procsAndOrFuncsRs.getString(1),
                    procsAndOrFuncsRs.getString(3),
                    this.quotedId,
                    this.pedantic),
      ...
      if (!hasResults) {
        ...
        // "stored procedure parameter types. If rights can not be granted, configure connection
        // with \"noAccessToProcedureBodies=true\" " +
      ...
      // Required to be sorted in name-order by JDBC spec, in 'normal' case getProcedures takes care
      // of this for us, but if system tables are
  ...
  protected Field[] createFieldMetadataForGetProcedures() {
    ...
    fields[3] =
        new Field(
            "", "reserved1", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 0);
    fields[4] =
        new Field(
            "", "reserved2", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 0);
    fields[5] =
        new Field(
            "", "reserved3", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 0);
    fields[6] =
        new Field(
            "", "REMARKS", this.metadataCollationIndex, this.metadataEncoding, MysqlType.CHAR, 255);
    fields[7] =
        new Field(
            "",
            "PROCEDURE_TYPE",
  ...
  protected java.sql.ResultSet getProceduresAndOrFunctions(
    ...
    new IterateBlock<String>(
      ...
      void forEach(String dbPattern) throws SQLException {
        ...
        java.sql.PreparedStatement proceduresStmt =
            prepareMetaDataSafeStatement(selectFromMySQLProcSQL.toString());
        ...
        try {
          ...
          try {
            ...
            // The mysql.proc table didn't exist in early MySQL versions and it's removed in MySQL
            // 8.0,
            ...
            if (returnFunctions) {
              ...
              String sql =
                  "SHOW FUNCTION STATUS WHERE " + (dbMapsToSchema ? "Db LIKE ?" : "Db = ?");
              if (procedureNamePattern != null && procedureNamePattern.length() > 0) {
                sql += " AND Name LIKE ?";
              }
            ...
            if (returnProcedures) {
              ...
              String sql =
                  "SHOW PROCEDURE STATUS WHERE " + (dbMapsToSchema ? "Db LIKE ?" : "Db = ?");
              if (procedureNamePattern != null && procedureNamePattern.length() > 0) {
                sql += " AND Name LIKE ?";
              }
              proceduresStmt = prepareMetaDataSafeStatement(sql);
  ...
  /**
   * Populates the resultRows list with the imported or exported keys of given table based on the
   * keysComment from the 'show table status' sql command. KeysComment is that part of the comment
   * field that follows the "InnoDB free ...;" prefix.
   *
  ...
  void populateKeyResults(
    ...
    if (parsedInfo.localColumnsList.size() != parsedInfo.referencedColumnsList.size()) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.12"),
          MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
          getExceptionInterceptor());
    }
    ...
    while (localColumnNames.hasNext()) {
      ...
      tuple[13] =
          s2b(
              Integer.toString(
                  java.sql.DatabaseMetaData.importedKeyNotDeferrable)); // DEFERRABILITY
  ...
  public java.sql.ResultSet getTablePrivileges(
    ...
    if (dbPattern != null) {
      conditionBuf.append(
          this.databaseTerm.getValue() == DatabaseTerm.SCHEMA ? " db LIKE ?" : " db = ?");
    }
  ...
  public java.sql.ResultSet getTables(
      String catalog, String schemaPattern, String tableNamePattern, final String[] types)
      throws SQLException {
      ...
      new IterateBlock<String>(
        ...
        void forEach(String dbPattern) throws SQLException {
          boolean operatingOnSystemDB =
              "information_schema".equalsIgnoreCase(dbPattern)
                  || "mysql".equalsIgnoreCase(dbPattern)
          ...
          try {
            ...
            try {
              ...
              sqlBuf.append(
                  StringUtils.quoteIdentifier(
                      dbPattern, DatabaseMetaData.this.quotedId, DatabaseMetaData.this.pedantic));
              ...
              if (MysqlErrorNumbers.SQL_STATE_COMMUNICATION_LINK_FAILURE.equals(
                  sqlEx.getSQLState())) {
                throw sqlEx;
              }
            ...
            try {
              ...
              // We should probably check SQLState here, but that can change depending on the server
              // version and user properties, however,
            ...
            while (results.next()) {
              ...
              if (hasTableTypes) {
                ...
                switch (TableType.getTableTypeCompliantWith(tableType)) {
                  case TABLE:
                    ...
                    if (operatingOnSystemDB && shouldReportSystemTables) {
                      ...
                      tablesKey =
                          new TableMetaDataKey(
                              TableType.SYSTEM_TABLE.getName(),
                              dbPattern,
                              null,
                              results.getString(1));
                      reportTable = true;
                      ...
                      tablesKey =
                          new TableMetaDataKey(
                              TableType.TABLE.getName(), dbPattern, null, results.getString(1));
                      reportTable = true;
                    }
                  ...
                  case VIEW:
                    if (shouldReportViews) {
                      ...
                      sortedRows.put(
                          new TableMetaDataKey(
                              TableType.VIEW.getName(), dbPattern, null, results.getString(1)),
                  ...
                  case LOCAL_TEMPORARY:
                    if (shouldReportLocalTemporaries) {
                      ...
                      sortedRows.put(
                          new TableMetaDataKey(
                              TableType.LOCAL_TEMPORARY.getName(),
                              dbPattern,
                              null,
                              results.getString(1)),
                          new ByteArrayRow(row, getExceptionInterceptor()));
                ...
                // TODO: Check if this branch is needed for 5.7 server (maybe refactor
                // hasTableTypes)
  ...
  public java.sql.ResultSet getTableTypes() throws SQLException {
    ...
    tuples.add(
        new ByteArrayRow(
            new byte[][] {TableType.LOCAL_TEMPORARY.asBytes()}, getExceptionInterceptor()));
    tuples.add(
        new ByteArrayRow(
            new byte[][] {TableType.SYSTEM_TABLE.asBytes()}, getExceptionInterceptor()));
    tuples.add(
        new ByteArrayRow(
            new byte[][] {TableType.SYSTEM_VIEW.asBytes()}, getExceptionInterceptor()));
    tuples.add(
        new ByteArrayRow(new byte[][] {TableType.TABLE.asBytes()}, getExceptionInterceptor()));
    tuples.add(
        new ByteArrayRow(new byte[][] {TableType.VIEW.asBytes()}, getExceptionInterceptor()));
  ...
  private byte[][] getTypeInfo(String mysqlTypeName) throws SQLException {
    ...
    rowVal[1] =
        Integer.toString(
                mt == MysqlType.YEAR && !DatabaseMetaData.this.yearIsDateType
                    ? Types.SMALLINT
                    : mt.getJdbcType())
            .getBytes(); // JDBC Data type
    // JDBC spec reserved only 'int' type for precision, thus we need to cut longer values
    rowVal[2] =
        Integer.toString(
                mt.getPrecision() > Integer.MAX_VALUE
                    ? Integer.MAX_VALUE
                    : mt.getPrecision().intValue())
            .getBytes(); // Precision
    switch (mt) {
      case TINYBLOB:
      case BLOB:
  ...
  public java.sql.ResultSet getTypeInfo() throws SQLException {
    ...
    fields[2] =
        new Field(
            "", "PRECISION", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 10);
    fields[3] =
        new Field(
            "",
            "LITERAL_PREFIX",
    ...
    tuples.add(
        new ByteArrayRow(getTypeInfo("DOUBLE PRECISION UNSIGNED"), getExceptionInterceptor()));
  ...
  public java.sql.ResultSet getUDTs(
    ...
    fields[4] =
        new Field(
            "", "DATA_TYPE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 10);
    fields[5] =
        new Field(
            "",
            "REMARKS",
  ...
  @Override
  public java.sql.ResultSet getVersionColumns(String catalog, String schema, final String table)
      throws SQLException {
        ...
        void forEach(String dbStr) throws SQLException {
          ...
          try {
            StringBuilder whereBuf =
                new StringBuilder(" Extra LIKE '%on update CURRENT_TIMESTAMP%'");
            ...
            if (whereBuf.length() > 0 || rsFields.size() > 0) {
              ...
              while (results != null && results.next()) {
                ...
                rowVal[4] =
                    typeDesc.columnSize == null
                        ? null
                        : s2b(typeDesc.columnSize.toString()); // COLUMN_SIZE
                rowVal[5] = s2b(Integer.toString(typeDesc.bufferLength)); // BUFFER_LENGTH
                rowVal[6] =
                    typeDesc.decimalDigits == null
                        ? null
                        : s2b(typeDesc.decimalDigits.toString()); // DECIMAL_DIGITS
                rowVal[7] =
                    Integer.toString(java.sql.DatabaseMetaData.versionColumnNotPseudo)
                        .getBytes(); // PSEUDO_COLUMN
                rows.add(new ByteArrayRow(rowVal, getExceptionInterceptor()));
              }
            }
          } catch (SQLException sqlEx) {
  ...
  protected LocalAndReferencedColumns parseTableStatusIntoLocalAndReferencedColumns(
    ...
    // keys will equal something like this: (parent_service_id child_service_id) REFER
    ...
    int indexOfOpenParenLocalColumns =
        StringUtils.indexOfIgnoreCase(
            0, keysComment, "(", this.quotedId, this.quotedId, SearchMode.__BSE_MRK_COM_MYM_HNT_WS);

    if (indexOfOpenParenLocalColumns == -1) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.14"),
          MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
          getExceptionInterceptor());
    }
    ...
    String constraintName =
        StringUtils.unQuoteIdentifier(
            keysComment.substring(0, indexOfOpenParenLocalColumns).trim(), this.quotedId);
    ...
    int indexOfCloseParenLocalColumns =
        StringUtils.indexOfIgnoreCase(
            0,
            keysCommentTrimmed,
            ")",
    ...
    if (indexOfCloseParenLocalColumns == -1) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.15"),
          MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
          getExceptionInterceptor());
    }
    ...
    if (indexOfRefer == -1) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.16"),
          MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
          getExceptionInterceptor());
    }

    int indexOfOpenParenReferCol =
        StringUtils.indexOfIgnoreCase(
            indexOfRefer,
            keysCommentTrimmed,
            "(",
    ...
    if (indexOfOpenParenReferCol == -1) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.17"),
          MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
          getExceptionInterceptor());
    }

    String referDbTableString =
    ...
    if (indexOfSlash == -1) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.18"),
          MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
          getExceptionInterceptor());
    }

    String referDb =
        StringUtils.unQuoteIdentifier(referDbTableString.substring(0, indexOfSlash), this.quotedId);
    String referTable =
        StringUtils.unQuoteIdentifier(
            referDbTableString.substring(indexOfSlash + 1).trim(), this.quotedId);

    int indexOfCloseParenRefer =
        StringUtils.indexOfIgnoreCase(
    ...
    if (indexOfCloseParenRefer == -1) {
      throw SQLError.createSQLException(
          Messages.getString("DatabaseMetaData.19"),
          MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
          getExceptionInterceptor());
    }

    String referColumnNamesString =
        keysCommentTrimmed.substring(indexOfOpenParenReferCol + 1, indexOfCloseParenRefer);

    List<String> referColumnsList =
        StringUtils.split(
            referColumnNamesString, columnsDelimitter, this.quotedId, this.quotedId, false);
    List<String> localColumnsList =
        StringUtils.split(
            localColumnNamesString, columnsDelimitter, this.quotedId, this.quotedId, false);

    return new LocalAndReferencedColumns(
        localColumnsList, referColumnsList, constraintName, referDb, referTable);
  }
  ...
  public boolean supportsIntegrityEnhancementFacility() throws SQLException {
    if (!this.conn
        .getPropertySet()
        .getBooleanProperty(PropertyKey.overrideSupportsIntegrityEnhancementFacility)
        .getValue()) {
      return false;
    }
  ...
  public boolean supportsResultSetConcurrency(int type, int concurrency) throws SQLException {
    ...
    throw SQLError.createSQLException(
        Messages.getString("DatabaseMetaData.20"),
        MysqlErrorNumbers.SQL_STATE_ILLEGAL_ARGUMENT,
        getExceptionInterceptor());
  }
  ...
  public ResultSet getClientInfoProperties() throws SQLException {
    // We don't have any built-ins, we actually support whatever the client wants to provide,
    // however we don't have a way to express this with the interface
    // given
    Field[] fields = new Field[4];
    fields[0] =
        new Field(
            "", "NAME", this.metadataCollationIndex, this.metadataEncoding, MysqlType.VARCHAR, 255);
    fields[1] =
        new Field(
            "", "MAX_LEN", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 10);
    fields[2] =
        new Field(
            "",
            "DEFAULT_VALUE",
  ...
  protected Field[] createFunctionColumnsFields() {
    Field[] fields = {
      ...
      new Field(
          "", "LENGTH", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 12),
      new Field(
          "", "SCALE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.SMALLINT, 12),
      new Field(
          "", "RADIX", this.metadataCollationIndex, this.metadataEncoding, MysqlType.SMALLINT, 6),
      new Field(
          "",
  ...
  @Override
  public java.sql.ResultSet getFunctions(
      String catalog, String schemaPattern, String functionNamePattern) throws SQLException {
    return getProceduresAndOrFunctions(
        getFunctionsFields(), catalog, schemaPattern, functionNamePattern, false, true);
  }
  ...
  protected java.sql.PreparedStatement prepareMetaDataSafeStatement(String sql)
    ...
    java.sql.PreparedStatement pStmt =
        this.conn.clientPrepareStatement(
  ...
  public java.sql.ResultSet getPseudoColumns(
    ...
    Field[] fields = {
      ...
      new Field(
          ...
          512),
      new Field(
          "", "DATA_TYPE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 12),
      new Field(
          "", "COLUMN_SIZE", this.metadataCollationIndex, this.metadataEncoding, MysqlType.INT, 12),
      new Field(
          "",
          "DECIMAL_DIGITS",
          this.metadataCollationIndex,
