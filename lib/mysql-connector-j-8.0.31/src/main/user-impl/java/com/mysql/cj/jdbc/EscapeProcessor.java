...
class EscapeProcessor {
   ...
   * @param connectionTimeZone server time zone
        ...
        if (token.charAt(0) == '{') { // It's an escape code
          ...
          if (!token.endsWith("}")) {
            throw SQLError.createSQLException(
                Messages.getString("EscapeProcessor.0", new Object[] {token}),
          ...
          if (StringUtils.startsWithIgnoreCase(collapsedToken, "{escape")) {
            ...
            if ((startPos == -1) || (endPos == -1)) {
              ...
              try {
                ...
                throw SQLError.createSQLException(
                    Messages.getString("EscapeProcessor.1", new Object[] {argument}),
                    MysqlErrorNumbers.SQL_STATE_SYNTAX_ERROR,
                    exceptionInterceptor);
              }
            }
            ...
            for (int i = endPos - 1; i >= startPos; i--) {
              ...
              if (c != ')') {
                newSql.append(
                    "()"); // handle no-parenthesis no-arg call not supported by MySQL parser
              }
  ...
  private static void processTimeToken(
    ...
    if ((startPos == -1) || (endPos == -1)) {
      ...
      try {
        ...
        throw SQLError.createSQLException(
            Messages.getString("EscapeProcessor.3", new Object[] {argument}),
            MysqlErrorNumbers.SQL_STATE_SYNTAX_ERROR,
            exceptionInterceptor);
      }
    }
      ...
      try {
        ...
        SQLException sqlEx =
            SQLError.createSQLException(
                Messages.getString("EscapeProcessor.2", new Object[] {argument}),
                MysqlErrorNumbers.SQL_STATE_SYNTAX_ERROR,
                exceptionInterceptor);
   ...
   * @throws SQLException if error occurs
   */
  private static String processConvertToken(
      String functionToken, ExceptionInterceptor exceptionInterceptor) throws SQLException {
    ...
    if (firstIndexOfParen == -1) {
      throw SQLError.createSQLException(
          Messages.getString("EscapeProcessor.4", new Object[] {functionToken}),
          MysqlErrorNumbers.SQL_STATE_SYNTAX_ERROR,
          exceptionInterceptor);
    }
    ...
    if (indexOfComma == -1) {
      throw SQLError.createSQLException(
          Messages.getString("EscapeProcessor.5", new Object[] {functionToken}),
          MysqlErrorNumbers.SQL_STATE_SYNTAX_ERROR,
          exceptionInterceptor);
    }
    ...
    if (indexOfCloseParen == -1) {
      throw SQLError.createSQLException(
          Messages.getString("EscapeProcessor.6", new Object[] {functionToken}),
          MysqlErrorNumbers.SQL_STATE_SYNTAX_ERROR,
          exceptionInterceptor);
    }
    ...
    if (newType == null) {
      throw SQLError.createSQLException(
          Messages.getString("EscapeProcessor.7", new Object[] {type.trim()}),
