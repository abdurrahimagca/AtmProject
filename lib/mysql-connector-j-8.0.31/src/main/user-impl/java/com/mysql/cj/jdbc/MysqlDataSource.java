...
public class MysqlDataSource extends JdbcPropertySetImpl
  ...
  protected java.sql.Connection getConnection(Properties props) throws SQLException {
    ...
    urlProps.stringPropertyNames().stream()
        .forEach(k -> props.setProperty(k, urlProps.getProperty(k)));
  ...
  protected void setBooleanRuntimeProperty(String name, boolean value) throws SQLException {
    ((AbstractRuntimeProperty<Boolean>) getBooleanProperty(name))
        .setValueInternal(value, null, null);
  }
  ...
  protected void setIntegerRuntimeProperty(String name, int value) throws SQLException {
    ((AbstractRuntimeProperty<Integer>) getIntegerProperty(name))
        .setValueInternal(value, null, null);
  }
  ...
  protected void setMemorySizeRuntimeProperty(String name, int value) throws SQLException {
    ((AbstractRuntimeProperty<Integer>) getMemorySizeProperty(name))
        .setValueInternal(value, null, null);
  }
