...
public class NonRegisteringDriver implements java.sql.Driver {
  ...
  /**
   * Typically, drivers will return true if they understand the subprotocol specified in the URL and
   * false if they don't. This driver's protocols start with jdbc:mysql:
   *
   ...
   *
   * <p>The driver should raise an SQLException if the URL is null or if it is the right driver to
   ...
   *
   * <p>MySQL protocol takes the form: jdbc:mysql://host:port/database
   *
  ...
  public DriverPropertyInfo[] getPropertyInfo(String url, Properties info) throws SQLException {
    ...
    DriverPropertyInfo passwordProp =
        new DriverPropertyInfo(PropertyKey.PASSWORD.getKeyName(), password);
    ...
    dpi[4] = passwordProp;
    System.arraycopy(
        driverPropInfo.toArray(new DriverPropertyInfo[0]), 0, dpi, 5, driverPropInfo.size());
