...
public class PreparedStatementWrapper extends StatementWrapper implements PreparedStatement {
  ...
  protected static PreparedStatementWrapper getInstance(
      ConnectionWrapper c, MysqlPooledConnection conn, PreparedStatement toWrap)
      throws SQLException {
  ...
  public boolean isWrapperFor(Class<?> iface) throws SQLException {
    ...
    return (interfaceClassName.equals("com.mysql.cj.jdbc.Statement")
        ...
        || interfaceClassName.equals("java.sql.PreparedStatement")); // TODO check other interfaces
  }
