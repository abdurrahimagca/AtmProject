...
public class StatementWrapper extends WrapperBase implements Statement {
  ...
  protected static StatementWrapper getInstance(
      ConnectionWrapper c, MysqlPooledConnection conn, Statement toWrap) throws SQLException {
  ...
  public Connection getConnection() throws SQLException {
    try {
      ...
      throw SQLError.createSQLException(
          Messages.getString("Statement.AlreadyClosed"),
  ...
  public int getFetchDirection() throws SQLException {
    ...
    return ResultSet
        .FETCH_FORWARD; // we actually never get here, but the compiler can't figure that out
  }
