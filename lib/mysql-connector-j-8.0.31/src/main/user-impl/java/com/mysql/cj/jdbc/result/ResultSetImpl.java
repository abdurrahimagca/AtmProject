...
public class ResultSetImpl extends NativeResultset
  ...
  /**
   * First character of the query that created this result set...Used to determine whether or not to
   * parse server info messages in certain circumstances.
   */
  ...
  public ResultSetImpl(OkPacket ok, JdbcConnection conn, StatementImpl creatorStmt) {
    ...
    if (this.connection != null) {
      ...
      this.padCharsWithSpace =
          this.connection
              .getPropertySet()
              .getBooleanProperty(PropertyKey.padCharsWithSpace)
              .getValue();
    }
  }
  ...
  public ResultSetImpl(ResultsetRows tuples, JdbcConnection conn, StatementImpl creatorStmt)
    ...
    this.defaultTimeValueFactory =
        new SqlTimeValueFactory(
    ...
    this.defaultUtilCalendarValueFactory =
        new UtilCalendarValueFactory(
            pset,
            this.session.getServerSession().getDefaultTimeZone(),
            this.session.getServerSession().getSessionTimeZone());
    ...
    this.defaultOffsetTimeValueFactory =
        new OffsetTimeValueFactory(
            pset, this.session.getProtocol().getServerSession().getDefaultTimeZone());
    this.defaultOffsetDateTimeValueFactory =
        new OffsetDateTimeValueFactory(
            pset,
            this.session.getProtocol().getServerSession().getDefaultTimeZone(),
            this.session.getProtocol().getServerSession().getSessionTimeZone());
    this.defaultZonedDateTimeValueFactory =
    ...
    this.useColumnNamesInFindColumn =
        pset.getBooleanProperty(PropertyKey.useColumnNamesInFindColumn).getValue();
    ...
    synchronized (checkClosed().getConnectionMutex()) {
      ...
      if (this.gatherPerfMetrics) {
        ...
        this.session
            .getProtocol()
            .getMetricsHolder()
            .reportNumberOfTablesAccessed(tableNamesSet.size());
      }
    }
  }
    ...
    synchronized (checkClosed().getConnectionMutex()) {
      if (!hasRows()) {
        throw SQLError.createSQLException(
            Messages.getString("ResultSet.ResultSet_is_from_UPDATE._No_Data_115"),
  ...
  protected final void checkColumnBounds(int columnIndex) throws SQLException {
    synchronized (checkClosed().getConnectionMutex()) {
      if ((columnIndex < 1)) {
        throw SQLError.createSQLException(
            Messages.getString(
                "ResultSet.Column_Index_out_of_range_low",
                new Object[] {
        ...
        throw SQLError.createSQLException(
            Messages.getString(
                "ResultSet.Column_Index_out_of_range_high",
                new Object[] {
                  Integer.valueOf(columnIndex),
                  Integer.valueOf(this.columnDefinition.getFields().length)
                }),
  ...
  public int findColumn(String columnName) throws SQLException {
    synchronized (checkClosed().getConnectionMutex()) {
      ...
      if (index == -1) {
        throw SQLError.createSQLException(
            Messages.getString("ResultSet.Column____112")
                + columnName
    ...
    try {
      ...
      SQLException sqlEx =
          SQLError.createSQLException(
              "Cannot read value with encoding: " + f.getEncoding(), this.exceptionInterceptor);
      sqlEx.initCause(e);
      throw sqlEx;
    }
  }
    ...
    try {
      ...
      throw SQLError.createSQLException(
          Messages.getString(
              ...
              new Object[] {Integer.valueOf(columnIndex), stringVal}),
          MysqlErrorNumbers.SQL_STATE_ILLEGAL_ARGUMENT,
          getExceptionInterceptor());
    }
  }
  ...
  public String getString(int columnIndex) throws SQLException {
    ...
    if (this.padCharsWithSpace
        && stringVal != null
        && f.getMysqlTypeId() == MysqlType.FIELD_TYPE_STRING) {
      int maxBytesPerChar =
          this.session
              .getServerSession()
              .getCharsetSettings()
      ...
      int fieldLength =
          (int) f.getLength() /* safe, bytes in a CHAR <= 1024 */
              / maxBytesPerChar; /* safe, this will never be 0 */
  ...
  public Object getObject(int columnIndex) throws SQLException {
    ...
    // we can't completely rely on code below because primitives have default values for null (e.g.
    // int->0)
    ...
    switch (field.getMysqlType()) {
      case BIT:
        // TODO Field sets binary and blob flags if the length of BIT field is > 1; is it needed at
        // all?
        if (field.isBinary() || field.isBlob()) {
          ...
          if (this.connection
              .getPropertySet()
              .getBooleanProperty(PropertyKey.autoDeserialize)
              .getValue()) {
            Object obj = data;
        ...
        return field.isSingleBit()
            ? Boolean.valueOf(getBoolean(columnIndex))
    ...
    synchronized (checkClosed().getConnectionMutex()) {
      if (type.equals(String.class)) {
        ...
        return (T)
            this.thisRow.getValue(
                columnIndex - 1, new DurationValueFactory(this.session.getPropertySet()));
      }
      ...
      if (this.connection
        ...
        try {
          ...
          SQLException sqlEx =
              SQLError.createSQLException(
                  "Conversion not supported for type " + type.getName(),
                  MysqlErrorNumbers.SQL_STATE_ILLEGAL_ARGUMENT,
                  getExceptionInterceptor());
          sqlEx.initCause(cce);
  ...
  @Override
  public Object getObjectStoredProc(int i, java.util.Map<Object, Object> map, int desiredSqlType)
      throws SQLException {
  ...
  public Object getObjectStoredProc(
      String colName, java.util.Map<Object, Object> map, int desiredSqlType) throws SQLException {
  ...
  public java.sql.Statement getStatement() throws SQLException {
    try {
      ...
      throw SQLError.createSQLException(
          "Operation not allowed on closed ResultSet.",
          MysqlErrorNumbers.SQL_STATE_GENERAL_ERROR,
          getExceptionInterceptor());
    }
  }
  ...
  public URL getURL(int colIndex) throws SQLException {
    ...
    try {
      ...
      throw SQLError.createSQLException(
          Messages.getString("ResultSet.Malformed_URL____104") + val + "'",
          MysqlErrorNumbers.SQL_STATE_ILLEGAL_ARGUMENT,
          getExceptionInterceptor());
    }
  }
  ...
  public URL getURL(String colName) throws SQLException {
    ...
    try {
      ...
      throw SQLError.createSQLException(
          Messages.getString("ResultSet.Malformed_URL____107") + val + "'",
          MysqlErrorNumbers.SQL_STATE_ILLEGAL_ARGUMENT,
          getExceptionInterceptor());
    }
  }
   ...
   *
   * @return <code>true</code> if this result set type is ResultSet.TYPE_FORWARD_ONLY and the
   *     connection property 'scrollTolerantForwardOnly' has not been set to <code>true</code>.
   */
   ...
   *
   * <p>If an input stream from the previous row is open, it is implicitly closed. The ResultSet's
    ...
    synchronized (locallyScopedConn.getConnectionMutex()) {
      ...
      try {
        if (this.useUsageAdvisor) {
          ...
          int resultSetSizeThreshold =
              locallyScopedConn
                  .getPropertySet()
                  .getIntegerProperty(PropertyKey.resultSetSizeThreshold)
                  .getValue();
          ...
          if (!isLast() && !isAfterLast() && (this.rowData.size() != 0)) {
            this.eventSink.processEvent(
                ...
                Messages.getString(
                    ...
                    new Object[] {
                      Integer.valueOf(getRow()), Integer.valueOf(this.rowData.size())
                    }));
          }
    ...
    synchronized (checkClosed().getConnectionMutex()) {
      ...
      if (isStrictlyForwardOnly() && direction != FETCH_FORWARD) {
        ...
        throw ExceptionFactory.createException(
            Messages.getString(
                "ResultSet.Unacceptable_value_for_fetch_direction", new Object[] {constName}));
      }
  ...
  public void setFetchSize(int rows) throws SQLException {
    synchronized (checkClosed().getConnectionMutex()) {
      if (rows < 0) {
        /* || rows > getMaxRows() */
        throw SQLError.createSQLException(
            Messages.getString("ResultSet.Value_must_be_between_0_and_getMaxRows()_66"),
            MysqlErrorNumbers.SQL_STATE_ILLEGAL_ARGUMENT,
            getExceptionInterceptor());
      }
  ...
  public String toString() {
    return hasRows()
        ? super.toString()
        : "Result set representing update count of " + this.updateCount;
  }
