...
public class ColumnImpl implements Column {
    ...
    switch (this.field.getMysqlType()) {
      ...
      case BIGINT:
        ...
        throw new IllegalArgumentException(
            "Unknown field length `" + this.field.getLength() + "` for signed int");
      case BIGINT_UNSIGNED:
        ...
        throw new IllegalArgumentException(
            "Unknown field length `" + this.field.getLength() + "` for unsigned int");
      case FLOAT:
      case FLOAT_UNSIGNED:
        return Type.FLOAT;
      case DECIMAL:
      ...
      case DATETIME:
        ...
        throw new IllegalArgumentException(
            "Unknown field length `" + this.field.getLength() + "` for datetime");
      case TIMESTAMP:
  ...
  public String getCollationName() {
    return CharsetMapping.getStaticCollationNameForCollationIndex(
        this.field.getCollationIndex()); // TODO use CharsetSettings method
  }

  public String getCharacterSetName() {
    return CharsetMapping.getStaticMysqlCharsetNameForCollationIndex(
        this.field.getCollationIndex()); // TODO use CharsetSettings method
  }
