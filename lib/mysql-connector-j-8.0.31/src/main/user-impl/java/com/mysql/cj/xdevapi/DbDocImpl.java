 ...
 * </pre>
 *
 * <b>key</b> is a JSON <b>string</b>. <b>value</b> is any of JSON <b>object</b>, <b>array</b>,
 * <b>number</b>, <b>string</b>, true, false, null.
 *
 * <p>Example of valid JSON object:
 *
 * <pre>
 * {
 * "field1" : "value 1",
 ...
 * </pre>
 *
 * To create {@link DbDoc} from existing string representation you need to use {@link
 * JsonParser#parseDoc(java.io.StringReader)} method:
 *
 * <pre>
 * DbDoc doc = JsonParser.parseDoc(new StringReader(&quot;{\&quot;key1\&quot; : \&quot;value1\&quot;}&quot;));
 * </pre>
 *
 * You can construct JSON document by {@link DbDoc}, {@link JsonString}, {@link JsonNumber}, {@link
 * JsonArray} and {@link JsonLiteral} methods and get JSON string representation by using {@link
