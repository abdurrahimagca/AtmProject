 ...
 */
public abstract class FilterableStatement<STMT_T, RES_T> extends PreparableStatement<RES_T>
   ...
   *
   * <p>For example, to find only 3 rows:
   *
   * <pre>
  ...
  public STMT_T offset(long limitOffset) {
    // Offset depends on Limit. There is no need to re-prepare the statement even if OFFSET was
    // never set before.
