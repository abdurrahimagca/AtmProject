...
public class ModifyStatementImpl extends FilterableStatement<ModifyStatement, Result>
  ...
  /* package private */ ModifyStatementImpl(
  ...
  protected Result executeStatement() {
    return this.mysqlxSession.query(
        getMessageBuilder().buildDocUpdate(this.filterParams, this.updates),
  ...
  protected XMessage getPrepareStatementXMessage() {
    return getMessageBuilder()
        .buildPrepareDocUpdate(this.preparedStatementId, this.filterParams, this.updates);
  }
  ...
  public CompletableFuture<Result> executeAsync() {
    return this.mysqlxSession.queryAsync(
        ((XMessageBuilder) this.mysqlxSession.<XMessage>getMessageBuilder())
            .buildDocUpdate(this.filterParams, this.updates),
        new UpdateResultBuilder<>());
  }
  ...
  public ModifyStatement unset(String... docPath) {
    ...
    this.updates.addAll(
        Arrays.stream(docPath)
            .map(dp -> new UpdateSpec(UpdateType.ITEM_REMOVE, dp))
