...
public class BigDecimalValueFactoryTest extends CommonAsserts {
  ...
  public void testCreateFromDate() {
    assertThrows(
        ...
        "Unsupported conversion from DATE to java.math.BigDecimal",
        new Callable<Void>() {
          @Override
  ...
  public void testCreateFromTime() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIME to java.math.BigDecimal",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromTimestamp() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIMESTAMP to java.math.BigDecimal",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            BigDecimalValueFactoryTest.this.vf.createFromTimestamp(
  ...
  public void testCreateFromLong() {
    ...
    assertEquals(
        Constants.BIG_DECIMAL_MAX_INTEGER_VALUE, this.vf.createFromLong(Integer.MAX_VALUE));
    assertEquals(Constants.BIG_DECIMAL_NEGATIVE_ONE, this.vf.createFromLong(-1));
    assertEquals(
        Constants.BIG_DECIMAL_MIN_INTEGER_VALUE, this.vf.createFromLong(Integer.MIN_VALUE));
  }
  ...
  public void testCreateFromBigInteger() {
    ...
    assertEquals(
        Constants.BIG_DECIMAL_MAX_INTEGER_VALUE,
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_MAX_INTEGER_VALUE));
    assertEquals(
        Constants.BIG_DECIMAL_NEGATIVE_ONE,
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_NEGATIVE_ONE));
    assertEquals(
        Constants.BIG_DECIMAL_MIN_INTEGER_VALUE,
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_MIN_INTEGER_VALUE));
  }
  ...
  public void testCreateFromDouble() {
    ...
    assertEquals(
        Constants.BIG_DECIMAL_MAX_INTEGER_VALUE, this.vf.createFromDouble(Integer.MAX_VALUE));
    assertEquals(BigDecimal.valueOf(-1.0), this.vf.createFromDouble(-1));
    assertEquals(
        Constants.BIG_DECIMAL_MIN_INTEGER_VALUE, this.vf.createFromDouble(Integer.MIN_VALUE));
  }
  ...
  public void testCreateFromBigDecimal() {
    ...
    assertEquals(
        Constants.BIG_DECIMAL_MIN_INTEGER_VALUE,
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MIN_INTEGER_VALUE));
  }
  ...
  public void testCreateFromBytes() {
    ...
    assertThrows(
        ...
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            BigDecimalValueFactoryTest.this.vf.createFromBytes(
  ...
  public void testCreateFromBit() {
    ...
    assertEquals(
        BigDecimal.valueOf(0xffffL),
        this.vf.createFromBit(new byte[] {(byte) 0xff, (byte) 0xff}, 0, 2));
    assertEquals(
        BigDecimal.valueOf(0xffffffL),
        this.vf.createFromBit(new byte[] {(byte) 0xff, (byte) 0xff, (byte) 0xff}, 0, 3));
    assertEquals(
        BigDecimal.valueOf(0xffffffffL),
        this.vf.createFromBit(
            new byte[] {(byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff}, 0, 4));
    assertEquals(
        BigDecimal.valueOf(0xffffffffffL),
        this.vf.createFromBit(
            new byte[] {(byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff}, 0, 5));
    assertEquals(
        BigDecimal.valueOf(0xffffffffffffL),
        this.vf.createFromBit(
            new byte[] {
            ...
            6));
    assertEquals(
        BigDecimal.valueOf(0xffffffffffffffL),
        this.vf.createFromBit(
            new byte[] {
              (byte) 0xff,
              (byte) 0xff,
