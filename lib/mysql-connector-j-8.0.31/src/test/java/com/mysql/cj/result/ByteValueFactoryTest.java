...
public class ByteValueFactoryTest extends CommonAsserts {
  ...
  public void testCreateFromDate() {
    assertThrows(
        ...
        "Unsupported conversion from DATE to java.lang.Byte",
        new Callable<Void>() {
          @Override
  ...
  public void testCreateFromTime() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIME to java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromTimestamp() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIMESTAMP to java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            ByteValueFactoryTest.this.vf.createFromTimestamp(
  ...
  public void testCreateFromLong() {
    ...
    assertThrows(
        ...
        "Value '128' is outside of valid range for type java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
    ...
    assertThrows(
        NumberOutOfRange.class,
        "Value '-129' is outside of valid range for type java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromBigInteger() {
    ...
    assertEquals(
        ...
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_MAX_BYTE_VALUE));
    assertEquals(
        Byte.valueOf((byte) -1), this.vf.createFromBigInteger(Constants.BIG_INTEGER_NEGATIVE_ONE));
    assertEquals(
        Byte.valueOf(Byte.MIN_VALUE),
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_MIN_BYTE_VALUE));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            ByteValueFactoryTest.this.vf.createFromBigInteger(
  ...
  public void testCreateFromBigDecimal() {
    ...
    assertEquals(
        Byte.valueOf(Byte.MAX_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MAX_BYTE_VALUE));
    assertEquals(
        Byte.valueOf((byte) -1), this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_NEGATIVE_ONE));
    assertEquals(
        Byte.valueOf(Byte.MIN_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MIN_BYTE_VALUE));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            ByteValueFactoryTest.this.vf.createFromBigDecimal(
                BigDecimal.valueOf(Byte.MAX_VALUE + 1));
            return null;
          }
        });
    assertThrows(
  ...
  public void testCreateFromBytes() {
    ...
    // jdbcCompliantTruncation initial value is cached in ValueFactiry, thus we need to construct a
    // property set with required initial value
    ...
    assertEquals(
        Byte.valueOf((byte) '-'), vfAllowTrunc.createFromBytes("-1.0".getBytes(), 0, 4, f));
    assertEquals(Byte.valueOf((byte) '1'), vfAllowTrunc.createFromBytes("1e0".getBytes(), 0, 3, f));
    assertEquals(
        Byte.valueOf((byte) '-'), vfAllowTrunc.createFromBytes("-1e1".getBytes(), 0, 4, f));
    ...
    assertThrows(
        NumberOutOfRange.class,
        "Value '-1.0' is outside of valid range for type java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
    ...
    assertThrows(
        NumberOutOfRange.class,
        "Value '1e0' is outside of valid range for type java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
    ...
    assertThrows(
        NumberOutOfRange.class,
        "Value '123' is outside of valid range for type java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
    ...
    assertThrows(
        NumberOutOfRange.class,
        "Value 'just a string' is outside of valid range for type java.lang.Byte",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
