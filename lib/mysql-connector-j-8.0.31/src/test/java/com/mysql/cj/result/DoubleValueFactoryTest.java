...
public class DoubleValueFactoryTest extends CommonAsserts {
  ...
  public void testCreateFromDate() {
    assertThrows(
        ...
        "Unsupported conversion from DATE to java.lang.Double",
        new Callable<Void>() {
          @Override
  ...
  public void testCreateFromTime() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIME to java.lang.Double",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromTimestamp() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIMESTAMP to java.lang.Double",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            DoubleValueFactoryTest.this.vf.createFromTimestamp(
  ...
  public void testCreateFromBigInteger() {
    ...
    assertEquals(
        ...
        this.vf.createFromBigInteger(Constants.BIG_DECIMAL_MAX_DOUBLE_VALUE.toBigInteger()));
    assertEquals(
        Double.valueOf(-1d), this.vf.createFromBigInteger(Constants.BIG_INTEGER_NEGATIVE_ONE));
    assertEquals(
        Double.valueOf(-Double.MAX_VALUE),
        this.vf.createFromBigInteger(
            Constants.BIG_DECIMAL_MAX_NEGATIVE_DOUBLE_VALUE.toBigInteger()));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Double",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            DoubleValueFactoryTest.this.vf.createFromBigInteger(
                Constants.BIG_DECIMAL_MAX_DOUBLE_VALUE
                    .toBigInteger()
    ...
    assertThrows(
        ...
        new Callable<Void>() {
          ...
          public Void call() throws Exception {
            DoubleValueFactoryTest.this.vf.createFromBigInteger(
                Constants.BIG_DECIMAL_MAX_NEGATIVE_DOUBLE_VALUE
                    .toBigInteger()
  ...
  public void testCreateFromBigDecimal() {
    ...
    assertEquals(
        Double.valueOf(Double.MAX_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MAX_DOUBLE_VALUE));
    assertEquals(
        Double.valueOf(-1), this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_NEGATIVE_ONE));
    assertEquals(
        Double.valueOf(-Double.MAX_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MAX_NEGATIVE_DOUBLE_VALUE));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Double",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            DoubleValueFactoryTest.this.vf.createFromBigDecimal(
                Constants.BIG_DECIMAL_MAX_DOUBLE_VALUE.add(Constants.BIG_DECIMAL_MAX_DOUBLE_VALUE));
            return null;
          }
        });
    assertThrows(
        ...
        new Callable<Void>() {
          ...
          public Void call() throws Exception {
            DoubleValueFactoryTest.this.vf.createFromBigDecimal(
                Constants.BIG_DECIMAL_MAX_NEGATIVE_DOUBLE_VALUE.subtract(
                    Constants.BIG_DECIMAL_MAX_DOUBLE_VALUE));
            return null;
          }
        });
  ...
  public void testCreateFromBit() {
    ...
    assertEquals(
        ...
        this.vf.createFromBit(
            ...
            6));
    assertEquals(
        Double.valueOf(0xffffffffffffffL),
        this.vf.createFromBit(
            new byte[] {
              (byte) 0xff,
              (byte) 0xff,
            ...
            7));
    assertEquals(
        Double.valueOf("1.8446744073709552E19"),
        this.vf.createFromBit(
            new byte[] {
              (byte) 0xff,
              (byte) 0xff,
