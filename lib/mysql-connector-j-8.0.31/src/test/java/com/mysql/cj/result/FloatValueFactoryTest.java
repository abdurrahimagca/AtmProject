...
public class FloatValueFactoryTest extends CommonAsserts {
  ...
  public void testCreateFromDate() {
    assertThrows(
        ...
        "Unsupported conversion from DATE to java.lang.Float",
        new Callable<Void>() {
          @Override
  ...
  public void testCreateFromTime() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIME to java.lang.Float",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromTimestamp() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIMESTAMP to java.lang.Float",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            FloatValueFactoryTest.this.vf.createFromTimestamp(
  ...
  public void testCreateFromBigInteger() {
    ...
    assertEquals(
        ...
        this.vf.createFromBigInteger(Constants.BIG_DECIMAL_MAX_FLOAT_VALUE.toBigInteger()));
    assertEquals(
        Float.valueOf(-1f), this.vf.createFromBigInteger(Constants.BIG_INTEGER_NEGATIVE_ONE));
    assertEquals(
        Float.valueOf(-Float.MAX_VALUE),
        this.vf.createFromBigInteger(
            Constants.BIG_DECIMAL_MAX_NEGATIVE_FLOAT_VALUE.toBigInteger()));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Float",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            FloatValueFactoryTest.this.vf.createFromBigInteger(
                Constants.BIG_DECIMAL_MAX_FLOAT_VALUE
                    .toBigInteger()
                    .add(Constants.BIG_INTEGER_ONE));
            return null;
          }
        });
    assertThrows(
        ...
        new Callable<Void>() {
          ...
          public Void call() throws Exception {
            FloatValueFactoryTest.this.vf.createFromBigInteger(
                Constants.BIG_DECIMAL_MAX_NEGATIVE_FLOAT_VALUE
                    .toBigInteger()
                    .subtract(Constants.BIG_INTEGER_ONE));
            return null;
          }
        });
  }
  ...
  public void testCreateFromDouble() {
    ...
    assertThrows(
        ...
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            FloatValueFactoryTest.this.vf.createFromDouble(
  ...
  public void testCreateFromBigDecimal() {
    ...
    assertEquals(
        Float.valueOf(Float.MAX_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MAX_FLOAT_VALUE));
    assertEquals(
        Float.valueOf(-1f), this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_NEGATIVE_ONE));
    assertEquals(
        Float.valueOf(-Float.MAX_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MAX_NEGATIVE_FLOAT_VALUE));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Float",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            FloatValueFactoryTest.this.vf.createFromBigDecimal(
                Constants.BIG_DECIMAL_MAX_FLOAT_VALUE.add(Constants.BIG_DECIMAL_ONE));
            return null;
          }
        });
    assertThrows(
        ...
        new Callable<Void>() {
          ...
          public Void call() throws Exception {
            FloatValueFactoryTest.this.vf.createFromBigDecimal(
                BigDecimal.valueOf((double) -Float.MAX_VALUE - Float.MAX_VALUE));
            return null;
          }
        });
  }
  ...
  public void testCreateFromBit() {
    ...
    assertEquals(
        Float.valueOf(65535), this.vf.createFromBit(new byte[] {(byte) 0xff, (byte) 0xff}, 0, 2));
    assertEquals(
        Float.valueOf(0xffffffL),
        this.vf.createFromBit(new byte[] {(byte) 0xff, (byte) 0xff, (byte) 0xff}, 0, 3));
    assertEquals(
        Float.valueOf(0xffffffffL),
        this.vf.createFromBit(
            new byte[] {(byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff}, 0, 4));
    assertEquals(
        Float.valueOf(0xffffffffffL),
        this.vf.createFromBit(
            new byte[] {(byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff}, 0, 5));
    assertEquals(
        Float.valueOf(0xffffffffffffL),
        this.vf.createFromBit(
            new byte[] {
            ...
            6));
    assertEquals(
        Float.valueOf(0xffffffffffffffL),
        this.vf.createFromBit(
            new byte[] {
              (byte) 0xff,
              (byte) 0xff,
            ...
            7));
    assertEquals(
        Float.valueOf("1.8446744073709552E19"),
        this.vf.createFromBit(
            new byte[] {
              (byte) 0xff,
              (byte) 0xff,
