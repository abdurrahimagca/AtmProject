...
public class IntegerValueFactoryTest extends CommonAsserts {
  ...
  public void testCreateFromTime() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIME to java.lang.Integer",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromTimestamp() {
    assertThrows(
        ...
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            IntegerValueFactoryTest.this.vf.createFromTimestamp(
  ...
  public void testCreateFromLong() {
    ...
    assertThrows(
        ...
        "Value '2147483648' is outside of valid range for type java.lang.Integer",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
    ...
    assertThrows(
        NumberOutOfRange.class,
        "Value '-2147483649' is outside of valid range for type java.lang.Integer",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromBigInteger() {
    ...
    assertEquals(
        Integer.valueOf(-1), this.vf.createFromBigInteger(Constants.BIG_INTEGER_NEGATIVE_ONE));
    assertEquals(
    ...
    assertThrows(
        ...
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            IntegerValueFactoryTest.this.vf.createFromBigInteger(
  ...
  public void testCreateFromBigDecimal() {
    ...
    assertEquals(
        Integer.valueOf(-1), this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_NEGATIVE_ONE));
    assertEquals(
        Integer.valueOf(Integer.MIN_VALUE),
    ...
    assertThrows(
        ...
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            IntegerValueFactoryTest.this.vf.createFromBigDecimal(
