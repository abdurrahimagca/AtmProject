...
public class LocalDateTimeValueFactoryTest extends CommonAsserts {
  ...
  public void testCreateFromTimestamp() {
    assertThrows(
        ...
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            LocalDateTimeValueFactoryTest.this.vf.createFromTimestamp(
  ...
  public void testCreateFromBigInteger() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from BIGINT to java.time.LocalDateTime",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromDouble() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from DOUBLE to java.time.LocalDateTime",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromBigDecimal() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from DECIMAL to java.time.LocalDateTime",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromBytes() {
    ...
    assertThrows(
        DataConversionException.class,
        "Cannot convert string '' to java.time.LocalDateTime value",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            LocalDateTimeValueFactoryTest.this.vf.createFromBytes("".getBytes(), 0, 0, f);
    ...
    assertEquals(
        LocalDateTime.of(2018, 1, 2, 3, 4, 5, 600000000),
        this.vf.createFromBytes("2018-01-02 03:04:05.6".getBytes(), 0, 21, f));
    assertEquals(
        LocalDateTime.of(2018, 1, 2, 0, 0, 0, 0),
        this.vf.createFromBytes("2018-01-02".getBytes(), 0, 10, f));
    assertEquals(
        LocalDateTime.of(1970, 1, 1, 3, 4, 5, 600000000),
        this.vf.createFromBytes("03:04:05.6".getBytes(), 0, 10, f));

    assertThrows(
        DataConversionException.class,
        "Cannot convert string '1' to java.time.LocalDateTime value",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
    ...
    assertThrows(
        DataConversionException.class,
        "Cannot convert string '-1.0' to java.time.LocalDateTime value",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
    ...
    assertThrows(
        DataConversionException.class,
        "Cannot convert string 'just a string' to java.time.LocalDateTime value",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            LocalDateTimeValueFactoryTest.this.vf.createFromBytes(
  ...
  public void testCreateFromBit() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from BIT to java.time.LocalDateTime",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
