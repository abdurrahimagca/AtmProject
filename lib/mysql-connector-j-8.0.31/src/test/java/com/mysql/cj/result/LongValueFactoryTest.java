...
public class LongValueFactoryTest extends CommonAsserts {
  ...
  public void testCreateFromTime() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIME to java.lang.Long",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromTimestamp() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIMESTAMP to java.lang.Long",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            LongValueFactoryTest.this.vf.createFromTimestamp(
  ...
  public void testCreateFromBigInteger() {
    ...
    assertEquals(
        ...
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_MAX_LONG_VALUE));
    assertEquals(
        Long.valueOf(-1), this.vf.createFromBigInteger(Constants.BIG_INTEGER_NEGATIVE_ONE));
    assertEquals(
        Long.valueOf(Long.MIN_VALUE),
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_MIN_LONG_VALUE));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Long",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            LongValueFactoryTest.this.vf.createFromBigInteger(
                Constants.BIG_INTEGER_MAX_LONG_VALUE.add(BigInteger.ONE));
            return null;
          }
        });
    assertThrows(
        ...
        new Callable<Void>() {
          ...
          public Void call() throws Exception {
            LongValueFactoryTest.this.vf.createFromBigInteger(
                Constants.BIG_INTEGER_MIN_LONG_VALUE.subtract(BigInteger.ONE));
            return null;
          }
        });
  }
  ...
  public void testCreateFromDouble() {
    ...
    assertThrows(
        ...
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            LongValueFactoryTest.this.vf.createFromDouble(
                Constants.BIG_INTEGER_MAX_LONG_VALUE
                    .add(Constants.BIG_INTEGER_MAX_INTEGER_VALUE)
                    .doubleValue());
            return null;
          }
        });
    assertThrows(
        ...
        new Callable<Void>() {
          ...
          public Void call() throws Exception {
            LongValueFactoryTest.this.vf.createFromDouble(
                Constants.BIG_INTEGER_MIN_LONG_VALUE
                    .add(Constants.BIG_INTEGER_MIN_INTEGER_VALUE)
                    .doubleValue());
            return null;
          }
        });
  ...
  public void testCreateFromBigDecimal() {
    ...
    assertEquals(
        Long.valueOf(Long.MAX_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MAX_LONG_VALUE));
    assertEquals(
        Long.valueOf(-1), this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_NEGATIVE_ONE));
    assertEquals(
        Long.valueOf(Long.MIN_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MIN_LONG_VALUE));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Long",
        new Callable<Void>() {
  ...
  public void testCreateFromBytes() {
    ...
    assertEquals(
        Long.valueOf(0),
        this.vf.createFromBytes("1.2E-2".getBytes(), 0, 6, f)); // TODO check truncation ?
  ...
  public void testCreateFromBit() {
    ...
    assertEquals(
        ...
        this.vf.createFromBit(
            ...
            6));
    assertEquals(
        Long.valueOf(0xffffffffffffffL),
        this.vf.createFromBit(
            new byte[] {
              (byte) 0xff,
              (byte) 0xff,
            ...
            7));
    assertEquals(
        Long.valueOf(0xffffffffffffffffL),
        this.vf.createFromBit(
            new byte[] {
              (byte) 0xff,
              (byte) 0xff,
