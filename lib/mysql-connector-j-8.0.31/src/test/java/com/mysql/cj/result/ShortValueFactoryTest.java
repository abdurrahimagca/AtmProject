...
public class ShortValueFactoryTest extends CommonAsserts {
  ...
  public void testCreateFromDate() {
    assertThrows(
        ...
        "Unsupported conversion from DATE to java.lang.Short",
        new Callable<Void>() {
          @Override
  ...
  public void testCreateFromTime() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIME to java.lang.Short",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromTimestamp() {
    assertThrows(
        DataConversionException.class,
        "Unsupported conversion from TIMESTAMP to java.lang.Short",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            ShortValueFactoryTest.this.vf.createFromTimestamp(
  ...
  public void testCreateFromLong() {
    ...
    assertThrows(
        ...
        "Value '32768' is outside of valid range for type java.lang.Short",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
    ...
    assertThrows(
        NumberOutOfRange.class,
        "Value '-32769' is outside of valid range for type java.lang.Short",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
  ...
  public void testCreateFromBigInteger() {
    ...
    assertEquals(
        ...
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_MAX_SHORT_VALUE));
    assertEquals(
        Short.valueOf((short) -1),
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_NEGATIVE_ONE));
    assertEquals(
        Short.valueOf(Short.MIN_VALUE),
        this.vf.createFromBigInteger(Constants.BIG_INTEGER_MIN_SHORT_VALUE));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Short",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            ShortValueFactoryTest.this.vf.createFromBigInteger(
  ...
  public void testCreateFromBigDecimal() {
    ...
    assertEquals(
        Short.valueOf(Short.MAX_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MAX_SHORT_VALUE));
    assertEquals(
        Short.valueOf((short) -1),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_NEGATIVE_ONE));
    assertEquals(
        Short.valueOf(Short.MIN_VALUE),
        this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MIN_SHORT_VALUE));
    assertThrows(
        NumberOutOfRange.class,
        "Value .+ is outside of valid range for type java.lang.Short",
        new Callable<Void>() {
          @Override
          public Void call() throws Exception {
            ShortValueFactoryTest.this.vf.createFromBigDecimal(
                BigDecimal.valueOf(Short.MAX_VALUE + 1));
            return null;
          }
        });
    assertThrows(
  ...
  public void testCreateFromBit() {
    ...
    assertEquals(
        ...
        this.vf.createFromBit(new byte[] {(byte) 0x7f, (byte) 0xff}, 0, 2));
    assertEquals(
        Short.valueOf((short) 0xffffL),
