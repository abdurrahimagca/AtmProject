...
public class StringValueFactoryTest extends CommonAsserts {
  ...
  public void testCreateFromTime() {
    assertEquals(
        "12:20:02.0420", this.vf.createFromTime(new InternalTime(12, 20, 02, 42000000, 4)));
    ...
    assertEquals(
        "44:05:06.000300",
        this.vf.createFromTime(new InternalTime(44, 5, 6, 300000, 6)).toString());
  }

  @Test
  public void testCreateFromTimestamp() {
    assertEquals(
        "2015-05-01 12:20:02.0420",
        this.vf.createFromTimestamp(new InternalTimestamp(2015, 05, 01, 12, 20, 02, 42000000, 4)));
    assertEquals(
        "2015-05-01 12:20:02.000004",
        this.vf.createFromTimestamp(new InternalTimestamp(2015, 05, 01, 12, 20, 02, 4000, 6)));
    assertEquals(
        "2018-01-01 01:01:01.000001",
        this.vf.createFromTimestamp(new InternalTimestamp(2018, 1, 1, 1, 1, 1, 1000, 6)));
    assertEquals(
        "0000-00-00 01:01:01.000001",
        this.vf.createFromTimestamp(new InternalTimestamp(0, 0, 0, 1, 1, 1, 1000, 6)));
    assertEquals(
        "0000-00-01 01:01:01.000001",
        this.vf.createFromTimestamp(new InternalTimestamp(0, 0, 1, 1, 1, 1, 1000, 6)));
    assertEquals(
        "0000-01-00 01:01:01.000001",
        this.vf.createFromTimestamp(new InternalTimestamp(0, 1, 0, 1, 1, 1, 1000, 6)));
    assertEquals(
        "0000-01-01 01:01:01.000001",
        this.vf.createFromTimestamp(new InternalTimestamp(0, 1, 1, 1, 1, 1, 1000, 6)));
    assertEquals(
        "0001-00-00 01:01:01.000001",
        this.vf.createFromTimestamp(new InternalTimestamp(1, 0, 0, 1, 1, 1, 1000, 6)));
    assertEquals(
        "0001-00-01 01:01:01.000001",
        this.vf.createFromTimestamp(new InternalTimestamp(1, 0, 1, 1, 1, 1, 1000, 6)));
    assertEquals(
        "0001-01-00 01:01:01.000100",
        this.vf.createFromTimestamp(new InternalTimestamp(1, 1, 0, 1, 1, 1, 100000, 6)));
  }
  ...
  public void testCreateFromBigInteger() {
    ...
    assertEquals(
        "2147483647", this.vf.createFromBigInteger(Constants.BIG_INTEGER_MAX_INTEGER_VALUE));
    assertEquals("-1", this.vf.createFromBigInteger(Constants.BIG_INTEGER_NEGATIVE_ONE));
    assertEquals(
        "-2147483648", this.vf.createFromBigInteger(Constants.BIG_INTEGER_MIN_INTEGER_VALUE));
  }
  ...
  public void testCreateFromBigDecimal() {
    ...
    assertEquals(
        "2147483647", this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MAX_INTEGER_VALUE));
    assertEquals("-1", this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_NEGATIVE_ONE));
    assertEquals(
        "-2147483648", this.vf.createFromBigDecimal(Constants.BIG_DECIMAL_MIN_INTEGER_VALUE));
  }
  ...
  public void testCreateFromBytes() {
    ...
    assertEquals(
        "2006-07-01 12:13:14", this.vf.createFromBytes("2006-07-01 12:13:14".getBytes(), 0, 19, f));
  ...
  public void testCreateFromBit() {
    ...
    assertEquals(
        Long.valueOf(0xffffffffL).toString(),
        this.vf.createFromBit(
            new byte[] {(byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff}, 0, 4));
    assertEquals(
        Long.valueOf(0xffffffffffL).toString(),
        this.vf.createFromBit(
            new byte[] {(byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff}, 0, 5));
    assertEquals(
        Long.valueOf(0xffffffffffffL).toString(),
        this.vf.createFromBit(
            new byte[] {
            ...
            6));
    assertEquals(
        Long.valueOf(0xffffffffffffffL).toString(),
        this.vf.createFromBit(
            new byte[] {
              (byte) 0xff,
              (byte) 0xff,
            ...
            7));
    assertEquals(
        Long.valueOf(0xffffffffffffffffL).toString(),
        this.vf.createFromBit(
            new byte[] {
              (byte) 0xff,
              (byte) 0xff,
