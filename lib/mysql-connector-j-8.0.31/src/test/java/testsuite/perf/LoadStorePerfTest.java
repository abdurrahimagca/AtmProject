...
public class LoadStorePerfTest extends BasePerfTest {
  ...
  public void setUp() throws Exception {
    String newTableType =
        System.getProperty(PropertyDefinitions.SYSP_testsuite_loadstoreperf_tabletype);

    this.largeResults =
        "TRUE"
            .equalsIgnoreCase(
                System.getProperty(PropertyDefinitions.SYSP_testsuite_loadstoreperf_useBigResults));
    ...
    //
    String query =
        "CREATE TABLE perfLoadStore (priKey INT NOT NULL, fk1 INT NOT NULL, fk2 INT NOT NULL,"
            + " dtField "
            + dateTimeType
            + ", charField1 CHAR(32), charField2 CHAR(32), charField3 CHAR(32), charField4"
            + " CHAR(32), intField1 INT, intField2 INT, intField3 INT, intField4 INT, doubleField1"
            + " DECIMAL, doubleField2 DOUBLE, doubleField3 DOUBLE, doubleField4 DOUBLE,PRIMARY KEY"
            + " (priKey))";
    ...
    for (int i = 0; i < numLoops; i++) {
      this.stmt.executeUpdate(
          "INSERT INTO perfLoadStore (priKey, fk1, fk2, dtField, charField1, charField2,"
              + " charField3, charField4, intField1, intField2, intField3, intField4, doubleField1,"
              + " doubleField2, doubleField3, doubleField4) VALUES ("
              + i
              + "," // priKey
              + "2," // fk1
              + "3," // fk2
  ...
  protected void doOneIteration() throws Exception {
    PreparedStatement pStmtStore =
        this.conn.prepareStatement(
            "UPDATE perfLoadStore SET priKey = ?, fk1 = ?, fk2 = ?, dtField = ?, charField1 = ?,"
                + " charField2 = ?, charField3 = ?, charField4 = ?, intField1 = ?, intField2 = ?,"
                + " intField3 = ?, intField4 = ?, doubleField1 = ?,doubleField2 = ?, doubleField3 ="
                + " ?, doubleField4 = ? WHERE priKey=?");
    PreparedStatement pStmtCheck =
        this.conn.prepareStatement("SELECT COUNT(*) FROM perfLoadStore WHERE priKey=?");
    PreparedStatement pStmtLoad = null;

    if (this.largeResults) {
      pStmtLoad =
          this.conn.prepareStatement(
              "SELECT priKey, fk1, fk2, dtField, charField1, charField2, charField3, charField4,"
                  + " intField1, intField2, intField3, intField4, doubleField1, doubleField2,"
      ...
      pStmtLoad =
          this.conn.prepareStatement(
              "SELECT priKey, fk1, fk2, dtField, charField1, charField2, charField3, charField4,"
                  + " intField1, intField2, intField3, intField4, doubleField1, doubleField2,"
                  + " doubleField3, doubleField4 FROM perfLoadStore WHERE priKey=?");
    }
