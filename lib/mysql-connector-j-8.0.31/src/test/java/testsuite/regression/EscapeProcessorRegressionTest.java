...
public class EscapeProcessorRegressionTest extends BaseTestCase {
  ...
  public void testBug11498() throws Exception {
    assertEquals(
        "replace into t1 (id, f1, f4) VALUES(1,\"\",\"tko { zna gdje se sakrio\"),(2,\"a\",\"sedmi"
            + " { kontinentio\"),(3,\"a\",\"a } cigov si ti?\")",
        this.conn.nativeSQL(
            "replace into t1 (id, f1, f4) VALUES(1,\"\",\"tko { zna gdje se"
  ...
  public void testBug60598() throws Exception {
    ...
    ZonedDateTime zdt =
        LocalDateTime.of(2001, 2, 3, 4, 5, 6, 7000000)
    ...
    String expected =
        "SELECT '"
            + zdt.format(TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET)
            + "' , '"
            + zdt.format(
                withFract
    ...
    String input =
        "SELECT {ts '2001-02-03 04:05:06' } , {ts '2001-02-03 04:05:06.007' } , {t '11:22:33.444'"
            + " }";
