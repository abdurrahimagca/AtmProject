...
public class StringRegressionTest extends BaseTestCase {
  ...
  public void testBug11629() throws Exception {
    ...
    try {
      ...
      assertTrue(
          withExclaims.length() == 0, "Unexpected: '" + withExclaims + "'"); // to catch any other
      bOut.close();
  ...
  public void testBug11614() throws Exception {
    ...
    createTable(
        "testBug11614",
        "(`id` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT, `text` TEXT NOT NULL, PRIMARY KEY(`id`))"
    ...
    try {
      ...
      utf8Conn
          .createStatement()
          .executeUpdate("INSERT INTO testBug11614 (`id`,`text`) values (1,'')");
      this.rs =
          utf8Conn.createStatement().executeQuery("SELECT `text` FROM testBug11614 WHERE id=1");
      ...
      String fromDatabase =
          getSingleIndexedValueWithQuery(utf8Conn, 1, "SELECT `text` FROM testBug11614").toString();
   ...
   *
   * <p>UPD: Method StringUtils.indexOfIgnoreCaseRespectQuotes() was replaced by
