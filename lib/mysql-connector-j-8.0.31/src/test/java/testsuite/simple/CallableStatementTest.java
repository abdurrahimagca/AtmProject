...
public class CallableStatementTest extends BaseTestCase {
  ...
  public void testInOutParams() throws Exception {
    ...
    createProcedure(
        "testInOutParam2",
        "(IN p1 VARCHAR(255), INOUT p2 VARCHAR(20))\nbegin\nSET p2=CONCAT(p1, p2);\nend\n");
  ...
  public void testOutParams() throws Exception {
    ...
    assertTrue(
        ...
        "Named and indexed parameter are not the same");
  ...
  public void testParameterParser() throws Exception {
    ...
    try {
      ...
      createProcedure(
          "bar", "(x char(16), y int, z DECIMAL(10)) insert into test.t1 values (x, y);");
