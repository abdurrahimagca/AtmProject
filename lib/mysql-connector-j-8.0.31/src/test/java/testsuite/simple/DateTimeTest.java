...
public class DateTimeTest extends BaseTestCase {
  ...
  TimeZone[] senderTimeZones =
      new TimeZone[] {tz_minus_10_00, tz_plus_05_00}; // , tz_UTC, tz_plus_01_00
  ...
  private static LocalDateTime ldt_20200101_120000_123456 =
      LocalDateTime.of(2020, 1, 1, 12, 00, 00, 123456000);

  private static LocalDateTime ldt_19700101_0000 = LocalDateTime.of(1970, 1, 1, 0, 0);
  private static LocalDateTime ldt_19700101_120000_123456 =
      LocalDateTime.of(1970, 1, 1, 12, 0, 0, 123456000);
  private static LocalDateTime ldt_19700101_020000_123000 =
      LocalDateTime.of(1970, 1, 1, 2, 0, 0, 123000000);
  private static LocalDateTime ldt_19700101_020000_123456 =
      LocalDateTime.of(1970, 1, 1, 2, 0, 0, 123456000);
  ...
  private static String incorrectDateErr =
      "Data truncation: Incorrect date value: 'X' for column 'd' at row 1";
  private static String incorrectTimeErr =
      "Data truncation: Incorrect time value: 'X' for column 'd' at row 1";
  private static String incorrectDatetimeErr =
      "Data truncation: Incorrect datetime value: 'X' for column 'd' at row 1";

  private static DateTimeFormatter YEAR_FORMATTER = DateTimeFormatter.ofPattern("yyyy");
  private static DateTimeFormatter TIME_FORMATTER_WITH_MILLIS_NO_OFFCET =
      DateTimeFormatter.ofPattern("HH:mm:ss.SSS");
  private static DateTimeFormatter TIME_FORMATTER_WITH_MICROS_NO_OFFCET =
      DateTimeFormatter.ofPattern("HH:mm:ss.SSSSSS");
  private static DateTimeFormatter DATETIME_FORMATTER_WITH_MICROS_NO_OFFCET =
        ...
        for (boolean useSSPS : new boolean[] {false, true}) {
          for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
            for (boolean sendTimeFract : new boolean[] {false, true}) {
              ...
              props.setProperty(
                  PropertyKey.forceConnectionTimeZoneToSession.getKeyName(),
              ...
              props.setProperty(
                  PropertyKey.sendFractionalSecondsForTime.getKeyName(), "" + sendTimeFract);
              props.setProperty(
                ...
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    props.setProperty(
                        ...
                        "" + forceConnectionTimeZoneToSession);
                    props.setProperty(
                        PropertyKey.preserveInstants.getKeyName(), "" + preserveInstants);
                    props.setProperty(PropertyKey.useServerPrepStmts.getKeyName(), "" + useSSPS);
                    props.setProperty(
                        PropertyKey.sendFractionalSecondsForTime.getKeyName(), "" + sendTimeFract);
                    props.setProperty(
                    ...
                    TimeZone connTz =
                        connectionTZ == null || "LOCAL".equals(connectionTZ)
                            ? senderTz
                            : ("SERVER".equals(connectionTZ)
                                ? serverTz
                                : TimeZone.getTimeZone(connectionTZ));
                    TimeZone sessionTz = forceConnectionTimeZoneToSession ? connTz : serverTz;

                    ZonedDateTime zdt_20200101_at_senderTz =
                        ld_20200101.atStartOfDay().atZone(senderTz.toZoneId());
                    ZonedDateTime zdt_20200101_at_calendarTz =
                        zdt_20200101_at_senderTz.withZoneSameInstant(tz_plus_02_00.toZoneId());
                    ZonedDateTime zdt_20200101_senderTz_to_connTz =
                        preserveInstants && !(connectionTZ == null || "LOCAL".equals(connectionTZ))
                            ? zdt_20200101_at_senderTz.withZoneSameInstant(connTz.toZoneId())
                            : zdt_20200101_at_senderTz;

                    final java.sql.Date sqlDate_at_senderTz =
                        new java.sql.Date(zdt_20200101_at_senderTz.toInstant().toEpochMilli());
                    ...
                    if (useSSPS && withFract) {
                      ...
                      setObjectFromTz(
                          props, tYear, sqlDate_at_senderTz, MysqlType.DATE, senderTz, expYear);
                      setObjectFromTz(
                          props, tYear, sqlDate_at_senderTz, MysqlType.DATETIME, senderTz, expYear);
                      setObjectFromTz(
                          props,
                          tYear,
                          sqlDate_at_senderTz,
                      ...
                      assertThrows(
                          ...
                          dataTruncatedErr);
                      assertThrows(
                          props, tYear, sqlDate_at_senderTz, null, senderTz, dataTruncatedErr);
                      assertThrows(
                          props,
                          tYear,
                          sqlDate_at_senderTz,
                    ...
                    assertThrows(
                        ...
                        dataTruncatedErr);
                    setObjectFromTz(
                        props, tYear, sqlDate_at_senderTz, MysqlType.YEAR, senderTz, expYear);
                    ...
                    setObjectFromTz(
                        props, tDate, sqlDate_at_senderTz, MysqlType.DATE, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, sqlDate_at_senderTz, MysqlType.CHAR, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, sqlDate_at_senderTz, MysqlType.VARCHAR, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, sqlDate_at_senderTz, MysqlType.TINYTEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, sqlDate_at_senderTz, MysqlType.TEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, sqlDate_at_senderTz, MysqlType.MEDIUMTEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, sqlDate_at_senderTz, MysqlType.LONGTEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, sqlDate_at_senderTz, MysqlType.DATETIME, senderTz, expDate);
                    setObjectFromTz(
                        props,
                        tDate,
                        sqlDate_at_senderTz,
                    ...
                    if (useSSPS) {
                      ...
                      setObjectFromTz(
                          props, tTime, sqlDate_at_senderTz, MysqlType.DATE, senderTz, s_000000);
                    } else {
                      assertThrows(
                          props,
                          tTime,
                    ...
                    assertThrows(
                        ...
                        incorrectTimeErr.replace("X", expDate));
                    setObjectFromTz(
                        props, tTime, sqlDate_at_senderTz, MysqlType.DATETIME, senderTz, s_000000);
                    setObjectFromTz(
                        props,
                        tTime,
                        sqlDate_at_senderTz,
                    ...
                    setObjectFromTz(
                        ...
                        MysqlType.YEAR,
                        senderTz,
                        expYear); // TIME takes numbers as a short notation, thus it works here
                    setObjectFromTz(
                        props,
                        tTime,
                        sqlDate_at_senderTz,
                        ...
                        senderTz,
                        "00:"
                            + expYear.substring(0, 2)
                            + ":"
                            + expYear.substring(
                                2)); // TIME takes numbers as a short notation, thus it works here
                    ...
                    String expDatetimeCal =
                        zdt_20200101_at_calendarTz
                            .toLocalDate()
                            .atStartOfDay()
                            .format(TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET);
                    String expDatetimeTs =
                        zdt_20200101_senderTz_to_connTz.format(
                    ...
                    setObjectFromTz(
                        ...
                        UseMethod.setDate);
                    setObjectFromTz(
                        props, tDatetime, sqlDate_at_senderTz, null, senderTz, expDatetime);
                    setObjectFromTz(
                        props,
                        tDatetime,
                        sqlDate_at_senderTz,
                    ...
                    ZonedDateTime zdt_default_on_wire =
                        zdt_20200101_at_senderTz
                            .toLocalDate()
                            .atStartOfDay()
                            .atZone(sessionTz.toZoneId());
                    ZonedDateTime zdt_calendar_on_wire =
                        zdt_20200101_at_calendarTz
                            .toLocalDate()
                            .atStartOfDay()
                            .atZone(sessionTz.toZoneId());
                    ZonedDateTime zdt_ts_on_wire =
                        zdt_20200101_senderTz_to_connTz.withZoneSameLocal(sessionTz.toZoneId());
                    ...
                    String expTimestamp =
                        zdt_default_on_wire
                            ...
                            .toLocalDateTime()
                            .format(TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET);
                    String expTimestampWithCal =
                        zdt_calendar_on_wire
                            .withZoneSameInstant(tz_UTC.toZoneId())
                            .toLocalDateTime()
                            .format(TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET);
                    String expTimestampTs =
                        zdt_ts_on_wire
                            .withZoneSameInstant(tz_UTC.toZoneId())
                            .toLocalDateTime()
                            .format(TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET);
                    ...
                    String expUnixTsWithCal =
                        "" + zdt_calendar_on_wire.toInstant().getEpochSecond();
                    ...
                    setObjectFromTz(
                        props, tVarchar, sqlDate_at_senderTz, MysqlType.DATE, senderTz, expDate);
                    setObjectFromTz(
                        props, tVarchar, sqlDate_at_senderTz, MysqlType.CHAR, senderTz, expDate);
                    setObjectFromTz(
                        props, tVarchar, sqlDate_at_senderTz, MysqlType.VARCHAR, senderTz, expDate);
                    setObjectFromTz(
                        props,
                        tVarchar,
                        sqlDate_at_senderTz,
                        ...
                        expDate);
                    setObjectFromTz(
                        props, tVarchar, sqlDate_at_senderTz, MysqlType.TEXT, senderTz, expDate);
                    setObjectFromTz(
                        props,
                        tVarchar,
                        sqlDate_at_senderTz,
                    ...
                    setObjectFromTz(
                        ...
                        expDatetimeTs);
                    setObjectFromTz(
                        props, tVarchar, sqlDate_at_senderTz, MysqlType.YEAR, senderTz, expYear);
                  }
                }
              }
            }
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    ZonedDateTime zdt_19700101_120000_123_at_senderTz =
                        (withFract
                                ? ldt_19700101_120000_123456
                                : ldt_19700101_120000_123456.withNano(0))
                            .atZone(senderTz.toZoneId());
                    ZonedDateTime zdt_19700101_120000_123_at_calendarTz =
                        zdt_19700101_120000_123_at_senderTz.withZoneSameInstant(
                            tz_plus_02_00.toZoneId());

                    ZonedDateTime zdt_19700101_on_wire =
                        (sendFractionalSeconds && sendTimeFract
                                ? zdt_19700101_120000_123_at_senderTz
                                : zdt_19700101_120000_123_at_senderTz.withNano(0))
                            .withZoneSameLocal(sessionTz.toZoneId());
                    ZonedDateTime zdt_default_on_wire =
                        LocalDate.now(sessionTz.toZoneId())
                            .atTime(zdt_19700101_120000_123_at_senderTz.toLocalTime())
                            .atZone(sessionTz.toZoneId());
                    ZonedDateTime zdt_calendar_on_wire =
                        LocalDate.now(sessionTz.toZoneId())
                            .atTime(zdt_19700101_120000_123_at_calendarTz.toLocalTime())
                            .atZone(sessionTz.toZoneId());

                    java.sql.Time sqlTime_120000 =
                        new java.sql.Time(
                            zdt_19700101_120000_123_at_senderTz.toInstant().getEpochSecond()
                                * 1000);
                    java.sql.Time sqlTime_120000_123 =
                        new java.sql.Time(
                            zdt_19700101_120000_123_at_senderTz.toInstant().toEpochMilli());

                    String expYear =
                        ""
                            + LocalDateTime.now(sessionTz.toZoneId())
                                .toLocalDate()
                                .getYear(); // TODO server applies the time_zone, bug?
                    String expDate =
                        ""
                            + LocalDateTime.now(sessionTz.toZoneId())
                                .toLocalDate(); // TODO server applies the time_zone, bug?

                    String expTimeNoMs =
                        zdt_19700101_120000_123_at_senderTz
                            .toLocalTime()
                            .format(TimeUtil.TIME_FORMATTER_NO_FRACT_NO_OFFSET);
                    String expTimeSendTimeFract =
                        sendFractionalSeconds && sendTimeFract
                            ? zdt_19700101_120000_123_at_senderTz
                                .toLocalTime()
                                .format(
                    ...
                    String expDate8_0_28 =
                        zdt_19700101_120000_123_at_senderTz.format(
                            DateTimeFormatter.ofPattern("20HH-mm-ss"));

                    String expTimeNoMsCal =
                        zdt_19700101_120000_123_at_calendarTz
                            .toLocalTime()
                            .format(TimeUtil.TIME_FORMATTER_NO_FRACT_NO_OFFSET);
                    String expTimeCal =
                        sendFractionalSeconds && sendTimeFract
                    ...
                    if (useSSPS && withFract) {
                      ...
                      setObjectFromTz(
                          props, tYear, sqlTime_120000_123, MysqlType.DATE, senderTz, s_19700101);
                      setObjectFromTz(
                          props, tYear, sqlTime_120000_123, MysqlType.TIME, senderTz, expYear);
                      setObjectFromTz(
                          props,
                          tYear,
                          sqlTime_120000_123,
                      ...
                      assertThrows(
                          ...
                          dataTruncatedErr);
                      assertThrows(
                          props, tYear, sqlTime_120000_123, null, senderTz, dataTruncatedErr);
                      assertThrows(
                          props,
                          tYear,
                          sqlTime_120000_123,
                    ...
                    assertThrows(
                        ...
                        dataTruncatedErr);
                    setObjectFromTz(
                        props, tYear, sqlTime_120000_123, MysqlType.YEAR, senderTz, s_1970);

                    /* Into DATE field */

                    String expDateErr =
                        incorrectDateErr.replace(
                            "X",
                            useSSPS
                                    && !(sendTimeFract && sendFractionalSeconds)
                                    && versionMeetsMinimum(8, 0, 28)
                                ? expDate8_0_28
                    ...
                    if (useSSPS) {
                      if (withFract) {
                        ...
                        setObjectFromTz(
                            props, tDate, sqlTime_120000_123, MysqlType.TIME, senderTz, expDate);
                      } else {
                        assertThrows(
                            props,
                            tDate,
                        ...
                        assertThrows(
                            ...
                            dataTruncatedErr);
                        assertThrows(
                            props, tDate, sqlTime_120000_123, null, senderTz, dataTruncatedErr);
                        assertThrows(
                            props,
                            tDate,
                            sqlTime_120000_123,
                      ...
                      assertThrows(
                          props, tDate, sqlTime_120000_123, MysqlType.TIME, senderTz, expDateErr);
                    }
                    assertThrows(
                        props, tDate, sqlTime_120000_123, MysqlType.CHAR, senderTz, expDateErr);
                    assertThrows(
                        props, tDate, sqlTime_120000_123, MysqlType.VARCHAR, senderTz, expDateErr);
                    assertThrows(
                        props, tDate, sqlTime_120000_123, MysqlType.TINYTEXT, senderTz, expDateErr);
                    assertThrows(
                        props, tDate, sqlTime_120000_123, MysqlType.TEXT, senderTz, expDateErr);
                    assertThrows(
                        props,
                        tDate,
                        sqlTime_120000_123,
                        ...
                        expDateErr);
                    assertThrows(
                        props, tDate, sqlTime_120000_123, MysqlType.LONGTEXT, senderTz, expDateErr);

                    setObjectFromTz(
                        props, tDate, sqlTime_120000_123, MysqlType.DATE, senderTz, s_19700101);
                    setObjectFromTz(
                        props, tDate, sqlTime_120000_123, MysqlType.DATETIME, senderTz, s_19700101);
                    setObjectFromTz(
                        props,
                        tDate,
                        sqlTime_120000_123,
                    ...
                    assertThrows(
                        ...
                        MysqlType.YEAR,
                        senderTz,
                        incorrectDateErr.replace("X", s_1970));
                    ...
                    setObjectFromTz(
                        ...
                        UseMethod.setTime);
                    setObjectFromTz(
                        props, tTime, sqlTime_120000_123, null, senderTz, expTimeSendTimeFract);
                    setObjectFromTz(
                        props, tTime, sqlTime_120000, MysqlType.CHAR, senderTz, s_120000);
                    setObjectFromTz(
                        props,
                        tTime,
                        sqlTime_120000_123,
                    ...
                    setObjectFromTz(
                        ...
                        expTimeSendTimeFract);
                    setObjectFromTz(
                        props, tTime, sqlTime_120000, MysqlType.TIME, senderTz, s_120000);
                    setObjectFromTz(
                        props,
                        tTime,
                        sqlTime_120000_123,
                    ...
                    if (useSSPS) {
                      setObjectFromTz(
                          props, tTime, sqlTime_120000_123, MysqlType.DATE, senderTz, s_000000);
                    } else {
                      assertThrows(
                          props,
                          tTime,
                          ...
                          MysqlType.DATE,
                          senderTz,
                          incorrectTimeErr.replace("X", s_19700101));
                    }
                    setObjectFromTz(
                        props,
                        tTime,
                    ...
                    if (useSSPS) {
                      if (withFract) {
                        ...
                        setObjectFromTz(
                            ...
                            UseMethod.setTime);
                        setObjectFromTz(
                            props, tDatetime, sqlTime_120000_123, null, senderTz, expDatetime);
                        setObjectFromTz(
                            props,
                            tDatetime,
                            sqlTime_120000_123,
                        ...
                        assertThrows(
                            ...
                            dataTruncatedErr);
                        assertThrows(
                            props, tDatetime, sqlTime_120000_123, null, senderTz, dataTruncatedErr);
                        assertThrows(
                            props,
                            tDatetime,
                            sqlTime_120000_123,
                      ...
                      assertThrows(
                          ...
                          expDatetimeErr);
                      assertThrows(
                          props, tDatetime, sqlTime_120000_123, null, senderTz, expDatetimeErr);
                      assertThrows(
                          props,
                          tDatetime,
                          sqlTime_120000_123,
                    ...
                    setObjectFromTz(
                        props, tDatetime, sqlTime_120000_123, MysqlType.DATE, senderTz, s_19700101);
                    setObjectFromTz(
                        props,
                        tDatetime,
                        sqlTime_120000_123,
                    ...
                    LocalDateTime ldt_exp1970Timestamp =
                        zdt_19700101_on_wire
                            .withZoneSameInstant(tz_UTC.toZoneId())
                            .toLocalDateTime();
                    LocalDateTime ldt_expDefTimestamp =
                        zdt_default_on_wire
                            .withZoneSameInstant(tz_UTC.toZoneId())
                            .toLocalDateTime();
                    LocalDateTime ldt_expCalTimestamp =
                        zdt_calendar_on_wire
                            .withZoneSameInstant(tz_UTC.toZoneId())
                            .toLocalDateTime();
                    ZonedDateTime zdt_expDATETimestamp =
                        ldt_19700101_0000
                            .atZone(sessionTz.toZoneId())
                            .withZoneSameInstant(tz_UTC.toZoneId());
                    ...
                    String expDefTimestampNoMs =
                        ldt_expDefTimestamp.format(TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET);
                    String expCalTimestamp = ldt_expCalTimestamp.format(df);
                    String expDATETimestamp =
                        zdt_expDATETimestamp.format(TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET);
                    ...
                    String expDefUnixTs =
                        expDefUnixTsNoMs
                            + (sendFractionalSeconds
                                    && sendTimeFract
                                    && zdt_default_on_wire.getNano() > 0
                                ? "." + TimeUtil.formatNanos(zdt_default_on_wire.getNano(), 3)
                                : "");
                    String expCalUnixTs =
                        zdt_calendar_on_wire.toEpochSecond()
                            + (sendFractionalSeconds
                                    && sendTimeFract
                                    && zdt_calendar_on_wire.getNano() > 0
                                ? "." + TimeUtil.formatNanos(zdt_calendar_on_wire.getNano(), 3)
                                : "");
                    String exp1970UnixTs =
                        zdt_19700101_on_wire.toEpochSecond()
                            + (sendFractionalSeconds
                                    && sendTimeFract
                                    && zdt_19700101_on_wire.getNano() > 0
                    ...
                    if (useSSPS && withFract) {
                      ...
                      assertThrows(
                          props, tTimestamp, sqlTime_120000_123, null, senderTz, expDatetimeErr);
                      assertThrows(
                          props,
                          tTimestamp,
                          sqlTime_120000,
                          null,
                          senderTz,
                          incorrectDatetimeErr.replace("X", s_120000));
                      assertThrows(
                          props,
                          tTimestamp,
                          sqlTime_120000_123,
                    ...
                    String expTimeCal2 =
                        useSSPS
                            ? expTimeNoMsCal
                            : expTimeCal; // TODO milliseconds are ignored by server. Bug ?
                    ...
                    setObjectFromTz(
                        props, tVarchar, sqlTime_120000_123, MysqlType.TIME, senderTz, expTime2);
                    setObjectFromTz(
                        props,
                        tVarchar,
                        sqlTime_120000_123,
                    ...
                    setObjectFromTz(
                        ...
                        expTimeSendTimeFract);
                    setObjectFromTz(
                        props, tVarchar, sqlTime_120000_123, MysqlType.DATE, senderTz, s_19700101);
                    setObjectFromTz(
                        props,
                        tVarchar,
                        sqlTime_120000_123,
                    ...
                    setObjectFromTz(
                        ...
                        s_19700101 + " " + expTime2);
                    setObjectFromTz(
                        props, tVarchar, sqlTime_120000_123, MysqlType.YEAR, senderTz, s_1970);
                  }
                }
              }
            }
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    DateTimeFormatter dateTimeFmt =
                        sendFractionalSeconds
                            ? (withFract
                                ...
                                : TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET)
                            : TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET;
                    DateTimeFormatter timeFmtsendFractionalSeconds =
                        sendFractionalSeconds
                            ? (withFract
                    ...
                    ZonedDateTime zdt_20200101_120000_123456_at_senderTz =
                        (withFract
                                ? ldt_20200101_120000_123456
                                : ldt_20200101_120000_123456.withNano(0))
                            .atZone(senderTz.toZoneId());
                    ZonedDateTime zdt_20200101_120000_123456_at_calendarTz =
                        zdt_20200101_120000_123456_at_senderTz.withZoneSameInstant(
                            tz_plus_02_00.toZoneId());

                    ZonedDateTime zdt_20200101_120000_123456_senderTz_to_connTz =
                        preserveInstants && !(connectionTZ == null || "LOCAL".equals(connectionTZ))
                            ? zdt_20200101_120000_123456_at_senderTz.withZoneSameInstant(
                                connTz.toZoneId())
                    ...
                    ZonedDateTime zdt_20200101_120000_123456_on_wire =
                        zdt_20200101_120000_123456_at_senderTz.withZoneSameLocal(
                            sessionTz.toZoneId());
                    ZonedDateTime zdt_no_date_120000_123456_on_wire =
                        LocalDate.now(sessionTz.toZoneId())
                            .atTime(zdt_20200101_120000_123456_at_senderTz.toLocalTime())
                            .atZone(sessionTz.toZoneId());
                    ZonedDateTime zdt_calendar_on_wire =
                        zdt_20200101_120000_123456_at_calendarTz.withZoneSameLocal(
                            sessionTz.toZoneId());
                    ZonedDateTime zdt_20200101_no_time_on_wire =
                        zdt_20200101_120000_123456_on_wire
                            .withHour(0)
                            .withMinute(0)
                            .withSecond(0)
                            .withNano(0);
                    ...
                    ZonedDateTime zdt_TS_on_wire =
                        zdt_20200101_120000_123456_senderTz_to_connTz.withZoneSameLocal(
                            sessionTz.toZoneId());
                    ...
                    String expDate =
                        zdt_20200101_120000_123456_on_wire.format(TimeUtil.DATE_FORMATTER);
                    String expDateDef =
                        zdt_no_date_120000_123456_on_wire.format(
                            useSSPS
                                ? TimeUtil.DATE_FORMATTER
                                : DateTimeFormatter.ofPattern("20HH-mm-ss"));
                    ...
                    String expTimeNoMs =
                        zdt_20200101_120000_123456_on_wire.format(
                            TimeUtil.TIME_FORMATTER_NO_FRACT_NO_OFFSET);
                    String expTime =
                        zdt_20200101_120000_123456_on_wire.format(timeFmtsendFractionalSeconds);
                    ...
                    String expDatetimeDef =
                        LocalDate.now(sessionTz.toZoneId())
                            .atTime(zdt_20200101_120000_123456_on_wire.toLocalTime())
                            .atZone(sessionTz.toZoneId())
                            .format(
                                useSSPS
                                    ? dateTimeFmt
                                    : DateTimeFormatter.ofPattern("20HH-mm-ss 00:00:00"));
                    String expDatetimeCal = zdt_calendar_on_wire.format(dateTimeFmt);
                    String expDatetimeNoTime =
                        zdt_20200101_120000_123456_on_wire.format(
                    ...
                    String expTimestamp =
                        zdt_20200101_120000_123456_on_wire
                            ...
                            .format(dateTimeFmt);
                    String expTimestampTS =
                        zdt_TS_on_wire.withZoneSameInstant(tz_UTC.toZoneId()).format(dateTimeFmt);
                    String expDefTimestamp =
                        zdt_no_date_120000_123456_on_wire
                            .withZoneSameInstant(tz_UTC.toZoneId())
                            .format(dateTimeFmt);
                    String expCalTimestamp =
                        zdt_calendar_on_wire
                            .withZoneSameInstant(tz_UTC.toZoneId())
                            .format(dateTimeFmt);
                    String expTimestampNoTime =
                        zdt_20200101_no_time_on_wire
                            .withZoneSameInstant(tz_UTC.toZoneId())
                            .format(dateTimeFmt);

                    String expDefUnixTs =
                        zdt_no_date_120000_123456_on_wire.toEpochSecond()
                            + (sendFractionalSeconds
                                    && zdt_no_date_120000_123456_on_wire.getNano() > 0
                                ? "."
                                    + TimeUtil.formatNanos(
                                        zdt_no_date_120000_123456_on_wire.getNano(), 6)
                                : "");
                    String expCalUnixTs =
                        zdt_calendar_on_wire.toEpochSecond()
                            + (sendFractionalSeconds && zdt_calendar_on_wire.getNano() > 0
                                ...
                                : "");
                    String expFullUnixTs =
                        zdt_20200101_120000_123456_on_wire.toEpochSecond()
                            + (sendFractionalSeconds
                                    && zdt_20200101_120000_123456_on_wire.getNano() > 0
                                ? "."
                                    + TimeUtil.formatNanos(
                                        zdt_20200101_120000_123456_on_wire.getNano(), 6)
                                : "");
                    String expFullUnixTsTS =
                        zdt_TS_on_wire.toEpochSecond()
                            + (sendFractionalSeconds && zdt_TS_on_wire.getNano() > 0
                    ...
                    if (useSSPS && withFract) {
                      setObjectFromTz(
                          ...
                          expYearCal,
                          null,
                          UseMethod.setTimestamp,
                          cal_02);
                      setObjectFromTz(
                          props, tYear, ts, null, senderTz, expYear, null, UseMethod.setTimestamp);
                      ...
                      assertThrows(
                          props, tYear, ts, MysqlType.DATETIME, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, ts, MysqlType.TIMESTAMP, senderTz, dataTruncatedErr);
                    }
                    ...
                    assertThrows(
                        props, tYear, ts, MysqlType.MEDIUMTEXT, senderTz, dataTruncatedErr);
                    ...
                    setObjectFromTz(
                        ...
                        cal_02);
                    setObjectFromTz(
                        props, tDate, ts, null, senderTz, expDateTS, null, UseMethod.setTimestamp);
                    ...
                    assertThrows(
                        ...
                        MysqlType.YEAR,
                        senderTz,
                        incorrectDateErr.replace("X", s_2020));
                    ...
                    setObjectFromTz(
                        ...
                        cal_02);
                    setObjectFromTz(
                        props, tTime, ts, null, senderTz, expTimeTS, null, UseMethod.setTimestamp);
                    ...
                    setObjectFromTz(
                        props, tDatetime, ts, MysqlType.DATE, senderTz, expDatetimeNoTime);
                    ...
                    setObjectFromTz(
                        props, tDatetime, ts, MysqlType.TINYTEXT, senderTz, expDatetime);
                    setObjectFromTz(props, tDatetime, ts, MysqlType.TEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, ts, MysqlType.MEDIUMTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, ts, MysqlType.LONGTEXT, senderTz, expDatetime);
                    if (useSSPS) {
                      if (withFract) {
                        setObjectFromTz(
                            props, tDatetime, ts, MysqlType.TIME, senderTz, expDatetimeDef);
                      } else {
                        assertThrows(
                            props, tDatetime, ts, MysqlType.TIME, senderTz, dataTruncatedErr);
                      }
                    } else {
                      assertThrows(
                          props,
                    ...
                    setObjectFromTz(
                        props, tDatetime, ts, MysqlType.DATETIME, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, ts, MysqlType.TIMESTAMP, senderTz, expDatetimeTS);
                    assertThrows(
                        props,
                        tDatetime,
                        ts,
                    ...
                    setObjectFromTz(
                        ...
                        UseMethod.setTimestamp);
                    setObjectFromTz(
                        props, tTimestamp, ts, null, senderTz, expTimestampTS, expFullUnixTsTS);
                    setObjectFromTz(
                        props,
                        tTimestamp,
                        ts,
                    ...
                    String expDatetimeCal2 =
                        useSSPS
                            ? zdt_calendar_on_wire.format(
                                TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET)
                    ...
                    String expTime2 =
                        useSSPS
                            ? expTimeNoMs
                            : expTime; // TODO milliseconds are ignored by server. Bug ?
                    String expDatetimeTS2 =
                        useSSPS
                            ? zdt_TS_on_wire.format(TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET)
                            : expDatetimeTS; // TODO milliseconds are ignored by server. Bug ?
                    ...
                    setObjectFromTz(
                        props, tVarchar, ts, MysqlType.DATETIME, senderTz, expDatetime2);
                    setObjectFromTz(
                        props, tVarchar, ts, MysqlType.TIMESTAMP, senderTz, expDatetimeTS2);
                    ...
                    setObjectFromTz(
                        props, tVarchar, ts, MysqlType.MEDIUMTEXT, senderTz, expDatetime);
  ...
  public void testUtilCalendarSetters() throws Exception {
    ...
    ZonedDateTime zdt_20200101_120000_123456_02_00 =
        ZonedDateTime.of(
            2020, 1, 1, 12, 00, 00, withFract ? 123456000 : 0, tz_plus_02_00.toZoneId());
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    ZonedDateTime zdt_20200101_120000_123456_at_senderTz =
                        zdt_20200101_120000_123456_02_00.withZoneSameInstant(senderTz.toZoneId());
                        ...
                        zdt_no_date_120000_123456_on_wire.format(
                            useSSPS
                                ...
                                : DateTimeFormatter.ofPattern(
                                    zdt_no_date_120000_123456_on_wire.getHour() == 0
                                        ? "00HH-mm-ss"
                                        : "20HH-mm-ss"));
                    String expDateTS = zdt_TS_on_wire.format(TimeUtil.DATE_FORMATTER);
                    ...
                    String expDatetime = zdt_20200101_120000_123456_on_wire.format(dateTimeFmt);
                    String expDatetimeTS = zdt_TS_on_wire.format(dateTimeFmt);
                    ZonedDateTime zdtDatetimeDef =
                        LocalDate.now(sessionTz.toZoneId())
                            .atTime(zdt_20200101_120000_123456_on_wire.toLocalTime())
                            .atZone(sessionTz.toZoneId());
                    String expDatetimeDef =
                        zdtDatetimeDef.format(
                            useSSPS
                                ? dateTimeFmt
                                : DateTimeFormatter.ofPattern(
                                    zdtDatetimeDef.getHour() == 0
                                        ? "00HH-mm-ss 00:00:00"
                                        : "20HH-mm-ss 00:00:00"));
                    String expDatetimeNoTime =
                        zdt_20200101_120000_123456_on_wire.format(
                    ...
                    String expTimestampTS =
                        zdt_TS_on_wire.withZoneSameInstant(tz_UTC.toZoneId()).format(dateTimeFmt);
                    ZonedDateTime zdtDefTimestamp =
                        zdt_no_date_120000_123456_on_wire.withZoneSameInstant(tz_UTC.toZoneId());
                    String expDefTimestamp =
                        zdtDefTimestamp.format(
                            useSSPS
                                ? dateTimeFmt
                                : DateTimeFormatter.ofPattern(
                                    zdtDatetimeDef.getHour() == 0
                    ...
                    String expDefUnixTs =
                        zdt_no_date_120000_123456_on_wire.toEpochSecond()
                            + (sendFractionalSeconds
                                ...
                                ? "."
                                    + TimeUtil.formatNanos(
                                        zdt_no_date_120000_123456_on_wire.getNano(), 3)
                                : "");
                    String expFullUnixTs =
                        zdt_20200101_120000_123456_on_wire.toEpochSecond()
                            + (sendFractionalSeconds
                                ...
                                ? "."
                                    + TimeUtil.formatNanos(
                                        zdt_20200101_120000_123456_on_wire.getNano(), 3)
                                : "");
                    String expFullUnixTsTS =
                        zdt_TS_on_wire.toEpochSecond()
                            + (sendFractionalSeconds && zdt_TS_on_wire.getNano() > 0
                    ...
                    if (useSSPS && withFract) {
                      ...
                      setObjectFromTz(
                          props, tYear, cal_02, MysqlType.TIMESTAMP, senderTz, expYearTS);
                    } else {
                      assertThrows(props, tYear, cal_02, null, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, cal_02, MysqlType.DATE, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, cal_02, MysqlType.TIME, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, cal_02, MysqlType.DATETIME, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, cal_02, MysqlType.TIMESTAMP, senderTz, dataTruncatedErr);
                    }
                    assertThrows(props, tYear, cal_02, MysqlType.CHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, cal_02, MysqlType.VARCHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, cal_02, MysqlType.TINYTEXT, senderTz, dataTruncatedErr);
                    assertThrows(props, tYear, cal_02, MysqlType.TEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, cal_02, MysqlType.MEDIUMTEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, cal_02, MysqlType.LONGTEXT, senderTz, dataTruncatedErr);
                    ...
                    if (useSSPS) {
                      if (withFract) {
                        ...
                        assertThrows(
                            props, tDate, cal_02, MysqlType.TIME, senderTz, dataTruncatedErr);
                      }
                    } else {
                      assertThrows(
                          props,
                    ...
                    setObjectFromTz(
                        props, tDatetime, cal_02, MysqlType.DATE, senderTz, expDatetimeNoTime);
                    setObjectFromTz(
                        props, tDatetime, cal_02, MysqlType.CHAR, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, cal_02, MysqlType.VARCHAR, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, cal_02, MysqlType.TINYTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, cal_02, MysqlType.TEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, cal_02, MysqlType.MEDIUMTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, cal_02, MysqlType.LONGTEXT, senderTz, expDatetime);
                    if (useSSPS) {
                      if (withFract) {
                        setObjectFromTz(
                            props, tDatetime, cal_02, MysqlType.TIME, senderTz, expDatetimeDef);
                      } else {
                        assertThrows(
                            props, tDatetime, cal_02, MysqlType.TIME, senderTz, dataTruncatedErr);
                      }
                    } else {
                      assertThrows(
                          props,
                    ...
                    setObjectFromTz(
                        props, tDatetime, cal_02, MysqlType.DATETIME, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, cal_02, MysqlType.TIMESTAMP, senderTz, expDatetimeTS);
                    assertThrows(
                        props,
                        tDatetime,
                        cal_02,
                    ...
                    setObjectFromTz(
                        props, tTimestamp, cal_02, null, senderTz, expTimestampTS, expFullUnixTsTS);
                    setObjectFromTz(
                        props,
                        tTimestamp,
                        cal_02,
                    ...
                    setObjectFromTz(
                        props, tVarchar, cal_02, MysqlType.DATETIME, senderTz, expDatetime2);
                    setObjectFromTz(
                        props, tVarchar, cal_02, MysqlType.TIMESTAMP, senderTz, expDatetimeTS2);
                    ...
                    setObjectFromTz(
                        props, tVarchar, cal_02, MysqlType.VARCHAR, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tVarchar, cal_02, MysqlType.TINYTEXT, senderTz, expDatetime);
                    setObjectFromTz(props, tVarchar, cal_02, MysqlType.TEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tVarchar, cal_02, MysqlType.MEDIUMTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tVarchar, cal_02, MysqlType.LONGTEXT, senderTz, expDatetime);
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    DateTimeFormatter dateTimeFmt =
                        sendFractionalSeconds && withFract
                            ? TimeUtil.DATETIME_FORMATTER_WITH_MILLIS_NO_OFFSET
                            : TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET;
                    DateTimeFormatter timeFmt =
                        sendFractionalSeconds && withFract
                    ...
                    java.util.Date utilDate =
                        java.util.Date.from(zdt_20200101_120000_123456_at_senderTz.toInstant());
                    ...
                    if (useSSPS && withFract) {
                      ...
                      setObjectFromTz(
                          props, tYear, utilDate, MysqlType.DATETIME, senderTz, expYear);
                      setObjectFromTz(
                          props, tYear, utilDate, MysqlType.TIMESTAMP, senderTz, expYearTS);
                    } else {
                      assertThrows(props, tYear, utilDate, null, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, utilDate, MysqlType.DATE, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, utilDate, MysqlType.TIME, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, utilDate, MysqlType.DATETIME, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, utilDate, MysqlType.TIMESTAMP, senderTz, dataTruncatedErr);
                    }
                    assertThrows(
                        props, tYear, utilDate, MysqlType.CHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, utilDate, MysqlType.VARCHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, utilDate, MysqlType.TINYTEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, utilDate, MysqlType.TEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, utilDate, MysqlType.MEDIUMTEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, utilDate, MysqlType.LONGTEXT, senderTz, dataTruncatedErr);
                    ...
                    setObjectFromTz(
                        props, tDate, utilDate, MysqlType.MEDIUMTEXT, senderTz, expDate);
                    setObjectFromTz(props, tDate, utilDate, MysqlType.LONGTEXT, senderTz, expDate);
                    if (useSSPS) {
                      if (withFract) {
                        setObjectFromTz(
                            props, tDate, utilDate, MysqlType.TIME, senderTz, expDateDef);
                      } else {
                        assertThrows(
                            props, tDate, utilDate, MysqlType.TIME, senderTz, dataTruncatedErr);
                      }
                    } else {
                      assertThrows(
                          props,
                    ...
                    setObjectFromTz(
                        props, tDate, utilDate, MysqlType.TIMESTAMP, senderTz, expDateTS);
                    assertThrows(
                        props,
                        tDate,
                        utilDate,
                    ...
                    if (useSSPS) {
                      setObjectFromTz(
                          props, tTime, utilDate, MysqlType.DATE, senderTz, s_000000_000000);
                    } else {
                      assertThrows(
                          props,
                          tTime,
                          ...
                          MysqlType.DATE,
                          senderTz,
                          incorrectTimeErr.replace("X", s_20200101));
                    }
                    ...
                    setObjectFromTz(
                        props, tTime, utilDate, MysqlType.MEDIUMTEXT, senderTz, expTime);
                    ...
                    setObjectFromTz(
                        props, tTime, utilDate, MysqlType.TIMESTAMP, senderTz, expTimeTS);
                    setObjectFromTz(
                        props,
                        tTime,
                        utilDate,
                    ...
                    setObjectFromTz(
                        props, tDatetime, utilDate, MysqlType.DATE, senderTz, expDatetimeNoTime);
                    setObjectFromTz(
                        props, tDatetime, utilDate, MysqlType.CHAR, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, utilDate, MysqlType.VARCHAR, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, utilDate, MysqlType.TINYTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, utilDate, MysqlType.TEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, utilDate, MysqlType.MEDIUMTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, utilDate, MysqlType.LONGTEXT, senderTz, expDatetime);
                    if (useSSPS) {
                      if (withFract) {
                        setObjectFromTz(
                            props, tDatetime, utilDate, MysqlType.TIME, senderTz, expDatetimeDef);
                      } else {
                        assertThrows(
                            props, tDatetime, utilDate, MysqlType.TIME, senderTz, dataTruncatedErr);
                      }
                    } else {
                      assertThrows(
                          props,
                    ...
                    setObjectFromTz(
                        props, tDatetime, utilDate, MysqlType.DATETIME, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, utilDate, MysqlType.TIMESTAMP, senderTz, expDatetimeTS);
                    assertThrows(
                        props,
                        tDatetime,
                        utilDate,
                    ...
                    setObjectFromTz(
                        props, tVarchar, utilDate, MysqlType.DATETIME, senderTz, expDatetime2);
                    setObjectFromTz(
                        props, tVarchar, utilDate, MysqlType.TIMESTAMP, senderTz, expDatetimeTS2);
                    ...
                    setObjectFromTz(
                        props, tVarchar, utilDate, MysqlType.CHAR, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tVarchar, utilDate, MysqlType.VARCHAR, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tVarchar, utilDate, MysqlType.TINYTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tVarchar, utilDate, MysqlType.TEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tVarchar, utilDate, MysqlType.MEDIUMTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tVarchar, utilDate, MysqlType.LONGTEXT, senderTz, expDatetime);
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    ZonedDateTime zdt_20200101_no_time_on_wire =
                        ld_20200101.atStartOfDay(sessionTz.toZoneId());
                    ...
                    String expTime =
                        zdt_20200101_no_time_on_wire.format(TIME_FORMATTER_WITH_MICROS_NO_OFFCET);
                    String expDatetimeNoTime =
                        zdt_20200101_no_time_on_wire.format(
                            DateTimeFormatter.ofPattern("yyyy-MM-dd 00:00:00"));
                    String expTimestamp =
                        zdt_20200101_no_time_on_wire
                            .withZoneSameInstant(tz_UTC.toZoneId())
                            .format(DATETIME_FORMATTER_WITH_MICROS_NO_OFFCET);
                    String expectedUnixTs =
                        zdt_20200101_no_time_on_wire.toEpochSecond()
                            + (zdt_20200101_no_time_on_wire.getNano() > 0
                                ? "."
                                    + TimeUtil.formatNanos(
                                        zdt_20200101_no_time_on_wire.getNano(), 3)
                                : "");
                    ...
                    if (useSSPS && withFract) {
                      ...
                      setObjectFromTz(
                          props, tYear, ld_20200101, MysqlType.DATETIME, senderTz, expYear);
                      setObjectFromTz(
                          props, tYear, ld_20200101, MysqlType.TIMESTAMP, senderTz, expYear);
                    } else {
                      assertThrows(props, tYear, ld_20200101, null, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, ld_20200101, MysqlType.DATE, senderTz, dataTruncatedErr);
                      assertThrows(
                          props,
                          tYear,
                          ld_20200101,
                    ...
                    assertThrows(
                        props, tYear, ld_20200101, MysqlType.CHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, ld_20200101, MysqlType.VARCHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, ld_20200101, MysqlType.TINYTEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, ld_20200101, MysqlType.TEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props,
                        tYear,
                        ld_20200101,
                        ...
                        dataTruncatedErr);
                    assertThrows(
                        props, tYear, ld_20200101, MysqlType.LONGTEXT, senderTz, dataTruncatedErr);
                    ...
                    setObjectFromTz(
                        props, tDate, ld_20200101, MysqlType.VARCHAR, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, ld_20200101, MysqlType.TINYTEXT, senderTz, expDate);
                    setObjectFromTz(props, tDate, ld_20200101, MysqlType.TEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, ld_20200101, MysqlType.MEDIUMTEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, ld_20200101, MysqlType.LONGTEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tDate, ld_20200101, MysqlType.DATETIME, senderTz, expDatetimeNoTime);
                    setObjectFromTz(
                        props,
                        tDate,
                        ld_20200101,
                    ...
                    assertThrows(
                        props, tTime, ld_20200101, MysqlType.VARCHAR, senderTz, expTimeErr);
                    assertThrows(
                        props, tTime, ld_20200101, MysqlType.TINYTEXT, senderTz, expTimeErr);
                    assertThrows(props, tTime, ld_20200101, MysqlType.TEXT, senderTz, expTimeErr);
                    assertThrows(
                        props, tTime, ld_20200101, MysqlType.MEDIUMTEXT, senderTz, expTimeErr);
                    assertThrows(
                        props, tTime, ld_20200101, MysqlType.LONGTEXT, senderTz, expTimeErr);
                    setObjectFromTz(
                        props, tTime, ld_20200101, MysqlType.DATETIME, senderTz, expTime);
                    setObjectFromTz(
                        props, tTime, ld_20200101, MysqlType.TIMESTAMP, senderTz, expTime);
                    setObjectFromTz(
                        props,
                        tTime,
                        ld_20200101,
                    ...
                    setObjectFromTz(
                        props, tDatetime, ld_20200101, null, senderTz, expDatetimeNoTime);
                    setObjectFromTz(
                        props, tDatetime, ld_20200101, MysqlType.DATE, senderTz, expDatetimeNoTime);
                    setObjectFromTz(
                        props, tDatetime, ld_20200101, MysqlType.CHAR, senderTz, expDatetimeNoTime);
                    setObjectFromTz(
                        props,
                        tDatetime,
                        ld_20200101,
                    ...
                    setObjectFromTz(
                        ...
                        expDatetimeNoTime);
                    setObjectFromTz(
                        props, tDatetime, ld_20200101, MysqlType.TEXT, senderTz, expDatetimeNoTime);
                    setObjectFromTz(
                        props,
                        tDatetime,
                        ld_20200101,
                    ...
                    setObjectFromTz(
                        ...
                        expDatetimeNoTime);
                    assertThrows(
                        props, tDatetime, ld_20200101, MysqlType.YEAR, senderTz, expDatetimeErr);
                    ...
                    setObjectFromTz(
                        ...
                        expectedUnixTs);
                    assertThrows(
                        props, tTimestamp, ld_20200101, MysqlType.YEAR, senderTz, expDatetimeErr);

                    /* Into VARCHAR field */

                    setObjectFromTz(props, tVarchar, ld_20200101, null, senderTz, expDate);
                    setObjectFromTz(
                        props, tVarchar, ld_20200101, MysqlType.DATE, senderTz, expDate);
                    setObjectFromTz(
                        props, tVarchar, ld_20200101, MysqlType.CHAR, senderTz, expDate);
                    setObjectFromTz(
                        props, tVarchar, ld_20200101, MysqlType.VARCHAR, senderTz, expDate);
                    setObjectFromTz(
                        props, tVarchar, ld_20200101, MysqlType.TINYTEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tVarchar, ld_20200101, MysqlType.TEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tVarchar, ld_20200101, MysqlType.MEDIUMTEXT, senderTz, expDate);
                    setObjectFromTz(
                        props, tVarchar, ld_20200101, MysqlType.LONGTEXT, senderTz, expDate);
                    setObjectFromTz(
                        props,
                        tVarchar,
                        ld_20200101,
                    ...
                    setObjectFromTz(
                        ...
                        expDatetimeNoTime);
                    setObjectFromTz(
                        props, tVarchar, ld_20200101, MysqlType.YEAR, senderTz, expYear);
                  }
                }
              }
            }
                  ...
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    DateTimeFormatter dateTimeFmt =
                        withFract
                            ...
                            : TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET;
                    DateTimeFormatter timeFmt =
                        withFract && sendFractionalSeconds
                            ? TIME_FORMATTER_WITH_MICROS_NO_OFFCET
                            : TimeUtil.TIME_FORMATTER_NO_FRACT_NO_OFFSET;
                    DateTimeFormatter timeFmtForChars =
                        withFract && sendFractionalSeconds
                    ...
                    ZonedDateTime zdt_no_date_120000_123456_on_wire =
                        LocalDate.now(sessionTz.toZoneId())
                            .atTime(sendFractionalSeconds ? orig_lt : orig_lt.withNano(0))
                            .atZone(sessionTz.toZoneId());
                    ...
                    String expDateErr9 =
                        incorrectDateErr.replace(
                            "X",
                            useSSPS && !sendFractionalSeconds && versionMeetsMinimum(8, 0, 28)
                                ? expTime8_0_28
                                : expTime9);

                    String expDatetimeErr6 = incorrectDatetimeErr.replace("X", expTime6);
                    String expDatetimeErr9 =
                        incorrectDatetimeErr.replace(
                            "X",
                            useSSPS && !sendFractionalSeconds && versionMeetsMinimum(8, 0, 28)
                                ? expTime8_0_28
                    ...
                    if (useSSPS && withFract) {
                      ...
                      assertThrows(
                          props, tYear, orig_lt, MysqlType.TIME, senderTz, dataTruncatedErr);
                    }
                    assertThrows(props, tYear, orig_lt, MysqlType.CHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, orig_lt, MysqlType.VARCHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, orig_lt, MysqlType.TINYTEXT, senderTz, dataTruncatedErr);
                    assertThrows(props, tYear, orig_lt, MysqlType.TEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, orig_lt, MysqlType.MEDIUMTEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, orig_lt, MysqlType.LONGTEXT, senderTz, dataTruncatedErr);
                    ...
                    if (useSSPS) {
                      if (withFract) {
                        ...
                        setObjectFromTz(
                            props, tDate, orig_lt, MysqlType.TIME, senderTz, expDateDef);
                      } else {
                        assertThrows(props, tDate, orig_lt, null, senderTz, dataTruncatedErr);
                        assertThrows(
                            props, tDate, orig_lt, MysqlType.TIME, senderTz, dataTruncatedErr);
                      }
                    } else {
                    ...
                    assertThrows(
                        props, tDate, orig_lt, MysqlType.MEDIUMTEXT, senderTz, expDateErr9);
                    ...
                    setObjectFromTz(
                        props, tTime, orig_lt, MysqlType.MEDIUMTEXT, senderTz, expTime6);
                    ...
                    if (useSSPS) {
                      if (withFract) {
                        ...
                        setObjectFromTz(
                            props, tDatetime, orig_lt, MysqlType.TIME, senderTz, expDatetimeDef);
                      } else {
                        assertThrows(props, tDatetime, orig_lt, null, senderTz, dataTruncatedErr);
                        assertThrows(
                            props, tDatetime, orig_lt, MysqlType.TIME, senderTz, dataTruncatedErr);
                      }
                    } else {
                      assertThrows(props, tDatetime, orig_lt, null, senderTz, expDatetimeErr6);
                      assertThrows(
                          props, tDatetime, orig_lt, MysqlType.TIME, senderTz, expDatetimeErr6);
                    }
                    assertThrows(
                        props, tDatetime, orig_lt, MysqlType.CHAR, senderTz, expDatetimeErr9);
                    assertThrows(
                        props, tDatetime, orig_lt, MysqlType.VARCHAR, senderTz, expDatetimeErr9);
                    assertThrows(
                        props, tDatetime, orig_lt, MysqlType.TINYTEXT, senderTz, expDatetimeErr9);
                    assertThrows(
                        props, tDatetime, orig_lt, MysqlType.TEXT, senderTz, expDatetimeErr9);
                    assertThrows(
                        props, tDatetime, orig_lt, MysqlType.MEDIUMTEXT, senderTz, expDatetimeErr9);
                    assertThrows(
                        props, tDatetime, orig_lt, MysqlType.LONGTEXT, senderTz, expDatetimeErr9);
                    ...
                    if (useSSPS && withFract) {
                      ...
                      assertThrows(
                          ...
                          null,
                          senderTz,
                          incorrectDatetimeErr.replace("X", expTimeNoMs));
                      assertThrows(
                          props, tTimestamp, orig_lt, MysqlType.TIME, senderTz, expDatetimeErr6);
                    }
                    assertThrows(
                        props, tTimestamp, orig_lt, MysqlType.CHAR, senderTz, expDatetimeErr9);
                    assertThrows(
                        props, tTimestamp, orig_lt, MysqlType.VARCHAR, senderTz, expDatetimeErr9);
                    assertThrows(
                        props, tTimestamp, orig_lt, MysqlType.TINYTEXT, senderTz, expDatetimeErr9);
                    assertThrows(
                        props, tTimestamp, orig_lt, MysqlType.TEXT, senderTz, expDatetimeErr9);
                    assertThrows(
                        props,
                        tTimestamp,
                        orig_lt,
                        ...
                        expDatetimeErr9);
                    assertThrows(
                        props, tTimestamp, orig_lt, MysqlType.LONGTEXT, senderTz, expDatetimeErr9);
                    ...
                    String expTime2 =
                        useSSPS
                            ? expTimeNoMs
                            : expTime6; // TODO milliseconds are ignored by server. Bug ?
                    ...
                    setObjectFromTz(
                        props, tVarchar, orig_lt, MysqlType.VARCHAR, senderTz, expTime9);
                    setObjectFromTz(
                        props, tVarchar, orig_lt, MysqlType.TINYTEXT, senderTz, expTime9);
                    setObjectFromTz(props, tVarchar, orig_lt, MysqlType.TEXT, senderTz, expTime9);
                    setObjectFromTz(
                        props, tVarchar, orig_lt, MysqlType.MEDIUMTEXT, senderTz, expTime9);
                    setObjectFromTz(
                        props, tVarchar, orig_lt, MysqlType.LONGTEXT, senderTz, expTime9);
                  }
                }
              }
            }
                  ...
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    DateTimeFormatter dateTimeFmt =
                        withFract && sendFractionalSeconds
                            ? DATETIME_FORMATTER_WITH_MICROS_NO_OFFCET
                            : TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET;
                    DateTimeFormatter dateTimeFmtForChars =
                        withFract && sendFractionalSeconds
                    ...
                    LocalDateTime orig_ldt =
                        withFract
                            ? ldt_20200101_120000_123456
                            : ldt_20200101_120000_123456.withNano(0);

                    ZonedDateTime zdt_20200101_120000_123456_at_senderTz =
                        orig_ldt.atZone(senderTz.toZoneId());

                    ZonedDateTime zdt_20200101_120000_123456_on_wire =
                        (sendFractionalSeconds
                                ? zdt_20200101_120000_123456_at_senderTz
                                : zdt_20200101_120000_123456_at_senderTz.withNano(0))
                            .withZoneSameLocal(sessionTz.toZoneId());
                    ZonedDateTime zdt_no_date_120000_123456_on_wire =
                        LocalDate.now(sessionTz.toZoneId())
                            .atTime(
                    ...
                    String expDatetime = zdt_20200101_120000_123456_on_wire.format(dateTimeFmt);
                    String expDatetimeChars =
                        zdt_20200101_120000_123456_on_wire.format(dateTimeFmtForChars);
                    String expDatetimeDef =
                        LocalDate.now(sessionTz.toZoneId())
                            .atTime(zdt_20200101_120000_123456_on_wire.toLocalTime())
                            .atZone(sessionTz.toZoneId())
                    ...
                    if (useSSPS && withFract) {
                      ...
                      setObjectFromTz(
                          props, tYear, orig_ldt, MysqlType.DATETIME, senderTz, expYear);
                      setObjectFromTz(
                          props, tYear, orig_ldt, MysqlType.TIMESTAMP, senderTz, expYear);
                    } else {
                      assertThrows(props, tYear, orig_ldt, null, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, orig_ldt, MysqlType.DATE, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, orig_ldt, MysqlType.TIME, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, orig_ldt, MysqlType.DATETIME, senderTz, dataTruncatedErr);
                      assertThrows(
                          props, tYear, orig_ldt, MysqlType.TIMESTAMP, senderTz, dataTruncatedErr);
                    }
                    assertThrows(
                        props, tYear, orig_ldt, MysqlType.CHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, orig_ldt, MysqlType.VARCHAR, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, orig_ldt, MysqlType.TINYTEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, orig_ldt, MysqlType.TEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, orig_ldt, MysqlType.MEDIUMTEXT, senderTz, dataTruncatedErr);
                    assertThrows(
                        props, tYear, orig_ldt, MysqlType.LONGTEXT, senderTz, dataTruncatedErr);
                    ...
                    setObjectFromTz(
                        props, tDate, orig_ldt, MysqlType.MEDIUMTEXT, senderTz, expDate);
                    setObjectFromTz(props, tDate, orig_ldt, MysqlType.LONGTEXT, senderTz, expDate);
                    if (useSSPS) {
                      if (withFract) {
                        setObjectFromTz(
                            props, tDate, orig_ldt, MysqlType.TIME, senderTz, expDateDef);
                      } else {
                        assertThrows(
                            props, tDate, orig_ldt, MysqlType.TIME, senderTz, dataTruncatedErr);
                      }
                    } else {
                      assertThrows(
                          props,
                    ...
                    if (useSSPS) {
                      setObjectFromTz(
                          props, tTime, orig_ldt, MysqlType.DATE, senderTz, s_000000_000000);
                    } else {
                      assertThrows(
                          props,
                          tTime,
                    ...
                    setObjectFromTz(
                        props, tTime, orig_ldt, MysqlType.MEDIUMTEXT, senderTz, expTime);
                    ...
                    setObjectFromTz(
                        props, tDatetime, orig_ldt, MysqlType.DATE, senderTz, expDatetimeNoTime);
                    setObjectFromTz(
                        props, tDatetime, orig_ldt, MysqlType.CHAR, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, orig_ldt, MysqlType.VARCHAR, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, orig_ldt, MysqlType.TINYTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, orig_ldt, MysqlType.TEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, orig_ldt, MysqlType.MEDIUMTEXT, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, orig_ldt, MysqlType.LONGTEXT, senderTz, expDatetime);
                    if (useSSPS) {
                      if (withFract) {
                        setObjectFromTz(
                            props, tDatetime, orig_ldt, MysqlType.TIME, senderTz, expDatetimeDef);
                      } else {
                        assertThrows(
                            props, tDatetime, orig_ldt, MysqlType.TIME, senderTz, dataTruncatedErr);
                      }
                    } else {
                      assertThrows(
                          props,
                    ...
                    setObjectFromTz(
                        props, tDatetime, orig_ldt, MysqlType.DATETIME, senderTz, expDatetime);
                    setObjectFromTz(
                        props, tDatetime, orig_ldt, MysqlType.TIMESTAMP, senderTz, expDatetime);
                    ...
                    setObjectFromTz(
                        props, tTimestamp, orig_ldt, null, senderTz, expTimestamp, expFullUnixTs);
                    setObjectFromTz(
                        props,
                        tTimestamp,
                        orig_ldt,
                    ...
                    String expDatetime2 =
                        useSSPS
                            ? zdt_20200101_120000_123456_on_wire.format(
                                TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET)
                            : zdt_20200101_120000_123456_on_wire.format(
                                dateTimeFmt); // TODO milliseconds are ignored by server. Bug ?
                    String expTime2 =
                        useSSPS
                            ? expTimeNoMs
                            : expTime; // TODO milliseconds are ignored by server. Bug ?
                    ...
                    setObjectFromTz(
                        props, tVarchar, orig_ldt, MysqlType.DATETIME, senderTz, expDatetime2);
                    setObjectFromTz(
                        props, tVarchar, orig_ldt, MysqlType.TIMESTAMP, senderTz, expDatetime2);
                    ...
                    setObjectFromTz(
                        props, tVarchar, orig_ldt, MysqlType.CHAR, senderTz, expDatetimeChars);
                    setObjectFromTz(
                        props, tVarchar, orig_ldt, MysqlType.VARCHAR, senderTz, expDatetimeChars);
                    setObjectFromTz(
                        props, tVarchar, orig_ldt, MysqlType.TINYTEXT, senderTz, expDatetimeChars);
                    setObjectFromTz(
                        props, tVarchar, orig_ldt, MysqlType.TEXT, senderTz, expDatetimeChars);
                    setObjectFromTz(
                        props,
                        tVarchar,
                        orig_ldt,
                        ...
                        expDatetimeChars);
                    setObjectFromTz(
                        props, tVarchar, orig_ldt, MysqlType.LONGTEXT, senderTz, expDatetimeChars);
  ...
  public void testOffsetTimeSetters() throws Exception {
    ...
    OffsetTime ot_120000_123456_05_00 =
        OffsetTime.of(12, 00, 00, withFract ? 123456000 : 0, ZoneOffset.ofHours(5));
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    String expTimeTz8_0_28 =
                        ot_120000_123456_05_00
                            .format(DateTimeFormatter.ofPattern("20HH-mm-ss X:00:00"))
                            .replace("+", "");
                    String expDatetimeTz8_0_28 =
                        ot_120000_123456_05_00
                            .format(DateTimeFormatter.ofPattern("20HH-mm-ss X:00:00.000000"))
                            .replace("+", "");
                    ...
                    if (useSSPS && withFract) {
                      setObjectFromTz(
                          props, tYear, ot_120000_123456_05_00, null, senderTz, expYearDef);
                      setObjectFromTz(
                          props,
                          tYear,
                          ot_120000_123456_05_00,
                      ...
                      assertThrows(
                          props, tYear, ot_120000_123456_05_00, null, senderTz, dataTruncatedErr);
                      assertThrows(
                          props,
                          tYear,
                          ot_120000_123456_05_00,
                    ...
                    if (useSSPS) {
                      if (withFract) {
                        setObjectFromTz(
                            props, tDate, ot_120000_123456_05_00, null, senderTz, expDateDef);
                        setObjectFromTz(
                            props,
                            tDate,
                            ot_120000_123456_05_00,
                        ...
                        assertThrows(
                            props, tDate, ot_120000_123456_05_00, null, senderTz, dataTruncatedErr);
                        assertThrows(
                            props,
                            tDate,
                            ot_120000_123456_05_00,
                      ...
                      assertThrows(
                          props, tDate, ot_120000_123456_05_00, null, senderTz, expDateErr);
                      assertThrows(
                          props,
                          tDate,
                          ot_120000_123456_05_00,
                    ...
                    assertThrows(
                        ...
                        expTimeErrTz);
                    setObjectFromTz(
                        props, tTime, ot_120000_05_00, MysqlType.TIME, senderTz, expTimeNoMs);
                    setObjectFromTz(
                        props, tTime, ot_120000_123456_05_00, MysqlType.TIME, senderTz, expTime);
                    ...
                    if (useSSPS) {
                      ...
                      assertThrows(
                          props, tDatetime, ot_120000_123456_05_00, null, senderTz, expDatetimeErr);
                      assertThrows(
                          props,
                          tDatetime,
                          ot_120000_123456_05_00,
                    ...
                    setObjectFromTz(
                        props, tVarchar, ot_120000_123456_05_00, null, senderTz, expTime2);
                    setObjectFromTz(
                        props,
                        tVarchar,
                        ot_120000_123456_05_00,
  ...
  public void testOffsetDatetimeSetters() throws Exception {
    ...
    // Starting from MySQL 8.0.22 server also converts string values in TIMESTAMP_WITH_TIMEZONE
    // format to the session time zone
    // for column types other than TIMESTAMP and DATETIME. In MySQL 8.0.26 it was reverted, restored
    // in MySQL 8.0.28.
    boolean serverConvertsTzForAllTypes =
        versionMeetsMinimum(8, 0, 22) && !versionMeetsMinimum(8, 0, 26)
            || versionMeetsMinimum(8, 0, 28);
    ...
    OffsetDateTime odt_20200101_120000_123456_05_00 =
        OffsetDateTime.of(2020, 1, 1, 12, 00, 00, withFract ? 123456000 : 0, ZoneOffset.ofHours(5));
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    ZonedDateTime zdt_20200101_120000_123456_at_senderTz =
                        odt_20200101_120000_123456_05_00.atZoneSameInstant(senderTz.toZoneId());
                    ...
                    ZonedDateTime zdt_TS_on_wire =
                        (sendFractionalSeconds
                                ? zdt_20200101_120000_123456_senderTz_to_connTz
                                : zdt_20200101_120000_123456_senderTz_to_connTz.withNano(0))
                            .withZoneSameLocal(sessionTz.toZoneId());
                    ...
                    String expDateChar =
                        serverConvertsTzForAllTypes
                            ? odt_20200101_120000_123456_05_00
                                .atZoneSameInstant(sessionTz.toZoneId())
                    ...
                    String expDatetimeNoTime =
                        zdt_20200101_120000_123456_on_wire.format(
                            DateTimeFormatter.ofPattern("yyyy-MM-dd 00:00:00"));
                    String expDatetimeExt =
                        (sendFractionalSeconds
                                ? odt_20200101_120000_123456_05_00
                                : odt_20200101_120000_123456_05_00.withNano(0))
                            .atZoneSameInstant(sessionTz.toZoneId())
                            .format(dateTimeFmt);
                    String expDatetimeExtOff =
                        (sendFractionalSeconds
                                ? odt_20200101_120000_123456_05_00
                                : odt_20200101_120000_123456_05_00.withNano(0))
                            .format(
                    ...
                    setObjectFromTz(
                        props, tDate, odt_20200101_120000_123456_05_00, null, senderTz, expDateTS);
                    setObjectFromTz(
                        props,
                        tDate,
                        odt_20200101_120000_123456_05_00,
                    ...
                    setObjectFromTz(
                        props, tTime, odt_20200101_120000_123456_05_00, null, senderTz, expTimeTS);
                    if (useSSPS) {
                      setObjectFromTz(
                          props,
                          tTime,
                    ...
                    String expTimestampExt =
                        (sendFractionalSeconds
                                ? odt_20200101_120000_123456_05_00
                                : odt_20200101_120000_123456_05_00.withNano(0))
                            .atZoneSameInstant(tz_UTC.toZoneId())
                            .format(dateTimeFmt);
                    String expFullUnixTsExt =
                        odt_20200101_120000_123456_05_00.toEpochSecond()
                            + (sendFractionalSeconds
                                    && odt_20200101_120000_123456_05_00.getNano() > 0
                                ? "."
                                    + TimeUtil.formatNanos(
                                        odt_20200101_120000_123456_05_00.getNano(), 6)
                                : "");
  ...
  public void testZonedDatetimeSetters() throws Exception {
    ...
    ZonedDateTime zdt_20200101_120000_123456_05_00 =
        ZonedDateTime.of(
            withFract ? ldt_20200101_120000_123456 : ldt_20200101_120000_123456.withNano(0),
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    ZonedDateTime zdt_20200101_120000_123456_at_senderTz =
                        zdt_20200101_120000_123456_05_00.withZoneSameInstant(senderTz.toZoneId());
                    ...
                    String expDateChar =
                        serverConvertsTzForAllTypes
                            ? zdt_20200101_120000_123456_05_00
                                .withZoneSameInstant(sessionTz.toZoneId())
                                .format(TimeUtil.DATE_FORMATTER)
                    ...
                    String expDatetimeNoTime =
                        zdt_20200101_120000_123456_on_wire.format(
                            DateTimeFormatter.ofPattern("yyyy-MM-dd 00:00:00"));
                    String expDatetimeOff =
                        zdt_20200101_120000_123456_05_00.format(
                            withFract && sendFractionalSeconds
                                ? TimeUtil.DATETIME_FORMATTER_WITH_NANOS_WITH_OFFSET
                                : TimeUtil.DATETIME_FORMATTER_NO_FRACT_WITH_OFFSET);
                    ...
                    setObjectFromTz(
                        props, tDate, zdt_20200101_120000_123456_05_00, null, senderTz, expDateTS);
                    setObjectFromTz(
                        props,
                        tDate,
                        zdt_20200101_120000_123456_05_00,
                    ...
                    setObjectFromTz(
                        props, tTime, zdt_20200101_120000_123456_05_00, null, senderTz, expTimeTS);
                    if (useSSPS) {
                      setObjectFromTz(
                          props,
                          tTime,
                    ...
                    String expTimestampExt =
                        zdt_20200101_120000_123456_05_00
                            ...
                            .format(dateTimeFmt);
                    String expFullUnixTsExt =
                        zdt_20200101_120000_123456_05_00.toEpochSecond()
                            + (sendFractionalSeconds
                                    && zdt_20200101_120000_123456_05_00.getNano() > 0
                                ? "."
                                    + TimeUtil.formatNanos(
                                        zdt_20200101_120000_123456_05_00.getNano(), 6)
                                : "");
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    String expDur =
                        TimeUtil.getDurationString(sendFractionalSeconds ? dur : dur_no_fract);
                    String expTime = TimeUtil.getDurationString(dur);

                    Duration neg_dur_no_fract = Duration.parse("-PT300H10M20S");
                    Duration neg_dur =
                        withFract ? Duration.parse("-PT300H10M20.123S") : neg_dur_no_fract;
                    String expNegDur =
                        TimeUtil.getDurationString(
                            sendFractionalSeconds ? neg_dur : neg_dur_no_fract);
                    ...
                    String expChar =
                        expDur + (withFract && sendFractionalSeconds && useSSPS ? "000" : "");
                    String expChar2 =
                        useSSPS
                            ? TimeUtil.getDurationString(dur_no_fract)
                            : expChar; // TODO milliseconds are ignored by server. Bug ?
                    String expNegChar =
                        expNegDur + (withFract && sendFractionalSeconds && useSSPS ? "000" : "");
                    String expNegChar2 =
                        useSSPS
                            ? TimeUtil.getDurationString(neg_dur_no_fract)
                            : expNegChar; // TODO milliseconds are ignored by server. Bug ?
                    ...
                    setObjectFromTz(
                        props, tVarchar, neg_dur, MysqlType.TIME, senderTz, expNegChar2);
                    ...
                    setObjectFromTz(
                        props, tVarchar, neg_dur, MysqlType.VARCHAR, senderTz, expNegTime);
                    setObjectFromTz(props, tVarchar, dur, MysqlType.TINYTEXT, senderTz, expTime);
                    setObjectFromTz(
                        props, tVarchar, neg_dur, MysqlType.TINYTEXT, senderTz, expNegTime);
                    ...
                    setObjectFromTz(
                        props, tVarchar, neg_dur, MysqlType.MEDIUMTEXT, senderTz, expNegTime);
                    setObjectFromTz(props, tVarchar, dur, MysqlType.LONGTEXT, senderTz, expTime);
                    setObjectFromTz(
                        props, tVarchar, neg_dur, MysqlType.LONGTEXT, senderTz, expNegTime);
                  }
                }
              }
            }
  ...
  void setObjectFromTz(
    ...
    try {
      ...
      PreparedStatement localPstmt =
          testConn.prepareStatement("INSERT INTO " + tableName + " VALUES (?, ?)");
      ...
      if (expectedUTCValue != null) {
        ...
        String sql =
            "SELECT * FROM "
                ...
                + expectedUTCValue
                + "'"
                + (expectedUnixTimestamp != null
                    ? " AND unix_timestamp(d) = " + expectedUnixTimestamp
                    : "");
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    Instant exp_instant_05 =
                        ldt_20200101_0000.atOffset(ZoneOffset.ofHours(5)).toInstant();
                    ...
                    assertEquals(
                        java.sql.Timestamp.from(exp_instant_05), this.rs.getTimestamp(1, cal_05));
                    assertEquals(java.sql.Date.from(exp_instant_tz), this.rs.getObject(1));
                    assertEquals(
                        java.sql.Date.from(exp_instant_tz),
                        this.rs.getObject(1, java.sql.Date.class));
                    assertEquals(
                        java.sql.Time.valueOf(lt_000000),
                        this.rs.getObject(1, java.sql.Time.class));
                    assertEquals(
                        java.sql.Timestamp.from(exp_instant_tz),
                        this.rs.getObject(1, java.sql.Timestamp.class));
                    assertEquals(
                        java.util.Date.from(exp_instant_tz),
                    ...
                    assertEquals(
                        ldt_20200101_0000.atZone(currZoneId).toOffsetDateTime().toOffsetTime(),
                        this.rs.getObject(1, OffsetTime.class));
                    assertEquals(
                        ldt_20200101_0000.atZone(currZoneId).toOffsetDateTime(),
                        this.rs.getObject(1, OffsetDateTime.class));
                    assertEquals(
                        ldt_20200101_0000.atZone(currZoneId),
                        this.rs.getObject(1, ZonedDateTime.class));
                    assertEquals(s_20200101, this.rs.getString(1));
                    assertThrows(
                        SQLException.class,
                        Messages.getString(
                            "ResultSet.UnsupportedConversion",
                    ...
                    assertEquals(
                        ldt_20191231_0000.atZone(currZoneId).toOffsetDateTime().toOffsetTime(),
                        this.rs.getObject(1, OffsetTime.class));
                    assertEquals(
                        ldt_20191231_0000.atZone(currZoneId).toOffsetDateTime(),
                        this.rs.getObject(1, OffsetDateTime.class));
                    assertEquals(
                        ldt_20191231_0000.atZone(currZoneId),
                        this.rs.getObject(1, ZonedDateTime.class));
  ...
  public void testTimeGetters() throws Exception {
    ...
    this.stmt.executeUpdate(
        "INSERT INTO " + tTime + " VALUES ('" + lt_120000_123456.toString() + "')");
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    assertEquals(
                        java.sql.Date.valueOf(ld_19700101),
                        this.rs.getObject(1, java.sql.Date.class));
                    assertEquals(
                        java.sql.Time.from(exp_instant_tz),
                        this.rs.getObject(1, java.sql.Time.class));
                    assertEquals(
                        java.sql.Timestamp.from(exp_instant_tz),
                        this.rs.getObject(1, java.sql.Timestamp.class));
                    ...
                    assertEquals(
                        exp_ldt.atZone(currZoneId).toOffsetDateTime().toOffsetTime(),
                        this.rs.getObject(1, OffsetTime.class));
                    assertEquals(
                        exp_ldt.atZone(currZoneId).toOffsetDateTime(),
                        this.rs.getObject(1, OffsetDateTime.class));
                    assertEquals(
                        exp_ldt.atZone(currZoneId), this.rs.getObject(1, ZonedDateTime.class));
                    ...
                    assertThrows(
                        SQLException.class,
                        Messages.getString("ResultSet.InvalidTimeValue", new Object[] {dur1}),
                        () -> {
                          this.rs.getTime(1);
                          return null;
                        });
                    ...
                    assertEquals(
                        Duration.parse(withFract ? "PT300H10M20.123S" : "PT300H10M20S"),
                        this.rs.getObject(1, Duration.class));
                    ...
                    assertThrows(
                        SQLException.class,
                        Messages.getString("ResultSet.InvalidTimeValue", new Object[] {dur2}),
                        () -> {
  ...
  public void testTimestampGetters() throws Exception {
    ...
    OffsetDateTime orig_UTC =
        OffsetDateTime.of(2019, 12, 31, 22, 0, 0, withFract ? 123456000 : 0, ZoneOffset.UTC);
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    Connection testConn = getConnectionWithProps(timeZoneFreeDbUrl, props);
                    this.rs =
                        testConn.createStatement().executeQuery("select * from " + tTimestamp);
                    assertTrue(this.rs.next());
                    ...
                    ZonedDateTime exp_on_wire =
                        orig_UTC.atZoneSameInstant(ZoneId.of(sessionTz.getID()));

                    ZonedDateTime exp_date =
                        exp_on_wire.withHour(0).withNano(0).withZoneSameLocal(currZoneId);
                    Instant exp_date_with_cal =
                        exp_on_wire
                            .withHour(0)
                            .withNano(0)
                            .toOffsetDateTime()
                    ...
                    ZonedDateTime exp_time =
                        exp_on_wire
                            .withYear(1970)
                            .withMonth(1)
                            .withDayOfMonth(1)
                            .withZoneSameLocal(currZoneId);
                    Instant exp_time_with_cal =
                        exp_on_wire
                            .withYear(1970)
                            .withMonth(1)
                            .withDayOfMonth(1)
                    ...
                    ZonedDateTime exp_timestamp =
                        preserveInstants
                            ? exp_on_wire
                                .withZoneSameLocal(connTz.toZoneId())
                                .withZoneSameInstant(currZoneId)
                            : exp_on_wire.withZoneSameLocal(currZoneId);

                    Instant exp_timestamp_with_cal =
                        exp_on_wire
                            .toOffsetDateTime()
                            .withOffsetSameLocal(ZoneOffset.ofHours(5))
                            .toInstant();

                    ZonedDateTime exp_odt =
                        exp_on_wire.withZoneSameLocal(
                            preserveInstants ? connTz.toZoneId() : currZoneId);

                    Calendar exp_cal =
                        GregorianCalendar.getInstance(preserveInstants ? connTz : clientTz);
                    exp_cal.set(
                        exp_on_wire.getYear(),
                        exp_on_wire.getMonthValue() - 1,
                        exp_on_wire.getDayOfMonth(),
                        exp_on_wire.getHour(),
                        exp_on_wire.getMinute(),
                        exp_on_wire.getSecond());
                    ...
                    assertEquals(
                        java.sql.Timestamp.from(exp_timestamp.toInstant()),
                        this.rs.getTimestamp(1));
                    assertEquals(
                        java.sql.Timestamp.from(exp_timestamp_with_cal),
                        this.rs.getTimestamp(1, cal_05));
                    assertEquals(
                        java.sql.Timestamp.from(exp_timestamp.toInstant()), this.rs.getObject(1));
                    assertEquals(
                        java.sql.Date.from(exp_date.toInstant()),
                        this.rs.getObject(1, java.sql.Date.class));
                    assertEquals(
                        java.sql.Time.from(exp_time.toInstant()),
                        this.rs.getObject(1, java.sql.Time.class));
                    assertEquals(
                        java.sql.Timestamp.from(exp_timestamp.toInstant()),
                        this.rs.getObject(1, java.sql.Timestamp.class));
                    assertEquals(
                        java.util.Date.from(exp_timestamp.toInstant()),
                        this.rs.getObject(1, java.util.Date.class));
                    assertEquals(exp_cal, this.rs.getObject(1, java.util.Calendar.class));
                    ...
                    assertEquals(
                        exp_datetime.toLocalDateTime(), this.rs.getObject(1, LocalDateTime.class));
                    assertEquals(
                        exp_datetime.toOffsetDateTime().toOffsetTime(),
                        this.rs.getObject(1, OffsetTime.class));
                    assertEquals(
                        exp_odt.toOffsetDateTime(), this.rs.getObject(1, OffsetDateTime.class));
                    assertEquals(exp_odt, this.rs.getObject(1, ZonedDateTime.class));
                    assertEquals(
                        exp_on_wire.toLocalDateTime().format(dateTimeFmt), this.rs.getString(1));
                    assertThrows(
                        SQLException.class,
                        Messages.getString(
                            "ResultSet.UnsupportedConversion",
                            new Object[] {"TIMESTAMP", Duration.class.getName()}),
                        () -> {
                          this.rs.getObject(1, Duration.class);
                          return null;
                        });
  ...
  public void testDatetimeGetters() throws Exception {
    boolean withFract =
        versionMeetsMinimum(5, 6, 4); // fractional seconds are not supported in previous versions
    LocalDateTime ldt_20200101_020000_123456 =
        LocalDateTime.of(2020, 1, 1, 2, 0, 0, withFract ? 123456000 : 0);
    DateTimeFormatter dateTimeFmt =
        withFract
            ? DATETIME_FORMATTER_WITH_MICROS_NO_OFFCET
            : TimeUtil.DATETIME_FORMATTER_NO_FRACT_NO_OFFSET;
    OffsetDateTime orig_UTC =
        OffsetDateTime.of(2020, 1, 1, 2, 0, 0, withFract ? 123456000 : 0, ZoneOffset.UTC);

    Calendar cal_05 = GregorianCalendar.getInstance(tz_plus_05_00);

    createTable(tDatetime, withFract ? "(d DATETIME(6))" : "(d DATETIME)");
    this.stmt.executeUpdate(
        "INSERT INTO " + tDatetime + " VALUES ('" + ldt_20200101_020000_123456.toString() + "')");
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    Instant exp_date_instant_05 =
                        ldt_20200101_0000.atOffset(ZoneOffset.ofHours(5)).toInstant();

                    Instant exp_time_instant_tz =
                        (withFract
                                ? ldt_19700101_020000_123000
                                : ldt_19700101_020000_123000.withNano(0))
                            .atZone(currZoneId)
                            .toInstant();
                    Instant exp_time_instant_05 =
                        (withFract
                                ? ldt_19700101_020000_123000
                                : ldt_19700101_020000_123000.withNano(0))
                            .atOffset(ZoneOffset.ofHours(5))
                    ...
                    Instant exp_timestamp_instant_05 =
                        ldt_20200101_020000_123456.atOffset(ZoneOffset.ofHours(5)).toInstant();
                    ...
                    TimeZone sessionTz = forceConnectionTimeZoneToSession ? connTz : serverTz;
                    ZonedDateTime exp_on_wire =
                        orig_UTC.atZoneSimilarLocal(ZoneId.of(sessionTz.getID()));
                    Instant exp_timestamp_instant =
                        (preserveInstants
                                ? exp_on_wire
                                    .withZoneSameLocal(connTz.toZoneId())
                                    .withZoneSameInstant(currZoneId)
                    ...
                    assertEquals(
                        java.sql.Date.from(exp_date_instant_05), this.rs.getDate(1, cal_05));
                    assertEquals(java.sql.Time.from(exp_time_instant_tz), this.rs.getTime(1));
                    assertEquals(
                        java.sql.Time.from(exp_time_instant_05), this.rs.getTime(1, cal_05));
                    assertEquals(
                        java.sql.Timestamp.from(exp_timestamp_instant), this.rs.getTimestamp(1));
                    assertEquals(
                        java.sql.Timestamp.from(exp_timestamp_instant_05),
                        this.rs.getTimestamp(1, cal_05));
                    assertEquals(ldt_20200101_020000_123456, this.rs.getObject(1));
                    assertEquals(
                        java.sql.Date.from(exp_date_instant_tz),
                        this.rs.getObject(1, java.sql.Date.class));
                    assertEquals(
                        java.sql.Time.from(exp_time_instant_tz),
                        this.rs.getObject(1, java.sql.Time.class));
                    assertEquals(
                        java.sql.Timestamp.from(exp_timestamp_instant),
                        this.rs.getObject(1, java.sql.Timestamp.class));
                    assertEquals(
                        java.util.Date.from(exp_timestamp_instant),
                        this.rs.getObject(1, java.util.Date.class));
                    assertEquals(exp_cal, this.rs.getObject(1, java.util.Calendar.class));
                    assertEquals(
                        ldt_20200101_020000_123456.toLocalDate(),
                        this.rs.getObject(1, LocalDate.class));
                    assertEquals(
                        ldt_20200101_020000_123456.toLocalTime(),
                        this.rs.getObject(1, LocalTime.class));
                    assertEquals(
                        ldt_20200101_020000_123456, this.rs.getObject(1, LocalDateTime.class));
                    assertEquals(
                        (withFract
                                ? ldt_19700101_020000_123456
                                : ldt_19700101_020000_123456.withNano(0))
                            .atZone(currZoneId)
                            .toOffsetDateTime()
                            .toOffsetTime(),
                        this.rs.getObject(1, OffsetTime.class));
                    assertEquals(
                        ldt_20200101_020000_123456
                            .atZone(preserveInstants ? connTz.toZoneId() : currZoneId)
                            .toOffsetDateTime(),
                        this.rs.getObject(1, OffsetDateTime.class));
                    assertEquals(
                        ldt_20200101_020000_123456.atZone(
                            preserveInstants ? connTz.toZoneId() : currZoneId),
                        this.rs.getObject(1, ZonedDateTime.class));
                    assertEquals(
                        ldt_20200101_020000_123456.format(dateTimeFmt), this.rs.getString(1));
                    assertThrows(
                        SQLException.class,
                        Messages.getString(
                            "ResultSet.UnsupportedConversion",
                            new Object[] {"DATETIME", Duration.class.getName()}),
                        () -> {
                          this.rs.getObject(1, Duration.class);
                          return null;
                        });
  ...
  public void testYearGetters() throws Exception {
    ...
    this.stmt.executeUpdate(
        "INSERT INTO " + tYear + " VALUES ('" + s_2020 + "', '" + s_2020 + "')");
                ...
                for (boolean useSSPS : new boolean[] {false, true}) {
                  for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                    for (boolean sendTimeFract : new boolean[] {false, true}) {
                      ...
                      props.setProperty(
                          PropertyKey.yearIsDateType.getKeyName(), "" + yearIsDateType);
                      if (connectionTZ == null) {
                        props.remove(PropertyKey.connectionTimeZone.getKeyName());
                      } else {
                        props.setProperty(
                            PropertyKey.connectionTimeZone.getKeyName(), connectionTZ);
                      }
                      props.setProperty(
                          PropertyKey.forceConnectionTimeZoneToSession.getKeyName(),
                          "" + forceConnectionTimeZoneToSession);
                      ...
                      props.setProperty(
                          ...
                          "" + sendTimeFract);
                      props.setProperty(
                          PropertyKey.sendFractionalSeconds.getKeyName(),
                          "" + sendFractionalSeconds);
                      ...
                      Connection testConn = getConnectionWithProps(timeZoneFreeDbUrl, props);
                      ResultSet rs1 =
                          testConn.createStatement().executeQuery("select * from " + tYear);
                      ...
                      if (yearIsDateType) {
                        ...
                        assertEquals(
                            java.sql.Timestamp.from(exp_instant_05), rs1.getTimestamp(1, cal_05));
                      ...
                      assertThrows(
                          SQLException.class,
                          Messages.getString(
                              "ResultSet.UnableToConvertString",
                      ...
                      assertThrows(
                          ...
                          Messages.getString(
                              "ResultSet.UnableToConvertString",
                              new Object[] {s_2020, LocalDate.class.getName()}),
                          new Callable<Void>() {
                            public Void call() throws Exception {
                      ...
                      assertThrows(
                          ...
                          Messages.getString(
                              "ResultSet.UnableToConvertString",
                              new Object[] {s_2020, LocalTime.class.getName()}),
                          new Callable<Void>() {
                            public Void call() throws Exception {
                      ...
                      assertThrows(
                          ...
                          Messages.getString(
                              "ResultSet.UnableToConvertString",
                              new Object[] {s_2020, OffsetTime.class.getName()}),
                          new Callable<Void>() {
                            public Void call() throws Exception {
              ...
              for (boolean useSSPS : new boolean[] {false, true}) {
                for (boolean sendFractionalSeconds : new boolean[] {false, true}) {
                  for (boolean sendTimeFract : new boolean[] {false, true}) {
                    ...
                    java.sql.Timestamp expTsNoFract =
                        java.sql.Timestamp.from(
                            zdt_20200101_120000_123456_at_senderTz.withNano(0).toInstant());
                    java.sql.Timestamp expTsNanos =
                        sendFractionalSeconds
                            ? java.sql.Timestamp.from(
                                zdt_20200101_120000_123456_at_senderTz.toInstant())
                            : expTsNoFract;
                    java.sql.Timestamp expTsMillis =
                        sendFractionalSeconds
                            ? java.sql.Timestamp.from(
                                zdt_20200101_120000_123456_at_senderTz
                    ...
                    java.util.Date expUdNoFract =
                        java.util.Date.from(
                            zdt_20200101_120000_123456_at_senderTz.withNano(0).toInstant());
                    java.util.Date expUd =
                        sendFractionalSeconds
                            ? java.util.Date.from(
                                zdt_20200101_120000_123456_at_senderTz.toInstant())
                            : expUdNoFract;
                    ...
                    TimeZone connTz =
                        connectionTZ == null || "LOCAL".equals(connectionTZ)
                            ...
                            : ("SERVER".equals(connectionTZ)
                                ? serverTz
                                : TimeZone.getTimeZone(connectionTZ));
                    ZonedDateTime expZdtNoFract =
                        zdt_20200101_120000_123456_at_senderTz
                            .withNano(0)
                            .withZoneSameInstant(
                                preserveInstants ? connTz.toZoneId() : senderTz.toZoneId());
                    ...
                    Timestamp expTsNanosFromChars =
                        useSSPS
                            ? expTsNoFract
                            : expTsNanos; // TODO milliseconds are ignored by server. Bug ?
                    Timestamp expTsMillisFromChars =
                        useSSPS
                            ? expTsNoFract
                            : expTsMillis; // TODO milliseconds are ignored by server. Bug ?
                    java.util.Date expUdFromChars =
                        useSSPS
                            ? expUdNoFract
                            : expUd; // TODO milliseconds are ignored by server. Bug ?
                    ZonedDateTime expZdtFromChars =
                        useSSPS
                            ? expZdtNoFract
                            : expZdt; // TODO milliseconds are ignored by server. Bug ?
  ...
  private void checkSymmetricSetAndGet(
      Properties props,
      String tableName,
      Object parameter,
      SQLType targetSqlType,
