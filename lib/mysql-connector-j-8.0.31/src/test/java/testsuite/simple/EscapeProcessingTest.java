...
public class EscapeProcessingTest extends BaseTestCase {
  ...
  public void testEscapeProcessing() throws Exception {
    ...
    ZonedDateTime zdt =
        LocalDateTime.parse("1997-05-24T10:30:29.123")
  ...
  public void testConvertEscape() throws Exception {
    assertEquals(
        this.conn.nativeSQL("{fn convert(abcd, SQL_INTEGER)}"),
  ...
  public void testTimestampConversion() throws Exception {
    ...
    String[] availableIds =
        TimeZone.getAvailableIDs(currentTimeZone.getRawOffset() - (3600 * 1000 * 7));
  ...
  public void testBug51313() throws Exception {
    ...
    this.rs =
        this.stmt.executeQuery(
            "SELECT 'MySQL \\\\\\' testing {long \\\\\\' escape -- { \\\\\\' sequences \\\\\\' } }"
    ...
    this.rs =
        this.stmt.executeQuery("SELECT 'MySQL \\'', '{ testing doubled -- } ''\\\\\\''' quotes '");
    assertTrue(this.rs.next());
