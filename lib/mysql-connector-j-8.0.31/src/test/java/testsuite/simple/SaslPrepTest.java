...
public class SaslPrepTest extends BaseTestCase {
  ...
  private static String BIDI_MSG1 =
      "Cannot contain both RandALCat characters and LCat characters\\.";
  private static String BIDI_MSG2 =
  ...
  public void mappingNonAsciiSpaceCharacters() {
    ...
    assertEquals("my,0 TEXT", SaslPrep.prepare("my,0\u200BTEXT", SaslPrep.StringType.STORED));
    assertEquals(
        " my,0 TEXT ", SaslPrep.prepare("\u00A0my,0\u2000TEXT\u3000", SaslPrep.StringType.QUERY));
    assertEquals(
        " my,0 TEXT ", SaslPrep.prepare("\u00A0my,0\u2000TEXT\u3000", SaslPrep.StringType.STORED));
  }
  ...
  public void mappingMappeableToNothing() {
    ...
    assertEquals(
        "my,0TEXT",
        SaslPrep.prepare("\u00ADmy,0\u1806TE\uFE0FXT\uFEFF", SaslPrep.StringType.QUERY));
    assertEquals(
        "my,0TEXT",
        SaslPrep.prepare("\u00ADmy,0\u1806TE\uFE0FXT\uFEFF", SaslPrep.StringType.STORED));
  }
  ...
  public void prohibitedOutputAsciiControlCharacters() {
    assertThrows(
        ...
        PROHIBITED_MSG1,
        () -> SaslPrep.prepare("\u007Fmy,0TEXT", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG1,
        () -> SaslPrep.prepare("\u007Fmy,0TEXT", SaslPrep.StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG2,
        () -> SaslPrep.prepare("my,0\u001FTEXT", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG2,
        () -> SaslPrep.prepare("my,0\u001FTEXT", SaslPrep.StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG3,
        () -> SaslPrep.prepare("my,0TEXT\u0000", SaslPrep.StringType.QUERY));
  ...
  public void prohibitedPrivateUseCharacters() {
    ...
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG2,
        () -> SaslPrep.prepare("my,0\uDBC0\uDC00TEXT", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG2,
        () -> SaslPrep.prepare("my,0\uDBC0\uDC00TEXT", SaslPrep.StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG3,
        () -> SaslPrep.prepare("my,0TEXT\uDB80\uDC46", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG3,
        () -> SaslPrep.prepare("my,0TEXT\uDB80\uDC46", SaslPrep.StringType.STORED));
  }
  ...
  public void prohibitedNonCharacterCodePoints() {
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG1,
        () -> SaslPrep.prepare("\uDB3F\uDFFFmy,0TEXT", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG1,
        () -> SaslPrep.prepare("\uDB3F\uDFFFmy,0TEXT", SaslPrep.StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG2,
        () -> SaslPrep.prepare("my,0\uFDD0TEXT", SaslPrep.StringType.QUERY));
    ...
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG2,
        () -> SaslPrep.prepare("my,0\uD9FF\uDFFETEXT", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG2,
        () -> SaslPrep.prepare("my,0\uD9FF\uDFFETEXT", SaslPrep.StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG3,
        () -> SaslPrep.prepare("my,0TEXT\uDBBF\uDFFF", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG3,
        () -> SaslPrep.prepare("my,0TEXT\uDBBF\uDFFF", SaslPrep.StringType.STORED));
  }
  ...
  public void prohibitedInappropriateForPlainTextCharacters() {
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG1,
        () -> SaslPrep.prepare("\uFFFACmy,0TEXT", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG1,
        () -> SaslPrep.prepare("\uFFFAmy,0TEXT", SaslPrep.StringType.STORED));
  ...
  public void prohibitedTaggingCharacters() {
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG1,
        () -> SaslPrep.prepare("\uDB40\uDC7Fmy,0TEXT", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG1,
        () -> SaslPrep.prepare("\uDB40\uDC7Fmy,0TEXT", SaslPrep.StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG2,
        () -> SaslPrep.prepare("my,0\uDB40\uDC21TEXT", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG2,
        () -> SaslPrep.prepare("my,0\uDB40\uDC21TEXT", SaslPrep.StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG3,
        () -> SaslPrep.prepare("my,0TEXT\uDB40\uDC01", SaslPrep.StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        PROHIBITED_MSG3,
        () -> SaslPrep.prepare("my,0TEXT\uDB40\uDC01", SaslPrep.StringType.STORED));
  }
  ...
  public void bidiCombinations() {
    ...
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG1,
        () -> SaslPrep.prepare("\u0627my,0TEXT", StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG1,
        () -> SaslPrep.prepare("\u0627my,0TEXT", StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG1,
        () -> SaslPrep.prepare("my,0TEXT\u064A", StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG1,
        () -> SaslPrep.prepare("my,0TEXT\u064A", StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG1,
        () -> SaslPrep.prepare("\u0627my,0\u0628TEXT\u064A", StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG1,
        () -> SaslPrep.prepare("\u0627my,0\u0628TEXT\u064A", StringType.STORED));

    // If a string contains any RandALCat character, a RandALCat character MUST be the first
    // character of the string, and a RandALCat character MUST be the
    // last character of the string.
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG2,
        () -> SaslPrep.prepare("\u0627-1\u0628-2-3-4", StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG2,
        () -> SaslPrep.prepare("\u0627-1\u0628-2-3-4", StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG2,
        () -> SaslPrep.prepare("-1-2-3-4\u064A", StringType.QUERY));
    assertThrows(
        WrongArgumentException.class,
        BIDI_MSG2,
        () -> SaslPrep.prepare("-1-2-3-4\u064A", StringType.STORED));

    // Fine, as long as starts and ends with RandALCat characters and doesn't contain any LCat
    // character.
    assertEquals(
        "\u0627-1-2-3-4\u064A", SaslPrep.prepare("\u0627-1-2-3-4\u064A", StringType.QUERY));
    assertEquals(
        "\u0627-1-2-3-4\u064A", SaslPrep.prepare("\u0627-1-2-3-4\u064A", StringType.STORED));
    assertEquals(
        "\u0627-1\u0628-2-3-4\u064A",
        SaslPrep.prepare("\u0627-1\u0628-2-3-4\u064A", StringType.QUERY));
    assertEquals(
        "\u0627-1\u0628-2-3-4\u064A",
        SaslPrep.prepare("\u0627-1\u0628-2-3-4\u064A", StringType.STORED));
  }
  ...
  public void unassignedCodePoints() {
    ...
    assertThrows(
        WrongArgumentException.class,
        UNASSIGNED_MSG1,
        () -> SaslPrep.prepare("\u0888my,0TEXT", StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        UNASSIGNED_MSG2,
        () -> SaslPrep.prepare("my,0\u0890TEXT", StringType.STORED));
    assertThrows(
        WrongArgumentException.class,
        UNASSIGNED_MSG3,
        () -> SaslPrep.prepare("my,0TEXT\u089F", StringType.STORED));
  }
}
