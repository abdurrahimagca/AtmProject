...
public class TableDeleteTest extends BaseTableTestCase {
  ...
  public void testDelete() {
    try {
      ...
      sqlUpdate(
          "create table testDelete (_id varchar(32), name varchar(20), birthday date, age int)");
  ...
  public void testPreparedStatements() {
    ...
    try {
      ...
      DeleteStatement testDelete2 =
          testTbl2.delete().where("ord >= :n"); // Criteria with one placeholder.
      DeleteStatement testDelete3 =
          testTbl3
              .delete()
              .where("ord >= :n AND ord <= :n + 1"); // Criteria with same placeholder repeated.
      DeleteStatement testDelete4 =
          testTbl4
              .delete()
      ...
      assertTestPreparedStatementsResult(
          testDelete2.bind("n", 2).execute(), 3, testTbl2.getName(), 1);
      assertPreparedStatementsCountsAndId(testSession, 0, testDelete2, 0, -1);
      assertTestPreparedStatementsResult(
          testDelete3.bind("n", 2).execute(), 2, testTbl3.getName(), 1, 4);
      assertPreparedStatementsCountsAndId(testSession, 0, testDelete3, 0, -1);
      assertTestPreparedStatementsResult(
          testDelete4.bind("n", 2).bind("m", 3).execute(), 2, testTbl4.getName(), 1, 4);
      assertPreparedStatementsCountsAndId(testSession, 0, testDelete4, 0, -1);
      ...
      assertTestPreparedStatementsResult(
          testDelete1.orderBy("id").execute(), 4, testTbl1.getName());
      assertPreparedStatementsCountsAndId(testSession, 0, testDelete1, 0, -1);
      assertTestPreparedStatementsResult(
          testDelete2.orderBy("id").execute(), 3, testTbl2.getName(), 1);
      assertPreparedStatementsCountsAndId(testSession, 0, testDelete2, 0, -1);
      assertTestPreparedStatementsResult(
          testDelete3.orderBy("id").execute(), 2, testTbl3.getName(), 1, 4);
      assertPreparedStatementsCountsAndId(testSession, 0, testDelete3, 0, -1);
      assertTestPreparedStatementsResult(
          testDelete4.orderBy("id").execute(), 2, testTbl4.getName(), 1, 4);
      assertPreparedStatementsCountsAndId(testSession, 0, testDelete4, 0, -1);
      ...
      assertTestPreparedStatementsResult(
          testDelete2.bind("n", 3).execute(), 2, testTbl2.getName(), 1, 2);
      assertPreparedStatementsCountsAndId(testSession, 2, testDelete2, 2, 1);
      assertTestPreparedStatementsResult(
          testDelete3.bind("n", 3).execute(), 2, testTbl3.getName(), 1, 2);
      assertPreparedStatementsCountsAndId(testSession, 3, testDelete3, 3, 1);
      assertTestPreparedStatementsResult(
          testDelete4.bind("m", 4).execute(), 3, testTbl4.getName(), 1);
      ...
      // execute.
      assertTestPreparedStatementsResult(
          testDelete1.limit(1).execute(), 1, testTbl1.getName(), 2, 3, 4);
      assertPreparedStatementsCountsAndId(testSession, 4, testDelete1, 1, 1);
      assertTestPreparedStatementsResult(
          testDelete2.limit(1).execute(), 1, testTbl2.getName(), 1, 2, 3);
      assertPreparedStatementsCountsAndId(testSession, 4, testDelete2, 2, 1);
      assertTestPreparedStatementsResult(
          testDelete3.limit(1).execute(), 1, testTbl3.getName(), 2, 3, 4);
      assertPreparedStatementsCountsAndId(testSession, 4, testDelete3, 3, 1);
      assertTestPreparedStatementsResult(
          testDelete4.limit(1).execute(), 1, testTbl4.getName(), 1, 3, 4);
      assertPreparedStatementsCountsAndId(testSession, 4, testDelete4, 4, 1);
      ...
      assertTestPreparedStatementsResult(
          testDelete1.limit(2).execute(), 2, testTbl1.getName(), 3, 4);
      assertPreparedStatementsCountsAndId(testSession, 4, testDelete1, 1, 2);
      assertTestPreparedStatementsResult(
          testDelete2.limit(2).execute(), 1, testTbl2.getName(), 1, 2, 3);
      assertPreparedStatementsCountsAndId(testSession, 4, testDelete2, 2, 2);
      assertTestPreparedStatementsResult(
          testDelete3.limit(2).execute(), 2, testTbl3.getName(), 3, 4);
      assertPreparedStatementsCountsAndId(testSession, 4, testDelete3, 3, 2);
      assertTestPreparedStatementsResult(
          testDelete4.limit(2).execute(), 1, testTbl4.getName(), 1, 3, 4);
      assertPreparedStatementsCountsAndId(testSession, 4, testDelete4, 4, 2);
      ...
      assertTestPreparedStatementsResult(
          testDelete1.orderBy("id").limit(1).execute(), 1, testTbl1.getName(), 2, 3, 4);
      assertPreparedStatementsCountsAndId(testSession, 3, testDelete1, 0, -1);
      assertTestPreparedStatementsResult(
          testDelete2.orderBy("id").limit(1).execute(), 1, testTbl2.getName(), 1, 2, 3);
      assertPreparedStatementsCountsAndId(testSession, 2, testDelete2, 0, -1);
      assertTestPreparedStatementsResult(
          testDelete3.orderBy("id").limit(1).execute(), 1, testTbl3.getName(), 2, 3, 4);
      assertPreparedStatementsCountsAndId(testSession, 1, testDelete3, 0, -1);
      assertTestPreparedStatementsResult(
          testDelete4.orderBy("id").limit(1).execute(), 1, testTbl4.getName(), 1, 3, 4);
      assertPreparedStatementsCountsAndId(testSession, 0, testDelete4, 0, -1);
      ...
      try {
        ...
        assertTestPreparedStatementsResult(
            testDelete2.execute(),
            4,
            testTbl2.getName()); // Fails preparing, execute as non-prepared.
        ...
        assertTestPreparedStatementsResult(
            testDelete2.execute(), 4, testTbl2.getName()); // Execute as non-prepared.
        assertPreparedStatementsCountsAndId(testSession, 1, testDelete2, 0, -1);
  ...
  private void testPreparedStatementsResetData() {
    for (int i = 0; i < 4; i++) {
      sqlUpdate(
          "CREATE TABLE IF NOT EXISTS testPrepareDelete_"
              + (i + 1)
              + " (id INT PRIMARY KEY, ord INT)");
      sqlUpdate("TRUNCATE TABLE testPrepareDelete_" + (i + 1));
      sqlUpdate(
          "INSERT INTO testPrepareDelete_" + (i + 1) + " VALUES (1, 1), (2, 2), (3, 3), (4, 4)");
    }
  }
