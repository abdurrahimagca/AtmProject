...
public class Login extends Card {
  ...
  private static boolean isPinTrue(String cardsPin, String cardPin) {
    ...
    if (attempts > 3) {
      // todo: her seferinde yeni obje olusturuldugundan bunun yapılması o kadar da kolay degil
      // attemps degişkeni daima sıfır oluyor
      ...
      try {
        ...
        while (rs.next()) cardsPin = rs.getString("PIN");
